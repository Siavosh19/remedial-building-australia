...
import { CavityDrainProductSection, CavityDrainIntroSection } from "./CavityDrainProductSection";

export const metadata: Metadata = {
  title: "Cavity Drain Membrane Systems — Basement Water Ingress — Remedial Building Australia",
  description: "Technical product reference for cavity drain dimple membrane systems used to manage and drain water ingress in basements on Australian Class 2 strata and commercial buildings.",
};
...
export default function CavityDrainPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Cavity drain membranes</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for cavity drain dimple membrane systems — Delta MS and equivalent products — used to manage and drain water ingress through basement walls and slabs in Australian Class 2 strata and commercial buildings. Covers system design (wall membrane, floor membrane, drain channel, sump), product selection, and limitations of cavity drain vs tanking approaches.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Dimple height", value: "2.0mm" },
                  { label: "Guidance", value: "BS 8102" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "cavity-drain-membrane-systems";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <CavityDrainIntroSection />
            <CavityDrainProductSection />
          </div>
        </section>
