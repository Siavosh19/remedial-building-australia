...
import { HydrophilicPUProductSection, HydrophilicPUIntroSection } from "./HydrophilicPUProductSection";

export const metadata: Metadata = {
  title: "Hydrophilic Polyurethane Injection Systems — Basement Water Ingress — Remedial Building Australia",
  description: "Technical product reference for hydrophilic polyurethane injection systems used to stop active water ingress through basement walls, slabs, and joints in Australian Class 2 strata and commercial buildings.",
};
...
export default function HydrophilicPUPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Hydrophilic PU injection</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Hydrophilic polyurethane injection systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for hydrophilic PU injection systems used to seal active water ingress through cracks, construction joints, and cold joints in basement walls and slabs on Australian Class 2 strata and commercial buildings. Covers product selection, injection equipment, gel vs foam behaviour, application sequence and substrate conditions.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Component type", value: "1C & 2C" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "hydrophilic-pu-injection";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <HydrophilicPUIntroSection />
            <HydrophilicPUProductSection />
          </div>
        </section>
