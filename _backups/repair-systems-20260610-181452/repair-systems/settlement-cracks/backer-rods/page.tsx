...
export const metadata: Metadata = {
  title: "Backer Rods — Settlement Cracks — Remedial Building Australia",
  description:
    "Technical product reference for closed-cell PE backer rods, open-cell PU backer rods, and bond-breaker tape for sealant joint depth control in settlement crack repair — controls sealant depth:width ratio, prevents three-sided adhesion, and ensures correct sealant movement accommodation in masonry and concrete joints in Australia.",
};
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Backer rods</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for closed-cell polyethylene backer rods, open-cell polyurethane backer rods, and bond-breaker tape used before sealant application in settlement crack repair — controls sealant depth:width ratio to the 1:2 target and prevents three-sided adhesion failure.</p>
              </div>
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  "Masking tape used for sealant edge protection — masking tape applied to joint edges before sealant application is removed immediately after tooling and must never be used as a bond-breaker at the joint base; the adhesive residue transfers to the concrete or masonry and causes sealant bonding at the base — exactly the three-sided adhesion problem that bond-breaker tape is designed to prevent",
                  "Compriband / pre-compressed impregnated foam tape — pre-compressed impregnated polyurethane foam tapes (Compriband, ISO-BLOCO) are self-expanding joint fillers applied to the joint face before a frame or panel is installed; they are a complete joint seal themselves, not a depth-control accessory for a gun-applied sealant; do not confuse them with backer rods",
                  "Crack injection ports (surface-mounted adhesive ports) — surface-mounted injection ports are epoxy-adhered over the crack for injection; backer rods are inserted into the joint depth below the sealant surface; they are completely different products serving different functions at different stages of the repair sequence",
                  "Closed-cell foam weatherstripping — adhesive-backed PE foam strips used for door and window draught-sealing are not backer rods; they are compressed as a weatherseal, not installed as a sealant depth-control backing; do not substitute weatherstripping for backer rod in construction joint sealing",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/sealants-polyurethane`, label: "PU Sealants", title: "PU sealants applied after backer rod installation" },
                { href: `${BASE}/injection-resins-pu-flexible`, label: "PU Flexible Injection", title: "Water-stop injection — applied before surface sealant and backer rod" },
              ].map((card) => (
