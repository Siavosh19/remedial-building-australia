...
import { AbrasivesToolsCCIntroSection, AbrasivesToolsCCProductSection } from "./AbrasivesToolsCCProductSection";

export const metadata: Metadata = {
  title: "Abrasives, Blades & Tools — Concrete Cracking — Remedial Building Australia",
  description:
    "Technical product reference for abrasives, diamond crack chaser blades, SDS-Plus rotary hammers, wire cup brushes, and hot air guns used in concrete crack repair preparation — crack routing, port hole drilling, surface cleaning, and pre-injection drying in Australia.",
};
...
export default function AbrasivesBladesToolsCCPage() {
  return (
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for preparation tools used in concrete crack repair — crack chaser blades for routing, SDS-Plus rotary hammers for port hole drilling, wire cup brushes for surface cleaning, and hot air guns for pre-injection crack drying in Australian crack repair practice.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Tool categories", value: "4" },
                  { label: "Crack chaser kerf", value: "4–6 mm" },
                  { label: "Port drill size", value: "12–16 mm" },
                  { label: "PT exclusion zone", value: "GPR required" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <AbrasivesToolsCCIntroSection />
            <AbrasivesToolsCCProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse concrete cracking tools with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/injection-resins-pu-flexible`, label: "PU Flexible Injection", title: "Hydrophilic PU resins — applied after crack preparation" },
                { href: `${BASE}/injection-resins-epoxy-rigid`, label: "Epoxy Rigid Injection", title: "Structural epoxy resins — applied to prepared dry crack" },
              ].map((card) => (
