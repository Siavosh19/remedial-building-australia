...
import { AcrylicSprayRenderIntroSection, AcrylicSprayRenderProductSection } from "./AcrylicSprayRenderProductSection";

export const metadata: Metadata = {
  title: "Acrylic Spray-Applied Render Systems — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description:
    "Technical product reference for acrylic spray-applied render systems used in facade render repair and reinstallation on Australian AAC and masonry buildings — Rockcote, Boral, and Weber system comparisons.",
};

const ACTIVE_SLUG = "acrylic-spray-applied-render";
...
export default function AcrylicSprayRenderPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Acrylic spray-applied render systems</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for acrylic spray-applied render systems used in facade render repair and reinstallation on Australian AAC and masonry buildings. Covers machine spray application, product selection, substrate preparation, and brand comparisons.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Application", value: "Machine spray" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <AcrylicSprayRenderIntroSection />

            <AcrylicSprayRenderProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse acrylic spray-applied render with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Trowel-applied PM render — polymer-modified cementitious render applied by steel trowel or float — listed on the two-coat polymer-modified render page",
                  "Texture coatings (not a render — applied over cured render) — acrylic texture coatings applied over a cured render base coat as the final decorative finish — not a render system in themselves",
                  "EIFS (system with insulation board) — systems incorporating a layer of EPS insulation board mechanically fixed to the substrate with render applied over fibreglass mesh — listed on the EIFS render systems page",
                  "Sand-cement render (no acrylic polymer) — traditional Portland cement and sand render without acrylic polymer admixture — listed on the two-coat sand-cement render page",
                ].map((item) => (
