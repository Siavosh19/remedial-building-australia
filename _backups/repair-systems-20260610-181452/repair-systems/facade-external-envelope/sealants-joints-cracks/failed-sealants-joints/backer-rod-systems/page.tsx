...
export const metadata: Metadata = {
  title: "Backer Rod Systems — Sealants, Joints & Cracks — Remedial Building Australia",
  description:
    "Technical product reference for polyethylene foam backer rod systems used in facade joint depth control for sealant remediation on Australian Class 2 strata buildings — closed-cell, open-cell and bond-breaker tape comparisons.",
};

const ACTIVE_SLUG = "backer-rod-systems";
...
export default function BackerRodPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Backer rod systems</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "PE foam / tape" },
                  { label: "Standards", value: "ASTM C 1330" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse backer rod with:</h3>
              </div>
