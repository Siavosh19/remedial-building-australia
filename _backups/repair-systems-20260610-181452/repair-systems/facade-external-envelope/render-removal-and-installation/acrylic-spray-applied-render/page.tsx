...
export const metadata: Metadata = {
  title: "Acrylic Spray-Applied Render Systems — Render Removal & Installation — Remedial Building Australia",
  description:
    "Technical product reference for acrylic spray-applied render systems — Dulux Acratex, Solver and Taubmans spray render systems for fast large-area application on rendered facades.",
};
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Acrylic spray-applied render</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Thickness", value: "4–6mm" },
                  { label: "Cure time", value: "24–48h" },
                  { label: "Coverage", value: "6–8 m²/bag" },
                ].map((s) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">General technical information only. Spray render requires appropriate equipment and operator skill — confirm substrate preparation, primer requirements and spray technique with the manufacturer TDS. Not a substitute for professional advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { href: "/repair-systems/facade-external-envelope/render-cracking-delamination/texture-coating-systems", label: "Related", title: "Texture coating systems" },
