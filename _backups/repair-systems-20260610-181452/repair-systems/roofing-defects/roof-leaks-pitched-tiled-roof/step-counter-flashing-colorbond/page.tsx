...
import { StepFlashingColorbondProductSection, StepFlashingColorbondIntroSection } from "./StepFlashingColorbondProductSection";

export const metadata: Metadata = {
  title: "Step and Counter-Flashing — Colorbond — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for Colorbond steel step and counter-flashing systems used in pitched tiled roof leak remediation on Australian buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function StepCounterFlashingColorbondPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Step and counter-flashing — Colorbond</span>
            </nav>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "step-counter-flashing-colorbond";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <StepFlashingColorbondIntroSection />

            <StepFlashingColorbondProductSection />
