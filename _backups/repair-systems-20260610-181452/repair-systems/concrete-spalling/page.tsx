...
const GROUPS = [
  ...
  },
  {
    heading: "Formwork",
    categories: [
      { label: "Formwork timber", count: 4, slug: "formwork-timber" },
      { label: "Formwork plywood", count: 4, slug: "formwork-plywood" },
      { label: "Form release agents", count: 4, slug: "form-release-agents" },
      { label: "Tie wire & fixings", count: 4, slug: "tie-wire-fixings" },
    ],
  },
  {
