        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img
                src="/Images/Categories/concrete-structural-defects/magnesite-flooring-deterioration.jpg"
                alt="Magnesite flooring deterioration"
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              ...
              <a
                href="/downloads/magnesite-flooring-inspection-checklist.pdf"
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img
              src="/Images/Categories/concrete-structural-defects/magnesite-flooring-deterioration/Typical%20Repair%20approach.jpg"
              alt="Magnesite flooring repair methodology"
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img
              src="/Images/Categories/concrete-structural-defects/magnesite-flooring-deterioration/Before%20After.PNG"
              alt="Magnesite flooring before and after repair"
              className="mt-8 w-full rounded-2xl border border-slate-200 object-cover"
            />
          </section>
          ...
          <section className="mt-16 grid gap-8 md:grid-cols-2" style={{ paddingTop: "3mm" }}>
            <a
              href="/repair-systems/flooring-systems"
            ...
            >
              ...
              <ul className="mt-4 space-y-2">
                {["Magnesite removal", "Substrate waterproofing", "Moisture barrier systems", "Structural slab repair", "Flooring reinstatement systems"].map((item) => (
            ...
            <a
              href="/materials-products/flooring"
              className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl"
            >
              <h3 className="text-2xl font-bold">Related Materials</h3>
              <ul className="mt-4 space-y-2">
                {["Waterproofing membranes", "Moisture barriers", "Levelling compounds", "Repair mortars", "Steel primers", "Approved flooring systems"].map((item) => (
                  <li key={item} className="flex gap-3 text-base leading-7 text-slate-700">
                    <span className="mt-2.5 h-2.5 w-2.5 shrink-0 rounded-full bg-slate-800" />
                    {item}
                  </li>
