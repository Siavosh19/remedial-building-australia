    ...
    <div className="min-h-screen bg-slate-100 text-slate-800">
      ...
      <main className="px-6 py-20">
        <section className="mx-auto max-w-7xl">
          <Link href="/defect-library/concrete-structural-defects" className="inline-flex rounded-xl border border-slate-300 bg-white px-5 py-3 text-base font-semibold text-slate-700 shadow-sm hover:bg-slate-100">
...
<ol className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 px-7 py-6">
          ...
          <section className="mt-16">
            <Link href="/repair-systems/settlement-cracks" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              <h3 className="text-2xl font-bold">Related Repair Systems</h3>
              <ul className="mt-4 space-y-2">
                {["PU injection resins", "Epoxy injection resins", "Crack injection ports", "Structural anchors and dowels", "Repair mortars", "Lime and repointing mortars", "Polyurethane sealants", "Backer rods"].map((item) => (
