...
<ol className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 px-7 py-6">
          ...
          <section className="mt-16">
            <Link href="/repair-systems/slab-edge-deterioration" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
