        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img src="/Images/Categories/concrete-structural-defects.jpg" alt="Slab edge deterioration" className="h-[420px] w-full object-cover" />
              <div className="border-t border-slate-200 p-5 text-base font-semibold text-slate-700">
                Typical slab edge spalling exposing corroded reinforcement at a balcony perimeter.
              </div>
            </div>
          </div>
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              ...
              <a href="/downloads/slab-edge-inspection-checklist.pdf" className="rounded-xl bg-sky-900 px-5 py-3 text-base font-semibold text-white hover:bg-sky-800">
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/concrete-structural-defects.jpg" alt="Slab edge repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <p className="mt-4 text-base leading-8 text-slate-700">
              Typical slab edge condition before and after concrete removal, steel treatment and repair mortar application.
            </p>
            <img src="/Images/Categories/concrete-structural-defects.jpg" alt="Slab edge before and after repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          </section>
          ...
          <section className="mt-16 grid gap-8 md:grid-cols-2">
            <a href="/repair-systems" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              ...
              <ul className="mt-4 space-y-2">
                {["Polymer-modified cementitious repair mortar systems", "Epoxy and cementitious bonding agents", "Reinforcement primer and corrosion inhibitor systems", "Anti-carbonation and elastomeric coating systems", "Silane and siloxane penetrating sealers"].map((item) => (
            ...
            <a href="/materials-products" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              ...
              <ul className="mt-4 space-y-2">
                {["Pre-bagged concrete repair mortars", "Two-component epoxy bonding agents", "Zinc-rich and epoxy reinforcement primers", "Elastomeric anti-carbonation coatings", "Penetrating silane surface sealers"].map((item) => (
                  <li key={item} className="flex gap-3 text-base leading-7 text-slate-700">
                    <span className="mt-2.5 h-2.5 w-2.5 shrink-0 rounded-full bg-slate-800" />
                    {item}
                  </li>
