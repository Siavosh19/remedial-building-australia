        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img src="/Images/Categories/basements-substructure.jpg" alt="Crack Injection Failures" className="h-[420px] w-full object-cover" />
              <div className="border-t border-slate-200 p-5 text-base font-semibold text-slate-700">Typical crack injection failures condition in a Class 2 building.</div>
            </div>
          </div>
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/basements-substructure.jpg" alt="Crack Injection Failures repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/basements-substructure.jpg" alt="Crack Injection Failures before and after" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          </section>
          <section className="mt-16 grid gap-8 md:grid-cols-2">
            ...
            <a href="/materials-products" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              ...
              <ul className="mt-4 space-y-2">{["Hydrophilic polyurethane injection resins", "Low-viscosity epoxy resins", "Injection ports and packers", "Crystalline waterproofing slurries", "High-pressure injection pumps and equipment"].map((item) => (<li key={item} className="flex gap-3 text-base leading-7 text-slate-700"><span className="mt-2.5 h-2.5 w-2.5 shrink-0 rounded-full bg-slate-800" />{item}</li>))}</ul>
