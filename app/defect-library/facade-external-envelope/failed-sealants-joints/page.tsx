        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img src="/Images/Categories/facade-external-envelope.jpg" alt="Failed sealant joints" className="h-[420px] w-full object-cover" />
              <div className="border-t border-slate-200 p-5 text-base font-semibold text-slate-700">
                Typical adhesive sealant failure at a facade panel joint allowing direct water ingress.
              </div>
            </div>
          </div>
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/facade-external-envelope.jpg" alt="Sealant joint repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <p className="mt-4 text-base leading-8 text-slate-700">
              Typical joint condition before and after full sealant removal, backer rod installation and new sealant application.
            </p>
            <img src="/Images/Categories/facade-external-envelope.jpg" alt="Sealant joints before and after repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          </section>
