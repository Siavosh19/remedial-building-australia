        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img src="/Images/Categories/facade-external-envelope.jpg" alt="Facade cracking" className="h-[420px] w-full object-cover" />
              <div className="border-t border-slate-200 p-5 text-base font-semibold text-slate-700">
                Diagonal cracking at window opening on a rendered facade — characteristic of differential movement.
              </div>
            </div>
          </div>
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/facade-external-envelope.jpg" alt="Facade cracking repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <p className="mt-4 text-base leading-8 text-slate-700">
              Typical facade condition before and after crack repair, movement joint installation and elastomeric coating.
            </p>
            <img src="/Images/Categories/facade-external-envelope.jpg" alt="Facade cracking before and after repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          </section>
