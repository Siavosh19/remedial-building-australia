        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img src="/Images/Categories/miscellaneous-other.jpg" alt="Acoustic Issues" className="h-[420px] w-full object-cover" />
              <div className="border-t border-slate-200 p-5 text-base font-semibold text-slate-700">Typical acoustic issues condition in a Class 2 building.</div>
            </div>
          </div>
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/miscellaneous-other.jpg" alt="Acoustic Issues repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/miscellaneous-other.jpg" alt="Acoustic Issues before and after" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          </section>
          <section className="mt-16 grid gap-8 md:grid-cols-2">
            ...
            <a href="/materials-products" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              ...
              <ul className="mt-4 space-y-2">{["Resilient acoustic underlays and mounts", "Acoustic-grade plasterboard", "Mineral wool acoustic batts", "Fire-rated acoustic sealants", "Acoustically rated laminated glass"].map((item) => (<li key={item} className="flex gap-3 text-base leading-7 text-slate-700"><span className="mt-2.5 h-2.5 w-2.5 shrink-0 rounded-full bg-slate-800" />{item}</li>))}</ul>
