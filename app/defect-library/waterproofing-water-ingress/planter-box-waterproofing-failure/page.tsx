        ...
        <section className="mx-auto max-w-7xl">
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              ...
              <a href="/downloads/planter-box-waterproofing-inspection-checklist.pdf" className="rounded-xl bg-sky-900 px-5 py-3 text-base font-semibold text-white hover:bg-sky-800">
          ...
          <section className="mt-16 grid gap-8 md:grid-cols-2">
            ...
            <a href="/materials-products/waterproofing" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              ...
              <ul className="mt-4 space-y-2">
                {["Root barrier membranes", "Drainage composite boards", "Liquid applied polyurethane membranes", "Geotextile filter fabrics", "Weep hole inserts and drainage cells"].map((item) => (
                  <li key={item} className="flex gap-3 text-base leading-7 text-slate-700">
                    <span className="mt-2.5 h-2.5 w-2.5 shrink-0 rounded-full bg-slate-800" />
                    {item}
                  </li>
