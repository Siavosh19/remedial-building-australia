...
const defects = [
  ...
  {
    title: "Failed Screeds & Tile Delamination",
    description:
      "Drummy, cracked or debonded tiles on balconies and podiums caused by failed screeds, trapped moisture, poor falls and membrane failure beneath the tile finish.",
    image: "/Images/Categories/waterproofing-water-ingress.jpg",
    href: "/defect-library/waterproofing-water-ingress/failed-screeds-tile-delamination",
    imagePosition: "object-center",
  },
];
