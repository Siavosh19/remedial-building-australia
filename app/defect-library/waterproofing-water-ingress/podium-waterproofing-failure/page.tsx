        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
              <img src="/Images/Categories/waterproofing-water-ingress.jpg" alt="Podium waterproofing failure" className="h-[420px] w-full object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              ...
              <a href="/downloads/podium-waterproofing-inspection-checklist.pdf" className="rounded-xl bg-sky-900 px-5 py-3 text-base font-semibold text-white hover:bg-sky-800">
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/waterproofing-water-ingress.jpg" alt="Podium waterproofing repair methodology" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          ...
          <section className="mt-16 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <img src="/Images/Categories/waterproofing-water-ingress.jpg" alt="Podium waterproofing before and after repair" className="mt-8 w-full rounded-2xl border border-slate-200 object-cover" />
          </section>
          ...
          <section className="mt-16 grid gap-8 md:grid-cols-2">
            ...
            <a href="/materials-products/waterproofing" className="block rounded-3xl border border-slate-200 bg-white p-8 text-sky-950 shadow-md transition hover:shadow-xl">
              ...
              <ul className="mt-4 space-y-2">
                {["Trafficable polyurethane membranes", "Expansion joint sealants and backing rods", "Pre-formed joint tapes and flashings", "Drainage composite boards and geotextile", "Podium paver support systems"].map((item) => (
                  <li key={item} className="flex gap-3 text-base leading-7 text-slate-700">
                    <span className="mt-2.5 h-2.5 w-2.5 shrink-0 rounded-full bg-slate-800" />
                    {item}
                  </li>
