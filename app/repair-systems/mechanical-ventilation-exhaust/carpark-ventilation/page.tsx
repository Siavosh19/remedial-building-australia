...
import { CarparkVentilationIntroSection, CarparkVentilationProductSection } from "./CarparkVentilationProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Carpark Ventilation — Mechanical, Ventilation & Exhaust — Remedial Building Australia",
  description:
...
const SIBLING_GROUPS = [
  { heading: "Roof Vents", tabs: [
    { label: "Mushroom vents", slug: "mushroom-roof-vents" },
  ]},
  { heading: "Exhaust Fans", tabs: [
    { label: "Mechanical exhaust", slug: "mechanical-exhaust-fans" },
    { label: "Window exhaust", slug: "window-mounted-exhaust-fans" },
  ]},
  { heading: "Ventilation", tabs: [
    { label: "Subfloor ventilation", slug: "subfloor-ventilation" },
    { label: "Carpark ventilation", slug: "carpark-ventilation" },
  ]},
];

export default function CarparkVentilationPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <Link href="/repair-systems/mechanical-ventilation-exhaust" className="hover:text-sky-700 transition">Mechanical, Ventilation &amp; Exhaust</Link>
              <span>/</span>
              <span className="text-sky-950">Carpark Ventilation</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Standard", value: "AS 1668.2" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "carpark-ventilation";
                      return (
                        <Link
                          key={tab.slug}
                          href={`/repair-systems/mechanical-ventilation-exhaust/${tab.slug}`}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <CarparkVentilationIntroSection />
            <CarparkVentilationProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  href: "/repair-systems/mechanical-ventilation-exhaust",
                  label: "Back to Mechanical, Ventilation & Exhaust",
                  title: "Browse all ventilation defect subcategories",
                },
                {
                  href: "/repair-systems/mechanical-ventilation-exhaust/mechanical-exhaust-fans",
                  label: "Mechanical Exhaust Fans",
                  title: "Inline duct, ceiling and wall-mounted exhaust fan systems",
                },
                {
                ...
                },
                {
                  ...
                  title: "Generate a scope of works for carpark ventilation upgrade",
                },
              ].map((card) => (
                <a
                  key={card.href}
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-7xl px-5 pt-10">
          <Link href="/repair-systems/mechanical-ventilation-exhaust" className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm transition hover:bg-slate-200">
