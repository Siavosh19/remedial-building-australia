...
import { WindowExhaustIntroSection, WindowExhaustProductSection } from "./WindowExhaustProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Window-Mounted Exhaust Fans — Mechanical, Ventilation & Exhaust — Remedial Building Australia",
  description:
...
export default function WindowMountedExhaustFansPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Window-Mounted Exhaust Fans</span>
            </nav>
            <PageNav />
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "window-mounted-exhaust-fans";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <WindowExhaustIntroSection />
            <WindowExhaustProductSection />
          </div>
        </section>
