...
import { SumpPumpProductSection, SumpPumpIntroSection } from "./SumpPumpProductSection";

export const metadata: Metadata = {
  title: "Sump and Pump Systems — Basement Water Ingress — Remedial Building Australia",
  description: "Technical product reference for sump and pump systems used to collect and discharge water ingress from basements on Australian Class 2 strata and commercial buildings.",
};
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Sump & pump</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for sump pit, pump, and float switch systems used as the active component of cavity drain waterproofing systems to collect and discharge water ingress from basements and below-ground spaces in Australian Class 2 strata and commercial buildings. Covers sump liner selection, submersible pump sizing, float switch specification, and maintenance obligations.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Compliance", value: "AS/NZS 4020" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "sump-and-pump-systems";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SumpPumpIntroSection />
            <SumpPumpProductSection />
          </div>
        </section>
