...
export const metadata: Metadata = {
  title: "Moisture Suppression Primers — Basement Water Ingress — Remedial Building Australia",
  description:
    "Technical product reference for moisture suppression primers for damp concrete surfaces in basement waterproofing — Fosroc Nitoproof 510 and compatible systems for Australian Class 2 strata and commercial buildings.",
};
...
export default function MoistureSupprimerPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for moisture suppression primers applied to damp concrete surfaces prior to waterproofing in basement and below-grade remediation — for substrates that cannot be fully dried before membrane application.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products listed", value: "1" },
                  { label: "Brand", value: "Fosroc" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <MoistureSupprimerIntroSection />
            <MoistureSupprimerProductSection />
          </div>
        </section>
