...
import { HydraulicCementProductSection, HydraulicCementIntroSection } from "./HydraulicCementProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Hydraulic Cement Plugging Systems — Basement Water Ingress — Remedial Building Australia",
  description: "Technical product reference for hydraulic setting cement systems used to plug active water leaks through basement walls and slabs in Australian Class 2 strata and commercial buildings.",
};
...
export default function HydraulicCementPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Hydraulic cement plugging</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Hydraulic cement plugging systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for rapid-setting hydraulic cement products used to physically plug active water leaks — running water, seeping joints, and pipe penetrations — in basement walls, slabs, and below-ground structures on Australian Class 2 strata and commercial buildings. Covers product selection, application under active flow, set time, and integration with subsequent tanking or injection systems.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Working time", value: "1–5 min" },
                  { label: "Standard", value: "AS 3972" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "hydraulic-cement-plugging";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <HydraulicCementIntroSection />
            <HydraulicCementProductSection />
          </div>
        </section>
