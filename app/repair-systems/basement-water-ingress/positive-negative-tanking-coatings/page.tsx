...
import { PositiveNegativeTankingProductSection, PositiveNegativeTankingIntroSection } from "./PositiveNegativeTankingProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Positive & Negative Tanking Coatings — Basement Water Ingress — Remedial Building Australia",
  description:
    "Technical product reference for positive and negative side cementitious tanking coatings for basement and below-grade waterproofing remediation — Westox CR25 and compatible two-component systems for Australian Class 2 strata and commercial buildings.",
};
...
const SIBLING_GROUPS = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { label: "Moisture suppression primers", slug: "moisture-suppression-primers" },
      { label: "Tanking coatings", slug: "positive-negative-tanking-coatings" },
    ],
  },
  {
...
export default function PositiveNegativeTankingPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Tanking coatings</span>
            </nav>
            <PageNav />
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                <div key={group.heading} className={`flex shrink-0 flex-col${gi > 0 ? " border-l border-slate-200 ml-1 pl-1" : ""}`}>
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "positive-negative-tanking-coatings";
                      return (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PositiveNegativeTankingIntroSection />
            <PositiveNegativeTankingProductSection />
          </div>
        </section>
