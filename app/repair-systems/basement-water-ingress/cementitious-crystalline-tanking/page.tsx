...
import { CrystallineTankingProductSection, CrystallineTankingIntroSection } from "./CrystallineTankingProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Cementitious Crystalline Tanking Systems — Basement Water Ingress — Remedial Building Australia",
  description: "Technical product reference for cementitious crystalline waterproofing systems used to tank basement walls and slabs against water ingress in Australian Class 2 strata and commercial buildings.",
};
...
export default function CrystallineTankingPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Crystalline tanking</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Cementitious crystalline tanking systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for cementitious crystalline waterproofing systems — Xypex, Penetron, and equivalent products — used to tank basement walls and slabs against hydrostatic water ingress from the negative or positive side in Australian Class 2 strata and commercial buildings. Covers crystalline chemistry, application method, negative-side vs positive-side selection, and AS 3600 compliance.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Application side", value: "Negative/positive" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "cementitious-crystalline-tanking";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <CrystallineTankingIntroSection />
            <CrystallineTankingProductSection />
          </div>
        </section>
