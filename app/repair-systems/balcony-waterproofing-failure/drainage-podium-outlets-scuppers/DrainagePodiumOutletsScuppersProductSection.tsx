...
const TECH_INFO = [
  {
    title: "Gravity vs siphonic drainage — roofs, balconies and podiums",
    items: [
      ...
      "For balcony and podium drainage, gravity systems are always used — siphonic drainage is not appropriate for the small catchment areas typical of balcony and podium applications",
    ],
    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
      <div className="mb-4 flex items-center gap-2.5">
        ...
        <h3 className="text-base font-extrabold text-sky-950">
          What are flat roof, balcony and podium drainage outlet and sump systems?
        </h3>
      </div>
      <div className="space-y-4 text-sm leading-7 text-slate-600">
        <p>
          Flat roof, balcony and podium drainage outlets collect ponding water from the surface and direct it into the building's stormwater drainage system. On flat roofs, balconies and podiums where ponding occurs, the outlet — together with its associated sump depression — is the critical component that ensures water is removed efficiently. Incorrectly sized, blocked, or poorly detailed outlets are a primary cause of persistent ponding even where falls have been corrected.
        </p>
        {expanded && (
          <>
            <p>
              Roof drainage outlets are classified as either gravity drains (Blucher D500, HL Hutterer HL62N) or siphonic drains (Geberit Pluvia). Gravity drains rely on partially filled pipes flowing under atmospheric pressure. Siphonic drains fill horizontal pipes completely, achieving much higher flow rates at smaller pipe diameters — but require specialist hydraulic design. For balcony and podium applications, gravity systems are always the appropriate choice.
            </p>
            <p>
              All flat roof, balcony and podium drainage outlets must comply with AS/NZS 3500.3 (Plumbing and Drainage — Stormwater Drainage) for sizing and strainer area requirements. The waterproofing membrane connection at the outlet collar is the most critical detail in any waterproofed assembly — membrane failure at the drain is the leading cause of water ingress in ponding-remediated flat roofs, balconies and podiums.
            </p>
          </>
        )}
      </div>
      ...
      <div>
        <div className="mb-5 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">3 products — 3 brands — flat roof, balcony and podium drainage outlet and sump systems</p>
          </div>
        </div>
        ...
        <div className="mb-6 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Side-by-side comparison of flat roof, balcony and podium drainage outlet systems. Confirm all product selections against the current manufacturer TDS and AS/NZS 3500.3 before specifying.
            </p>
          </div>
        </div>
