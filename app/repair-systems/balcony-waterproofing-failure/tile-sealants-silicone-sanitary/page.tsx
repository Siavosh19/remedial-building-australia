...
import { TileSealantsIntroSection, TileSealantsProductSection } from "./TileSealantsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Tile Sealants — Silicone & Sanitary — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for silicone and sanitary sealants used in wet area and balcony tiled surfaces — movement joints at internal angles, wall/floor junctions, and around fixtures in Australian Class 2 strata apartment buildings.",
};
...
export default function TileSealantsSiliconeSanitaryPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Tile sealants — silicone and sanitary</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Tile Sealants — Silicone &amp; Sanitary
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for silicone and sanitary sealants used in wet areas over tiled waterproofed surfaces — movement joints at internal angles, wall/floor junctions and around fixtures in Australian Class 2 strata apartment buildings.
                </p>
              </div>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "tile-sealants-silicone-sanitary";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <TileSealantsIntroSection />
            <TileSealantsProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Sealant selection must be confirmed against project requirements, substrate type, joint width, expected movement, chemical exposure, and the current manufacturer technical data sheet. AS 3740 requires flexible sealant joints at all internal angles and changes of plane in wet area waterproofing systems. Do not rely on this reference as a substitute for professional waterproofing consultant advice.
              </p>
            </div>
