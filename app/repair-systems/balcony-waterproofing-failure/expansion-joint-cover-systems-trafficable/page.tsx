...
import { ExpansionJointIntroSection, ExpansionJointProductSection } from "./ExpansionJointProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Expansion Joint Cover Systems — Trafficable — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for metal and elastomeric expansion joint cover systems for trafficable balcony and podium deck surfaces — aluminium, stainless and EPDM profiles bridging movement joints while maintaining waterproofing continuity in Australian Class 2 strata apartment buildings.",
};
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Expansion joint cover systems — trafficable</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 01</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Expansion Joint Cover Systems — Trafficable
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for metal and elastomeric expansion joint cover systems for trafficable balcony and podium deck surfaces — aluminium, stainless and EPDM profiles that bridge movement joints while maintaining waterproofing continuity in Australian Class 2 strata apartment buildings.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Materials", value: "Aluminium / EPDM" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "expansion-joint-cover-systems-trafficable";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ExpansionJointIntroSection />
            <ExpansionJointProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Expansion joint cover system selection must be confirmed against the structural engineer&apos;s movement calculations, joint width, expected movement magnitude, traffic loading, substrate condition, AS 3740, AS 4654.2, and the current manufacturer technical data sheet. Expansion joint cover systems do not replace correct waterproofing membrane detailing at joint faces. Do not rely on this reference as a substitute for professional engineering or waterproofing consultant advice.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  label: "Backer Rod & Bond Breaker Tape",
