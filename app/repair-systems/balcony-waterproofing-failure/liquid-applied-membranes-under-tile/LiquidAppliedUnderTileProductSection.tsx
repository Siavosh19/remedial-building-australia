...
const PRODUCTS: Product[] = [
  {
    ...
    productType: "Liquid-applied acrylic undertile membrane — wet area and balcony",
    filterTags: ["Acrylic", "Undertile", "Wet-area", "Balcony-terrace", "Water-based", "1C", "AS-4858"],
    techChips: [
      { label: "Acrylic liquid membrane", cls: "bg-slate-100 text-slate-700" },
    ...
    technicalProperties: [
      ...
      "Embed reinforcing fabric at all junctions, corners, drain surrounds and penetrations",
      "AS 4858 compliant — confirm current classification with Westox Building Products",
    ],
    limitations: [
      ...
      "Confirm current product specification and AS 4858 classification with Westox Building Products before specifying",
...
const TECH_INFO = {
  typicalApplications: [
    "Undertile waterproofing for balconies on Class 2 strata apartment buildings",
    "Wet area waterproofing — shower bases, bathroom floors and laundry areas",
    "Light commercial wet areas requiring AS 4858 compliant undertile membrane",
  ],
  selectionCriteria: [
    "Confirm whether acrylic or polyurethane membrane is specified — acrylic membranes have lower elongation than pure PU systems",
    "Specify pure PU membrane where active crack bridging or high elongation is required",
    "Confirm AS 4858 classification and elongation rating from Westox TDS before specifying",
    "Confirm primer compatibility and moisture content limits with Westox technical",
  ],
  limitations: [
    "Primer mandatory on all substrates — confirm Westox-compatible primer before application",
    "Two-coat minimum to achieve required DFT — single coat is insufficient",
    "Not suitable for direct trafficable or UV-exposed surfaces without protection",
    "Flood test mandatory before tiling",
  ],
  standardsNotes: [
    "AS 4858 — Wet Area Membranes — primary product compliance standard for liquid-applied balcony membranes",
    "AS 3740 — Waterproofing of Domestic Wet Areas — flood test requirements and DFT",
    "Confirm current AS 4858 classification with Westox Building Products",
  ],
  suitableDefects: [
    "Balcony waterproofing failure — undertile membrane replacement",
    "Wet area waterproofing failure — bathroom and laundry floor remediation",
  ],
  typicalSubstrates: [
    "In-situ reinforced concrete — primed per Westox requirements",
    "Fibre cement sheet and compressed fibre cement board",
    "Screeded concrete — confirm cure and moisture content before membrane",
  ],
};
...
export function LiquidAppliedUnderTileIntroSection() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
      <div className="mb-4 flex items-center gap-2.5">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-950 text-white"><BookOpen size={15} /></div>
        <h3 className="text-base font-extrabold text-sky-950">Liquid-applied undertile membranes for balcony and wet area waterproofing</h3>
      </div>
...
export function LiquidAppliedUnderTileProductSection() {
      ...
      <div>
        <div className="mb-5 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">1 product — liquid-applied acrylic undertile membrane — scroll to view</p>
          </div>
        </div>
