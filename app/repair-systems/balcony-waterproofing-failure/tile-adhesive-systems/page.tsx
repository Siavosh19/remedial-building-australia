...
import { TileAdhesiveProductSection } from "./TileAdhesiveProductSection";

export const metadata: Metadata = {
  title: "Tile Adhesive and Grout Systems — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for polymer-modified tile adhesives, epoxy tile adhesives, and grout systems used over waterproofing membranes on balconies and terraces in Australian Class 2 strata apartment buildings — membrane compatibility, AS/NZS 4992 classification, movement joint requirements, large format tile selection, brand comparisons, and system sequence.",
};
...
export default function TileAdhesiveSystemsPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Tile adhesive and grout systems</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 01</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Tile adhesive and grout systems — balcony over-membrane
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for polymer-modified tile adhesives, epoxy tile adhesives, and grout systems used over waterproofing membranes on balconies and terraces. Covers membrane compatibility, AS/NZS 4992 classification, movement joint requirements, large format tile selection, and brand comparisons for Australian Class 2 strata building applications.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System types", value: "Polymer / epoxy / grout" },
                  { label: "System position", value: "Over-membrane tile fixing" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end gap-0 overflow-x-auto">
              {SIBLING_TABS.map((tab) => {
                const active = tab.slug === "tile-adhesive-systems";
                return (
                  <a
                    key={tab.slug}
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-sky-950">What are tile adhesive and grout systems — balcony over-membrane?</h3>
              </div>
            ...
            {/* Client component — accordion + all three sections + table + warning boxes */}
            <TileAdhesiveProductSection />
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                This page provides general technical information only. Final product selection must be confirmed against the current manufacturer technical data sheet, project specification, membrane system compatibility, tile format and size, substrate condition, AS/NZS 4992 classification requirements, AS 3958.1 installation requirements, NCC requirements, and movement joint design. Epoxy adhesive systems require specialist application — confirm applicator experience and mixing requirements with the manufacturer before specifying. Do not rely on this reference as a substitute for professional waterproofing consultant or tiling contractor advice.
              </p>
            </div>
