...
import { TerminationBarsIntroSection, TerminationBarsProductSection } from "./TerminationBarsProductSection";

export const metadata: Metadata = {
  title: "Membrane Termination Bars & Accessories — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for aluminium and stainless-steel termination bar profiles that mechanically anchor the edge of liquid-applied and sheet membranes at wall and upstand terminations in Australian Class 2 strata apartment buildings.",
};
...
export default function MembraneTerminationBarsPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Fix type", value: "Mechanical fix" },
                  { label: "Standard", value: "AS 4654.2" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "membrane-termination-bars-accessories";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <TerminationBarsIntroSection />
            <TerminationBarsProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Product selection and installation details must be confirmed against the current manufacturer technical data sheet, the specific waterproofing membrane system specification, substrate conditions, AS 4654.2, AS 3740, and NCC requirements. Minimum membrane turn-up heights and termination details must be confirmed with the membrane manufacturer and a qualified waterproofing consultant. Do not rely on this reference as a substitute for professional engineering or waterproofing consultant advice.
              </p>
            </div>
