...
import { VCLIntroSection, VCLProductSection } from "./VCLProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Vapour Control Layers — Warm Roof — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
...
export default function VapourControlLayersWarmRoofPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Vapour control layers — warm roof</span>
            </nav>
            <PageNav />
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "vapour-control-layers-warm-roof";
                      return (
                        <a
                          key={tab.slug}
