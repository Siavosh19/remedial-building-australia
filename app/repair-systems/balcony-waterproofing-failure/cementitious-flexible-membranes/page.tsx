...
import { CementitiousProductSection } from "./CementitiousProductSection";

export const metadata: Metadata = {
  title: "Cementitious Flexible Waterproofing Membranes — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for two-component cementitious flexible waterproofing membranes used in balcony, terrace, and wet area waterproofing remediation on Australian Class 2 strata apartment buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function CementitiousFlexibleMembranesPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Cementitious flexible membranes</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for two-component polymer-modified cementitious waterproofing membranes. Covers product classification, AS 4858 class ratings, system selection, application requirements, and brand comparisons for Australian Class 2 strata building applications.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System types", value: "Two-component" },
                  { label: "Standards", value: "AS 4858 / AS 4654" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end gap-0 overflow-x-auto">
              {SIBLING_TABS.map((tab) => {
                const active = tab.slug === "cementitious-flexible-membranes";
                return (
                  <a
                    key={tab.slug}
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-sky-950">What are cementitious flexible waterproofing membranes?</h3>
              </div>
            ...
            {/* Interactive: accordion + product grid + system comparison */}
            <CementitiousProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse cementitious flexible membranes with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Polyurethane and hybrid liquid membranes (ARDEX WPM 157, Sikalastic-487, Bostik Dampfix PU, Gripset P39 and similar) — these are polymer-based, not cement-based, and typically have higher elongation — listed on the liquid applied PU and hybrid membrane page",
                  "Single-component acrylic and SBR membranes (Crommelin Wetite, Gripset 38FC and similar) — water-based polymer systems, not cementitious — listed on the liquid applied acrylic membrane page",
                  "Crystalline waterproofing (Xypex, Krystol and similar) — penetrating admixture systems, not surface-applied membrane-forming products",
                  "Rigid cementitious coatings — non-flexible cement coatings such as Maxseal Super or similar rigid tanking products — not the same as flexible two-part polymer-modified systems",
                  "Epoxy moisture barriers — two-part epoxy primers applied under floor adhesives — these are moisture barriers, not waterproof membranes",
                  "Sheet membranes — factory-manufactured sheet products (torch-on bitumen, self-adhesive butyl) — not liquid or trowel-applied systems",
                ].map((item) => (
