...
import { HobsProductSection, HobsIntroSection } from "./HobsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Balcony & Rooftop Hobs & Upstands — Precast, Cast-In, In-Situ & Masonry — Remedial Building Australia",
  description:
    "Technical product reference for balcony, terrace, roof and planter HOBS & UPSTANDS used in waterproofing remediation on Australian Class 2 strata apartment buildings — precast concrete hob frames, cast-in (lost-form) hobs, in-situ formed hobs, masonry core-filled hobs and precast lintel hobs, with size variants, forming methods and standards (AS 4654.2 / NCC / AS 3600 / AS 3700).",
};
...
export default function HobsUpstandsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Hobs &amp; upstands</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — Upstands</p>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System types", value: "5" },
                  { label: "Min hob size", value: "120 × 150 mm" },
                  { label: "Standard", value: "AS 4654.2 / NCC" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "hobs-upstands";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            {/* Interactive: accordion + product grid + comparison */}
            <HobsProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-3 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse structural hobs / upstands with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Hob and upstand selection, dimensions, reinforcement and dowelling must be confirmed against the structural and waterproofing design, manufacturer technical data, NCC requirements, and Australian Standards including AS 4654.2, AS 3600 and AS 3700. Fields marked &ldquo;CONFIRM&rdquo; are project- or manufacturer-specific and must be verified. Do not rely on this reference as a substitute for professional engineering or waterproofing consultant advice.
              </p>
            </div>
