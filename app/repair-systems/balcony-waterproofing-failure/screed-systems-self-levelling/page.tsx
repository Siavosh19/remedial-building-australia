...
import { SLScreedProductSection } from "./SLScreedProductSection";

export const metadata: Metadata = {
  title: "Self-Levelling Screed Systems — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for self-levelling screed systems used in balcony and terrace waterproofing remediation on Australian Class 2 strata apartment buildings — internal vs external use, pre-membrane substrate preparation, product selection, limitations, and brand comparisons.",
};
...
export default function ScreedSystemsSLPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Self-levelling screed systems</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 01</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Self-levelling screed systems — balcony waterproofing
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for self-levelling screed systems used in balcony and terrace waterproofing remediation. Covers internal vs external use, pre-membrane substrate preparation, product selection, application limitations, and brand comparisons for Australian Class 2 strata building applications.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Use categories", value: "Internal and external" },
                  { label: "System position", value: "Pre-membrane substrate prep" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end gap-0 overflow-x-auto">
              {SIBLING_TABS.map((tab) => {
                const active = tab.slug === "screed-systems-self-levelling";
                return (
                  <a
                    key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            {/* What are self-levelling screed systems */}
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-950 text-white">
                  <BookOpen size={15} />
                </div>
                <h3 className="text-base font-extrabold text-sky-950">What are self-levelling screed systems — balcony waterproofing?</h3>
              </div>
            ...
            <SLScreedProductSection />

            {/* Do not confuse warning box */}
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse self-levelling screeds with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Polymer-modified sand-cement screeds (ARDEX A 38, A 48, Mapecem Pronto, Topcem Pronto AU) — these are compacted screeds suitable for pre-membrane falls correction and over-membrane unbonded toppings — listed on the polymer-modified screed page",
                  "Internal self-levelling compounds (ARDEX K 15 Microtec, Mapei Ultraplan Eco, Ultraplan Maxi) — these are for internal use only and must not be used on external balconies under any circumstances",
                  "Over-membrane protection toppings — self-levelling compounds are not approved for application over liquid-applied waterproofing membranes — only A 38 / A 48 unbonded over a slip sheet is approved for this position in ARDEX systems",
                  "Waterproofing membranes — self-levelling screeds are substrate preparation products, not waterproofing — a classified membrane must always be applied above the screed",
                  "Tile adhesive beds — a tile adhesive bed is applied over the cured membrane, not over a self-levelling screed directly — confirm the correct system sequence",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                {
                  href: "/repair-systems/balcony-waterproofing-failure/screed-systems-polymer-modified",
