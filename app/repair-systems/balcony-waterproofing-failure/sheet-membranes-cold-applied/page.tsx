...
import { ColdAppliedProductSection } from "./ColdAppliedProductSection";

export const metadata: Metadata = {
  title: "Heat-Welded and Cold-Applied Self-Adhered Sheet Membranes — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for heat-welded and cold-applied self-adhered sheet membranes used in balcony and terrace waterproofing remediation on Australian Class 2 strata apartment buildings — product classification, system selection, and brand comparisons.",
};
...
export default function ColdAppliedSheetMembranesPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Heat-welded and cold-applied sheet membranes</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System types", value: "Heat-welded / Self-adhered" },
                  { label: "Standards", value: "AS 4654 / AS 4858" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end gap-0 overflow-x-auto">
              {SIBLING_TABS.map((tab) => {
                const active = tab.slug === "sheet-membranes-cold-applied";
                return (
                  <a
                    key={tab.slug}
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-sky-950">What are heat-welded and cold-applied self-adhered sheet membranes?</h3>
              </div>
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse heat-welded and cold-applied sheet membranes with:</h3>
              </div>
