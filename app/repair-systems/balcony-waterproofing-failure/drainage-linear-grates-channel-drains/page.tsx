        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Linear grates and channel drains</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 01</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Linear grates and channel drains — balcony waterproofing
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for linear grates and channel drains used in balcony, terrace, and podium waterproofing remediation. Covers stainless steel, PVC, and HDPE channel drain systems, tile insert and slot grate formats, load class selection, membrane compatibility, installation sequence, and brand comparisons for Australian Class 2 strata building applications.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Materials", value: "SS / PVC / HDPE" },
                  { label: "System position", value: "Edge and threshold drainage" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                This page provides general technical information only. Final product selection must be confirmed against the current manufacturer technical data sheet, project specification, substrate condition, membrane system requirements, NCC requirements, AS/NZS 3500.3 drainage requirements, AS 3740 fall requirements, AS 3996 load class requirements, and applicator warranty conditions. Do not rely on this reference as a substitute for professional engineering, hydraulic engineering, or waterproofing consultant advice.
              </p>
            </div>
