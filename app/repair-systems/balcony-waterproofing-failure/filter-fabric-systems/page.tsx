...
export const metadata: Metadata = {
  title: "Filter Fabric Systems — Podium and Planter Box Waterproofing — Remedial Building Australia",
  description:
    "Technical product reference for filter fabric systems used in balcony, roof deck, planter box and podium waterproofing remediation in Australian Class 2 strata buildings. Content coming soon.",
};
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-slate-200 bg-white p-12 shadow-sm text-center">
              ...
              <p className="mt-3 max-w-lg mx-auto text-sm leading-7 text-slate-500">
                Technical product reference, system comparisons and brand equivalents for filter fabric systems (planter boxes) will be published here. Check back soon.
              </p>
              <a
