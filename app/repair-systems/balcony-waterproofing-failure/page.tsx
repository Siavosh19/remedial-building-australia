...
export const metadata = {
  title: "Balcony Waterproofing Failure — Repair Systems — Class 2 Strata — Remedial Building Australia",
  description:
    "Product categories for balcony waterproofing repair in Australian Class 2 strata apartment buildings — liquid applied membranes, sheet systems, crystalline waterproofing, drainage accessories, penetration collars and flood test equipment.",
};

const PRODUCT_CATEGORIES = [
  { label: "Liquid applied membranes — polyurethane", count: 8, slug: "liquid-applied-membranes-polyurethane" },
  ...
  { label: "Cementitious crystalline waterproofing", count: 5, slug: "cementitious-crystalline-waterproofing" },
  ...
  { label: "Tapered insulation board systems", count: 4, slug: "tapered-insulation-board-systems" },
  ...
  { label: "Fire collars — intumescent", count: 3, slug: "fire-collars-intumescent" },
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Balcony waterproofing failure</span>
            </nav>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
              Technical repair system reference for balcony waterproofing failure in Australian Class 2 strata — select a product category to view system information, product comparisons and brand equivalents.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-8 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">18 product categories — select to view technical reference and brand equivalents.</p>
              </div>
            </div>
