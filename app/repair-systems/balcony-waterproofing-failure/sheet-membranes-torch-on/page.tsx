...
import { TorchOnProductSection } from "./TorchOnProductSection";
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-sky-950">What are torch-on bitumen modified sheet membranes?</h3>
              </div>
              <p className="text-sm leading-7 text-slate-600">
                Torch-on modified bitumen sheet membranes are factory-manufactured waterproofing sheets composed of a bitumen binder modified with either SBS (styrene-butadiene-styrene, an elastomeric rubber modifier) or APP (atactic polypropylene, a plastomeric modifier), reinforced with polyester or fibreglass carrier, and applied by gas torch to create a fully-bonded waterproof membrane layer. They are a well-established system for balcony, terrace, podium slab, and flat roof waterproofing in Australian remedial building practice. A two-layer system — base sheet plus cap sheet — is standard for balcony remediation on Class 2 strata buildings. The mineral granule-surfaced cap sheet provides a UV-stable, exposed or lightly trafficable finished surface where tiles or screed are not required.
              </p>
            </div>
