...
import { AcrylicProductSection } from "./AcrylicProductSection";

export const metadata: Metadata = {
  title: "Liquid-Applied Acrylic & SBR Waterproofing Membranes — Balcony Waterproofing Repair — Remedial Building Australia",
  description:
    "Technical product reference for liquid-applied acrylic, SBR polymer, and water-based waterproofing membranes for balcony, wet area, facade, and roof applications in Australian Class 2 strata buildings — product classification, exposure suitability, brand comparisons, and procurement sources.",
};
...
export default function LiquidAppliedAcrylicPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Liquid applied — acrylic & SBR</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 01</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Liquid-applied acrylic and water-based waterproofing membranes
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for liquid-applied acrylic, SBR polymer, and water-based waterproofing membranes. Covers product classification, exposure suitability, system selection, and brand comparisons for Australian Class 2 strata building applications.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Product types", value: "Acrylic / SBR" },
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end gap-0 overflow-x-auto">
              {SIBLING_TABS.map((tab) => {
                const active = tab.slug === "liquid-applied-membranes-acrylic";
                return (
                  <a
                    key={tab.slug}
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-sky-950">What are liquid-applied acrylic and water-based membranes?</h3>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-sky-950">Common uses — acrylic and water-based membranes</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Internal wet area waterproofing — bathrooms, laundries, ensuites under tiles",
                  "Under-tile balcony and terrace waterproofing where a covered membrane system is required",
                  "Exposed pedestrian deck and balcony surfaces — only where the specific product is rated for trafficable and UV-exposed use",
                  "External wall, facade, and parapet waterproofing and weather protection",
                  "Roof and deck weatherproofing — flat or low-slope roofs requiring a flexible waterproof coating",
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Technical limitations — do not assume product equivalence</h3>
              </div>
              <p className="mb-4 text-sm leading-6 text-amber-900">
                Acrylic and SBR water-based membranes should not be treated as automatically equal to polyurethane or polyurethane-hybrid membranes for exposed remedial balcony work. Product selection in this category depends on:
              </p>
              <ul className="mb-5 space-y-2">
                {[
                  "UV exposure — SBR systems are not formulated for prolonged direct sun and must be covered",
                  "Trafficability — only specifically rated acrylic systems are suitable as exposed pedestrian finishes",
                  "Movement and thermal cycling — SBR and acrylic have lower elongation than polyurethane — confirm against substrate movement expectations",
                  "Drainage — confirm the membrane detail at drains and penetrations matches the drainage system being used",
                  "Substrate condition — moisture content, surface profile, and adhesion test results",
                  "Whether the membrane is under-tile, under-screed, or exposed — these are not interchangeable",
                  "Primer requirements — mandatory for all products in this group",
                  "Reinforcing fabric requirements — required at all corners, junctions, and penetrations in most systems",
                  "Dry film thickness and number of coats — single-coat application is insufficient for any product in this group",
                  "Curing time before tiling, screed, or foot traffic — confirm with the current manufacturer TDS",
                  "Compatibility with tile adhesive, screed, toppings, or overlay coatings",
                  "AS 3740 and AS 4858 compliance — confirm classification with the manufacturer for the specific product",
                ].map((item) => (
              ...
              <p className="text-sm font-semibold leading-6 text-amber-900">
                Do not confuse products in this category with: polyurethane membranes (separate product group), cementitious flexible membranes (ARDEX 8+9, Mapelastic Foundation), sheet membranes, or epoxy moisture barriers.
              </p>
            </div>
