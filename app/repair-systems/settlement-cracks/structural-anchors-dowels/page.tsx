...
import { StructuralAnchorsDowelsIntroSection, StructuralAnchorsDowelsProductSection } from "./StructuralAnchorsDowelsProductSection";

export const metadata: Metadata = {
  title: "Structural Anchors & Dowels — Settlement Cracks — Remedial Building Australia",
  description:
    "Technical product reference for helical stainless steel crack stitching bars and chemical anchor dowels for structural repair of settlement cracks — Helifix CemTie, Thor Helical Bar, Hilti HIT-RE 500 V3, and Ramset Chemset Epoxy 500+ for masonry and concrete in Australia.",
};

const ACTIVE_SLUG = "structural-anchors-dowels";
...
export default function StructuralAnchorsDowelsPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Structural anchors &amp; dowels</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Structural anchors &amp; dowels</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for helical stainless steel crack stitching bars (Helifix, Thor Helical) for masonry, and epoxy chemical anchor dowels (Hilti HIT-RE 500 V3, Ramset Chemset) for concrete — settlement must be confirmed dormant and structural engineer assessment is required before stitching.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products covered", value: "4" },
                  { label: "Masonry system", value: "Helical SS bar" },
                  { label: "Concrete system", value: "Rebar + epoxy" },
                  { label: "Settlement status", value: "Confirm dormant" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <StructuralAnchorsDowelsIntroSection />
            <StructuralAnchorsDowelsProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse structural anchors with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/injection-resins-epoxy-rigid`, label: "Epoxy Rigid Injection", title: "Structural epoxy crack reinstatement before or after stitching" },
                { href: `${BASE}/lime-repointing-mortars`, label: "Lime Repointing", title: "Mortar joint reinstatement in masonry after helical bar installation" },
              ].map((card) => (
