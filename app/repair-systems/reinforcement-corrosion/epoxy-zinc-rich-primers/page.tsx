...
import { EpoxyZincRichPrimersIntroSection, EpoxyZincRichPrimersProductSection } from "./EpoxyZincRichPrimersProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Epoxy Zinc-Rich Rebar Primers — Reinforcement Corrosion — Remedial Building Australia",
  description:
    "Technical product reference for epoxy zinc-rich and cementitious rebar primers used in reinforcement corrosion repair on Australian structures — Fosroc Nitoprime Zincrich, Ardex BR 10 ZP, SikaTop Armatec 110 EpoCem, Mapei Mapefer 1K.",
};

const ACTIVE_SLUG = "epoxy-zinc-rich-primers";
...
export default function EpoxyZincRichPrimersPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Epoxy zinc-rich primers</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Epoxy zinc-rich rebar primers</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for epoxy zinc-rich and cementitious rebar primers applied directly to cleaned reinforcing steel in reinforcement corrosion repair — covers product selection, system compatibility, and application requirements for Australian structural repair.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products covered", value: "4" },
                  { label: "Prep standard", value: "St 2 min" },
                  { label: "Types", value: "Zinc-rich / Cement" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EpoxyZincRichPrimersIntroSection />
            <EpoxyZincRichPrimersProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse epoxy zinc-rich primers with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Migrating corrosion inhibitors (MCI) — surface-applied MCI products (Sika Ferrogard-903+, Cortec MCI-2020) migrate through concrete to the rebar; zinc-rich primers are applied directly to physically exposed and cleaned rebar — a completely different application",
                  "Galvanic anodes (cathodic protection) — discrete zinc anodes (Galvashield XP) provide electrochemical cathodic protection across a wider zone; zinc-rich primers provide localised galvanic protection only at the primed rebar surface",
                  "Concrete bonding agents — SBR latex and acrylic bonding agents improve mechanical bond between old and new concrete; zinc-rich primers protect rebar and do not perform the bonding agent function (SikaTop Armatec 110 EpoCem is an exception — it functions as both)",
                  "General anti-corrosion paints — industrial zinc-rich paints (used on structural steel) are not tested or approved for use in concrete repair and should not be substituted for EN 1504-7-approved rebar primers",
                  "Repair mortars — polymer-modified repair mortars are placed over the primed rebar to reinstate concrete cover; they are not rebar primers — both products are required in the repair sequence",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/repair-mortars-polymer-modified`, label: "Repair Mortars (PM)", title: "Polymer-modified repair mortars for reinforcement corrosion repair" },
