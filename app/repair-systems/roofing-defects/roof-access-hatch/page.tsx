...
import { RoofAccessIntroSection, RoofAccessProductSection } from "./RoofAccessProductSection";

export const metadata: Metadata = {
  title: "Roof Access Hatch — Roofing Defects Repair — Remedial Building Australia",
  description:
    "Technical product reference for aluminium and insulated roof access hatch systems for providing safe roof access on Australian Class 2 strata apartment buildings.",
};
...
export default function RoofAccessHatchPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Roof Access Hatch</span>
            </nav>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "roof-access-hatch";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <RoofAccessIntroSection />
            <RoofAccessProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Roof access hatch specification must comply with AS 1657 for fixed platforms and ladders and WHS Regulation 2017 Part 4.5 for working at heights. Product selection must be confirmed against opening size, structural support and the current manufacturer technical data sheet. Do not rely on this reference as a substitute for a licensed specialist.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  title: "Fixed double-glazed skylight replacement systems",
                },
                {
