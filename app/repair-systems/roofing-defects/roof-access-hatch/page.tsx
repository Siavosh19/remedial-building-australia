...
export const metadata = {
  title: "Roof Access Hatch — Roofing Defects — Remedial Building Australia",
  description:
    "Technical product reference for roof access hatch replacement on Australian Class 2 strata buildings — aluminium hatch systems and insulated hatch systems.",
};

const DEFECT_SLUG = "roof-access-hatch";

const GROUPS = [
  {
    heading: "Hatch Systems",
    items: [
      { label: "Aluminium hatch systems", slug: "aluminium-hatch-systems", count: 3, description: "Milcor, Gorter and equivalent aluminium roof access hatch systems for strata building roof access." },
      { label: "Insulated hatch systems", slug: "insulated-hatch-systems", count: 2, description: "Fakro LST, Milcor SSD and equivalent thermally insulated roof hatch systems with integrated ladder." },
    ],
  },
];
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
              Roof access hatch replacement systems
            </h1>
