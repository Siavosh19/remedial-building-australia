...
import { GutterReplacementIntroSection, GutterReplacementProductSection } from "./GutterReplacementProductSection";

export const metadata: Metadata = {
  title: "Gutter Replacement — Roofing Defects Repair — Remedial Building Australia",
  description:
    "Technical product reference for quad gutter, half-round gutter and box gutter replacement systems with leaf guard for external gutter failure on Australian Class 2 strata apartment buildings.",
};
      ...
      <main>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "gutter-replacement";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <GutterReplacementIntroSection />
            <GutterReplacementProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Gutter sizing must be confirmed by hydraulic design to AS/NZS 3500.3. Product selection must be confirmed against roof area, rainfall intensity, existing Colorbond colour match and the current manufacturer technical data sheet. Do not rely on this reference as a substitute for a licensed roofing specialist.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  title: "Generate a scope of works for gutter replacement",
                },
              ].map((card) => (
                <a
                  key={card.href}
