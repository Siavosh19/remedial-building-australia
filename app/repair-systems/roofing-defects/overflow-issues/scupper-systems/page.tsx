...
import { ScupperSystemsProductSection, ScupperSystemsIntroSection } from "./ScupperSystemsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Scupper Overflow Systems — Overflow Issues — Roofing Defects — Remedial Building Australia",
  description:
    "Technical product reference for scupper overflow systems used in flat and low-pitched roof secondary drainage compliance on Australian buildings — product selection, AS/NZS 3500.3, materials, and brand comparisons.",
};
...
export default function ScupperSystemsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Scupper systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Overflow level", value: "Primary drain +25–50mm" },
                  { label: "AS/NZS standard", value: "3500.3" },
                  { label: "Material", value: "SS316 or aluminium" },
                  { label: "Capacity", value: "≥50% primary drain" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "scupper-systems";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <ScupperSystemsIntroSection />

            <ScupperSystemsProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse scupper systems with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                {
                  href: "/repair-systems/roofing-defects/overflow-issues/weir-overflow-systems",
                  label: "Weir Overflow Systems",
                  title: "Weir overflow outlet systems for box gutter and flat roof compliance",
                },
                {
