...
import { PipeOverflowProductSection, PipeOverflowIntroSection } from "./PipeOverflowProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Pipe Overflow Systems — Overflow Issues — Roofing Defects — Remedial Building Australia",
  description:
    "Technical product reference for pipe overflow systems used in flat and low-pitched roof secondary drainage compliance on Australian buildings — product selection, AS/NZS 3500.3, uPVC and copper pipe systems.",
};
...
export default function PipeOverflowSystemsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Pipe overflow</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Min pipe size", value: "DN75" },
                  { label: "Activation height", value: "25–50mm above primary" },
                  { label: "AS/NZS standard", value: "3500.3" },
                  { label: "Materials", value: "uPVC, copper" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "pipe-overflow-systems";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <PipeOverflowIntroSection />

            <PipeOverflowProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse pipe overflow systems with:</h3>
              </div>
