...
import { WeirOverflowProductSection, WeirOverflowIntroSection } from "./WeirOverflowProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Weir Overflow Systems — Overflow Issues — Roofing Defects — Remedial Building Australia",
  description:
    "Technical product reference for weir overflow outlet systems used in box gutter and flat roof secondary drainage compliance on Australian buildings — product selection, AS/NZS 3500.3, aluminium and stainless steel weir outlets.",
};

const SIBLING_GROUPS = [
  { heading: "Overflow Systems", tabs: [
    { label: "Scupper systems", slug: "scupper-systems" },
    { label: "Pipe overflow", slug: "pipe-overflow-systems" },
    { label: "Weir overflow", slug: "weir-overflow-systems" },
  ]},
];

export default function WeirOverflowSystemsPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <Link href="/repair-systems/roofing-defects/overflow-issues" className="hover:text-sky-700 transition">Overflow Issues</Link>
              <span>/</span>
              <span className="text-sky-950">Weir overflow</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Weir height adjustment", value: "±30mm" },
                  { label: "Material", value: "SS316 / aluminium" },
                  { label: "AS standard", value: "3500.3" },
                  { label: "Box gutter min", value: "50mm freeboard" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "weir-overflow-systems";
                      return (
                        <Link
                          key={tab.slug}
                          href={`/repair-systems/roofing-defects/overflow-issues/${tab.slug}`}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <WeirOverflowIntroSection />

            <WeirOverflowProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse weir overflow systems with:</h3>
              </div>
              ...
              {[
                {
                  ...
                  title: "Browse all overflow issue product types",
                },
                {
                  href: "/repair-systems/roofing-defects/overflow-issues/scupper-systems",
                  label: "Scupper Systems",
                  title: "Scupper outlet systems for roof overflow compliance",
                },
                {
                  href: "/repair-systems/roofing-defects/overflow-issues/pipe-overflow-systems",
                  label: "Pipe Overflow Systems",
                  title: "Pipe overflow systems for flat and low-pitched roof drainage",
                },
                {
                  href: "/repair-systems/roofing-defects",
                  label: "Roofing Defects",
                  title: "Browse all roofing defect categories and repair systems",
                },
              ].map((card) => (
                <a
                  key={card.href}
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-7xl px-5 pt-10">
          <Link href="/repair-systems/roofing-defects/overflow-issues" className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm transition hover:bg-slate-200">
            ← Overflow Issues
          </Link>
        </div>
