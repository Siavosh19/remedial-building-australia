...
import { OverflowIssuesIntroSection, OverflowIssuesProductSection } from "./OverflowIssuesProductSection";

export const metadata: Metadata = {
  title: "Overflow Issues — Roofing Defects Repair — Remedial Building Australia",
  description:
    "Technical product reference for scupper outlets, pipe overflow and weir overflow systems for roof drainage overflow management on Australian Class 2 strata apartment buildings.",
};
...
export default function OverflowIssuesPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Overflow Issues</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Material", value: "Stainless / Aluminium" },
                  { label: "Standard", value: "AS/NZS 3500.3" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "overflow-issues";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <OverflowIssuesIntroSection />
            <OverflowIssuesProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Overflow sizing must be confirmed by hydraulic design to AS/NZS 3500.3 — overflow relief must be provided at each drainage zone. Product selection must be confirmed against the current manufacturer technical data sheet. Do not rely on this reference as a substitute for a professional engineer or hydraulic design consultant.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  label: "Poor Falls & Ponding",
                  title: "Screed and tapered insulation fall correction systems",
                },
                {
                  href: "/repair-systems/roofing-defects/box-gutter-failure",
                  label: "Box Gutter Failure",
                  title: "Box gutter lining and overflow systems",
                },
                {
                  href: "/ai-scope-builder",
                  label: "AI Scope Builder",
                  title: "Generate a scope of works for flat roof drainage",
                },
              ].map((card) => (
                <a
                  key={card.href}
