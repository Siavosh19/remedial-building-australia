...
export const metadata = {
  title: "Overflow Issues — Roofing Defects — Remedial Building Australia",
  description:
    "Technical product reference for overflow system installation and upgrade on Australian Class 2 strata buildings — scupper systems, pipe overflow systems and weir overflow systems for NCC-compliant roof drainage overflow.",
};

const DEFECT_SLUG = "overflow-issues";

const GROUPS = [
  {
    heading: "Overflow Systems",
    items: [
      { label: "Scupper systems", slug: "scupper-systems", count: 3, description: "Blucher, Geberit and Alproc stainless steel and aluminium scupper outlet systems for wall-mounted roof overflow compliance." },
      { label: "Pipe overflow systems", slug: "pipe-overflow-systems", count: 2, description: "PVC and copper pipe overflow systems with associated flashings for roof drainage overflow compliance on flat and low-pitched roofs." },
      { label: "Weir overflow systems", slug: "weir-overflow-systems", count: 2, description: "Alproc and Blucher proprietary weir overflow outlet systems for box gutter and flat roof overflow compliance." },
    ],
  },
];
