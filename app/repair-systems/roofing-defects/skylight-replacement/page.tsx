...
import { SkylightIntroSection, SkylightProductSection } from "./SkylightProductSection";

export const metadata: Metadata = {
  title: "Skylight Replacement — Roofing Defects Repair — Remedial Building Australia",
  description:
    "Technical product reference for fixed double-glazed skylight systems and aluminium flashing kits for skylight replacement on Australian Class 2 strata apartment buildings.",
};
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Materials", value: "Glass / Aluminium" },
                  { label: "Standard", value: "AS 2047" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "skylight-replacement";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SkylightIntroSection />
            <SkylightProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Skylight specification must be confirmed against opening size, roof pitch, glazing energy performance requirements (NCC Section J) and the current manufacturer technical data sheet. Do not rely on this reference as a substitute for a licensed roofing specialist or building designer.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  title: "Aluminium and insulated roof access hatch systems",
                },
                {
