...
import { StepFlashingAluminiumFFProductSection, StepFlashingAluminiumFFIntroSection } from "./StepFlashingAluminiumFFProductSection";

export const metadata: Metadata = {
  title: "Step Flashing Systems — Aluminium — Flashing Failures — Remedial Building Australia",
  description:
    "Technical product reference for aluminium step flashing systems used in roof flashing failure remediation on Australian buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function StepFlashingAluminiumFFPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Step flashing systems — aluminium</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 04</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Step flashing systems — aluminium
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for aluminium step flashing systems used in roof flashing failure remediation. Covers supplier options, finishing, painting of mill-finish aluminium, dissimilar metal precautions, and AS 1562.1 requirements for Australian residential and strata buildings.
                </p>
              </div>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "step-flashing-aluminium";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <StepFlashingAluminiumFFIntroSection />

            <StepFlashingAluminiumFFProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  "Lead chimney flashing (Austral Lead Code 4 or Code 5 sheet) — a completely different material — malleable, self-sealing at overlaps, heavier, and used for chimney apron, soakers and back gutter details — listed on the Chimney — lead page",
                  "Aluminium penetration flashing collars — preformed collar systems for pipes and vents — listed on the Penetration collars page",
                  ...
                  "Aluminium valley flashings — different roofing element at roof-plane junctions — not listed on this page",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Step flashing must comply with AS 1562.1 and tile manufacturer requirements. Final product selection must be confirmed against the current supplier data sheet, project specification, tile profile, wall construction, and mortar joint type. Installed by a licensed roofing contractor. Do not rely on this reference as a substitute for professional engineering or roofing consultant advice.
              </p>
            </div>
