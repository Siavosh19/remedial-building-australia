...
import { StepFlashingColorbondFFProductSection, StepFlashingColorbondFFIntroSection } from "./StepFlashingColorbondFFProductSection";

export const metadata: Metadata = {
  title: "Step Flashing Systems — Colorbond — Flashing Failures — Remedial Building Australia",
  description:
    "Technical product reference for Colorbond steel step flashing systems used in roof flashing failure remediation on Australian buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function StepFlashingColorbondFFPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Step flashing systems — Colorbond</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 04</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Step flashing systems — Colorbond steel
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for Colorbond steel step flashing systems used in roof flashing failure remediation. Covers product selection, forming methods, AS 1562.1 requirements, colour matching, and brand comparisons for Australian residential and strata buildings.
                </p>
              </div>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "step-flashing-colorbond";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <StepFlashingColorbondFFIntroSection />

            <StepFlashingColorbondFFProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse Colorbond step flashing with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Lead step flashing (Austral Lead Code 4 sheet) — a different material entirely, heavier, malleable, and self-sealing at overlaps — used for heritage buildings and high-specification chimney and tiled roof applications — listed on the Chimney — lead page",
                  ...
                  "Valley flashings — a different roofing element at the valley junction between two roof planes — a different product category",
                  "Penetration flashing collars — preformed collar systems for pipes and vents through roof — listed on the Penetration collars page",
                  "Colorbond roofing sheet — bulk roofing material, not a step flashing product — step flashings are formed from coil or pre-cut strip",
                ].map((item) => (
