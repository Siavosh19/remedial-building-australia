...
import { StepFlashingAluminiumProductSection, StepFlashingAluminiumIntroSection } from "./StepFlashingAluminiumProductSection";

export const metadata: Metadata = {
  title: "Step and Counter-Flashing — Aluminium — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for aluminium step and counter-flashing systems used in pitched tiled roof leak remediation on Australian buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function StepCounterFlashingAluminiumPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Step and counter-flashing — aluminium</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 04</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Step and counter-flashing systems — aluminium
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for aluminium step and counter-flashing systems used in pitched tiled roof leak remediation. Covers supplier options, finishing, painting of mill-finish aluminium, dissimilar metal precautions, and AS 1562.1 requirements for Australian residential and strata buildings.
                </p>
              </div>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "step-counter-flashing-aluminium";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <StepFlashingAluminiumIntroSection />

            <StepFlashingAluminiumProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse aluminium step flashing with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Colorbond step flashing (Lysaght/BlueScope or Stramit) — factory pre-painted steel, not aluminium — listed on the Step — Colorbond page — different forming characteristics and galvanic considerations",
                  "Lead step flashing (Austral Lead Code 3 or Code 4 sheet) — a completely different material — malleable, self-sealing at overlaps, heavier, and used for heritage applications — listed on the Step — lead page",
                  "Aluminium valley flashings — different roofing element at roof-plane junctions — listed on Valley — alum page",
                  "Aluminium penetration flashing collars — preformed collar systems for pipes and vents — listed on the Penetrations pages",
                  "Zincalume flashing — zinc-aluminium coated steel, not bare aluminium sheet — do not confuse material types when ordering from a fabricator",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Step flashing design must comply with tile manufacturer requirements and AS 1562.1. Final product selection must be confirmed against the current supplier data sheet, project specification, tile profile, wall construction, and mortar joint type. Installed by a licensed roofing contractor. Do not rely on this reference as a substitute for professional engineering or roofing consultant advice.
              </p>
            </div>
