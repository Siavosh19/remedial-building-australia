...
import { RidgeHipRebedProductSection, RidgeHipRebedIntroSection } from "./RidgeHipRebedProductSection";

export const metadata: Metadata = {
  title: "Ridge and Hip Capping Rebed Systems — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for flexible polymer mortar systems used for ridge and hip capping rebed on pitched tiled roofs in Australian Class 2 strata and residential buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function RidgeHipCappingRebedPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Ridge and hip capping rebed</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Polymer bedding mortar" },
                  { label: "Standard", value: "AS 4046 / NCC" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "ridge-hip-capping-rebed";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <RidgeHipRebedIntroSection />

            <RidgeHipRebedProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse polymer bedding mortar with:</h3>
              </div>
