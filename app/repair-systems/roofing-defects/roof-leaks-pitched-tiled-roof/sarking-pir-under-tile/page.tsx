...
import { SarkingPIRProductSection, SarkingPIRIntroSection } from "./SarkingPIRProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Sarking — PIR Under-Tile Insulation — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for PIR under-tile insulation board systems used in pitched tiled roof thermal upgrade on Australian buildings — Kingspan Kooltherm K107, Recticel Eurothane GP, Celotex RS5000 — product selection, R-value, NCC compliance.",
};
...
export default function SarkingPIRUnderTilePage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Sarking — PIR under-tile insulation</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "PIR insulation board" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "sarking-pir-under-tile";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <SarkingPIRIntroSection />

            <SarkingPIRProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse PIR under-tile insulation boards with:</h3>
              </div>
