...
import { PenetrationFlashingCollarProductSection, PenetrationFlashingCollarIntroSection } from "./PenetrationFlashingCollarProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Penetration Flashing Collar Systems — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for penetration flashing collar systems used in pitched tiled roof leak remediation on Australian buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function PenetrationFlashingCollarPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Penetration flashing collar systems — pitched tiled roofs
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for pre-formed and site-formed penetration flashing collar systems for round pipe and conduit penetrations through pitched tiled roofs. Covers Deks, Polyplas, and lead collar systems — size selection, pitch selection, and heritage applications.
                </p>
              </div>
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <PenetrationFlashingCollarIntroSection />

            <PenetrationFlashingCollarProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              ...
              <ul className="space-y-2.5">
                {[
                  "Penetration plinth systems (listed on the Plinths page) — plinths are raised box enclosures for penetrations through flat or low-slope roof areas where a standard pre-formed collar cannot be used — not the same as a collar flashing through a pitched tile field",
                  "Sealant-only terminations — applying silicone sealant around a pipe penetration without a flashing collar is not an acceptable weatherproofing method for a tiled roof — a collar flashing must be installed",
                  "Valley flashings, step flashings, and counter flashings — these are flashing products for the junctions between roof planes and wall structures, not for pipe penetrations",
                  "Roofing collar foam kits — expanding foam collars are not an accepted weatherproofing method for external pipe penetrations through tiled roofs — a pre-formed EPDM collar is required",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Confirm pipe OD, roof pitch and tile profile with Deks or Polyplas technical before ordering. Final product selection must be confirmed against the current manufacturer technical data sheet, project specification, pipe size, roof pitch, and tile profile. Installed by a licensed roof plumber. Do not rely on this reference as a substitute for professional roofing consultant advice.
              </p>
            </div>
