...
import { ValleyFlashingCopperProductSection, ValleyFlashingCopperIntroSection } from "./ValleyFlashingCopperProductSection";

export const metadata: Metadata = {
  title: "Copper Valley Flashing Systems — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for copper sheet valley flashing systems used in pitched tiled roof leak repair on Australian heritage and premium residential buildings — product classification, thickness selection, patina, dissimilar metals precautions, and brand comparisons.",
};
...
export default function ValleyFlashingCopperPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Valley flashing — copper</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Material", value: "Copper sheet" },
                  { label: "Standard", value: "AS 1432 / AS 1562" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "valley-flashing-copper";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <ValleyFlashingCopperIntroSection />

            <ValleyFlashingCopperProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse copper valley flashing with:</h3>
              </div>
