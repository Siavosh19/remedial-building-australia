...
import { RoofInsulationR4ProductSection, RoofInsulationR4IntroSection } from "./RoofInsulationR4ProductSection";

export const metadata: Metadata = {
  title: "Roof Insulation Systems — R4 — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for R4 ceiling batt insulation systems used in pitched tiled roof remediation on Australian buildings — Bradford Gold, Knauf Earthwool, Fletcher Optimo — product classification, system selection, NCC requirements, and brand comparisons.",
};
...
export default function RoofInsulationR4Page() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Roof insulation systems — R4</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 04</p>
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Roof insulation systems — R4 ceiling batts
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for R4.0 and R4.1 ceiling batt insulation systems. Covers product selection, AS/NZS 4859 classification, NCC minimum R-values by climate zone, glasswool vs polyester alternatives, and brand comparisons for Australian residential and Class 2 strata buildings.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "Ceiling batt insulation" },
                  { label: "Standard", value: "AS/NZS 4859 / NCC" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "roof-insulation-r4";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <RoofInsulationR4IntroSection />

            <RoofInsulationR4ProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse R4 ceiling batts with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Under-tile PIR sarking insulation board (Kingspan, Recticel and similar) — PIR boards are installed in the roof space under the roof tiles and over the sarking membrane — they are not ceiling batts and serve a different function — listed on the Sarking — PIR page",
                  "Reflective foil sarking (Bradford Anticon, Fletcher Sisalation and similar) — reflective foil is installed under the roof tiles in the roof space — it is a combined sarking and radiant heat barrier product, not a bulk insulation batt — listed on the Sarking — foil page",
                  "Mineral wool under-tile insulation (Bradford, Knauf, Rockwool under-tile products) — mineral wool under-tile products are installed in the roof space under tiles, not at the ceiling level — listed on the Sarking — mineral wool page",
                  "R6 or higher R-value ceiling batts — R4.0/R4.1 is the NCC minimum for climate zones 4–6 only — climate zones 7 and 8 require higher R-values — confirm with certifier",
                  "Wall insulation batts — wall batts have different widths, thicknesses, and R-values suited to wall stud spacing — do not substitute wall batts for ceiling batts",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Minimum R-value depends on NCC climate zone. Confirm with energy assessor or building certifier before specifying. Final product selection must be confirmed against the current manufacturer technical data sheet, project specification, joist spacing, and NCC Section J requirements. Ceiling insulation installation must comply with AS 3999. Do not rely on this reference as a substitute for professional engineering, energy assessment, or roofing consultant advice.
              </p>
            </div>
