...
import { ValleyFlashingAluminiumProductSection, ValleyFlashingAluminiumIntroSection } from "./ValleyFlashingAluminiumProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Aluminium Valley Flashing Systems — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for aluminium valley flashing systems used in pitched tiled roof leak repair on Australian residential and Class 2 strata buildings — product classification, system selection, fixing requirements, and brand comparisons.",
};
...
export default function ValleyFlashingAluminiumPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Valley flashing — aluminium</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Valley flashing systems — aluminium
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for aluminium valley flashing systems used in pitched tiled roof leak repair. Covers product classification, material options, fixing requirements, lapping, and brand comparisons for Australian residential and Class 2 strata applications under AS 1562.1.
                </p>
              </div>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "valley-flashing-aluminium";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <ValleyFlashingAluminiumIntroSection />

            <ValleyFlashingAluminiumProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse aluminium valley iron with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Colorbond valley iron (BlueScope/Lysaght/Stramit) — factory pre-painted Colorbond steel — different material, factory colour coating system, Zincalume or Colorbond steel substrate — listed on the Colorbond valley flashing page",
                  "Lead valley flashing — traditional soft lead sheet valley iron used in heritage and premium applications — different material, heavier, different working characteristics — listed on the copper valley page context",
                  "Zincalume valley iron (unpainted) — Zincalume steel without Colorbond colour coating — do not substitute for painted Colorbond or aluminium without confirming compatibility with tile type",
                  "Copper valley flashing — architectural copper sheet valley iron — different material, develops natural patina — listed on the copper valley flashing page",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Valley width, profile and lap must comply with tile manufacturer requirements. Confirm with roofing contractor. This page provides general technical information only. Final product selection must be confirmed against the current manufacturer technical data sheet, project specification, tile type, roof pitch, and AS 1562.1 requirements where applicable. Do not rely on this reference as a substitute for professional roofing or building consultant advice.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  title: "Generate a scope of works for valley flashing replacement",
                },
              ].map((card) => (
                <a
                  key={card.href}
