...
import { SarkingMineralWoolProductSection, SarkingMineralWoolIntroSection } from "./SarkingMineralWoolProductSection";

export const metadata: Metadata = {
  title: "Sarking — Mineral Wool Under-Tile Insulation — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for mineral wool under-tile insulation systems for pitched tiled roofs on Australian buildings — Bradford Gold glasswool, Knauf Earthwool, and ROCKWOOL stone wool — product selection, NCC R-value compliance, fire performance, and vapour management.",
};
...
export default function SarkingMineralWoolPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Sarking — mineral wool insulation</span>
            </nav>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "sarking-mineral-wool";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <SarkingMineralWoolIntroSection />

            <SarkingMineralWoolProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse mineral wool insulation with:</h3>
              </div>
