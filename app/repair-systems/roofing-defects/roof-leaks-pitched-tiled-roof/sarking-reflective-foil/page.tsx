...
import { SarkingReflectiveFoilProductSection, SarkingReflectiveFoilIntroSection } from "./SarkingReflectiveFoilProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Sarking — EHD Reflective Foil Systems — Roof Leaks — Remedial Building Australia",
  description:
    "Technical product reference for EHD anti-glare reflective foil sarking systems used in pitched tiled roof remediation on Australian buildings — Bradford Anticon, Sisalation 475, and Kingspan Thermofoil — product selection, NCC compliance, and installation requirements.",
};
...
export default function SarkingReflectiveFoilPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Sarking — EHD reflective foil</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "Reflective foil sarking" },
                  { label: "Standard", value: "AS 4201 / NCC" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "sarking-reflective-foil";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <SarkingReflectiveFoilIntroSection />

            <SarkingReflectiveFoilProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse EHD reflective foil sarking with:</h3>
              </div>
