...
import { PoorFallsIntroSection, PoorFallsProductSection } from "./PoorFallsProductSection";

export const metadata: Metadata = {
  title: "Poor Falls & Ponding — Flat Roofs — Roofing Defects Repair — Remedial Building Australia",
  description:
    "Technical product reference for polymer-modified lightweight screed, tapered insulation, drainage outlets and waterproofing membrane systems for poor falls and ponding water on flat roofs of Australian Class 2 strata apartment buildings.",
};
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Poor Falls &amp; Ponding — Flat Roofs</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Screed / Membrane" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "poor-falls-ponding-flat-roofs";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PoorFallsIntroSection />
            <PoorFallsProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Fall design must be confirmed by hydraulic analysis — minimum 1:100 fall required to drainage outlets. Product selection must be confirmed against substrate condition, loading capacity and the current manufacturer technical data sheet. Do not rely on this reference as a substitute for a professional engineer or licensed waterproofing consultant.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  title: "Box gutter lining systems",
                },
                {
                  href: "/ai-scope-builder",
                  label: "AI Scope Builder",
                  title: "Generate a scope of works for flat roof remediation",
                },
              ].map((card) => (
                <a
                  key={card.href}
