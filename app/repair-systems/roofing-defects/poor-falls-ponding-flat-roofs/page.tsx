...
export const metadata = {
  title: "Poor Falls and Ponding — Flat Roofs — Roofing Defects — Remedial Building Australia",
  description:
    "Technical product reference for poor falls and ponding water remediation on flat roofs in Australian Class 2 strata buildings — screed systems, tapered insulation, drainage outlets and waterproofing membranes.",
};

const DEFECT_SLUG = "poor-falls-ponding-flat-roofs";

const GROUPS = [
  {
    heading: "Fall Correction Systems",
    items: [
      { label: "Polymer-modified lightweight screed systems", slug: "polymer-modified-screed", count: 3, description: "ARDEX, Laticrete and Mapei polymer-modified lightweight screed systems for fall correction on flat roofs." },
      { label: "Tapered insulation board systems", slug: "tapered-insulation-board", count: 3, description: "Kingspan, Recticel and Rockwool PIR, XPS and mineral wool tapered insulation board systems for fall correction on flat roofs." },
    ],
  },
  {
    heading: "Drainage & Waterproofing",
    items: [
      { label: "Drainage outlet systems", slug: "drainage-outlet-systems", count: 3, description: "Blucher, Geberit and HL Hutterer flat roof drainage outlet and sump systems for flat roof ponding remediation." },
      { label: "Waterproofing membrane systems — flat roof", slug: "waterproofing-membrane-flat-roof", count: 3, description: "Sika Sarnafil, Protan and ARDEX liquid-applied waterproofing systems for flat roof waterproofing as part of ponding remediation." },
    ],
  },
];

export default function PoorFallsPondingFlatRoofsPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
              Poor falls and ponding — flat roof repair systems
            </h1>
