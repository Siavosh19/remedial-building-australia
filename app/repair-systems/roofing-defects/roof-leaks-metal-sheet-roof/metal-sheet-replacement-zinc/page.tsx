...
import { ZincProductSection, ZincIntroSection } from "./ZincProductSection";
...
export const metadata: Metadata = {
  title:
    "Metal Sheet Replacement — Zinc (Natural) — Roof Leaks Metal Sheet Roof — Remedial Building Australia",
  description:
    "Technical product reference for natural zinc sheet roof replacement — VMZINC, Rheinzink and natural zinc standing seam systems for Australian heritage and premium metal roof remediation.",
};
...
const ACTIVE_SLUG = "metal-sheet-replacement-zinc";
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Zinc (natural) sheet replacement</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Natural zinc sheet replacement systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Natural zinc roofing sheet (VMZINC, Rheinzink) is a titanium zinc alloy product that develops a self-healing blue-grey patina, specified for heritage, premium residential and architectural applications. It requires zinc-specialist installation, galvanic isolation from copper and ferrous metals, and thermal movement provision — fundamentally different constraints to Colorbond steel roofing.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Material", value: "Titanium zinc alloy" },
                  { label: "Thickness range", value: "0.65mm — 1.0mm" },
                  { label: "Min pitch (SS)", value: "3°" },
                  { label: "Patina", value: "Self-healing blue-grey" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                This page provides general technical information only. Natural zinc roofing requires specialist installer competency, heritage adviser input on heritage-listed buildings, galvanic compatibility assessment, structural engineer sign-off for loads, and confirmation against the current manufacturer TDS. Do not rely on this reference as a substitute for professional engineering, heritage or roofing consultant advice.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { href: `${BASE_URL}/metal-sheet-replacement-zincalume`, label: "Metal Sheets", title: "Zincalume sheet replacement" },
