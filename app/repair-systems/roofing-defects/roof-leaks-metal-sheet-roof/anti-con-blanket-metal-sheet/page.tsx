...
import { AntiConBlanketProductSection, AntiConBlanketIntroSection } from "./AntiConBlanketProductSection";
...
export const metadata: Metadata = {
  title:
    "Anti-Con Blanket — Metal Sheet Roof — Remedial Building Australia",
  description:
    "Technical product reference for anti-condensation blanket under metal sheet roofing — Bradford Anticon, Knauf and equivalent glasswool foil blankets for Australian metal roof remediation and NCC Section J compliance.",
};
...
const ACTIVE_SLUG = "anti-con-blanket-metal-sheet";
const BASE_URL = "/repair-systems/roofing-defects/roof-leaks-metal-sheet-roof";

export default function AntiConBlanketPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Anti-con blanket</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Anti-condensation blanket systems — metal sheet roof
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Bradford Anticon and equivalent glasswool/foil blankets are installed directly under metal sheet roofing on purlin tops to control condensation and contribute thermal resistance for NCC Section J compliance. The blanket alone does not guarantee NCC compliance — a thermal assessor must confirm the total roof assembly R-value for the applicable climate zone.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Common thickness", value: "75mm" },
                  { label: "Approx R-value", value: "R1.5 (blanket)" },
                  { label: "Standard", value: "NCC Section J" },
                  { label: "Foil face", value: "Down (cavity side)" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <AntiConBlanketIntroSection />
            <AntiConBlanketProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. NCC Section J compliance must be confirmed by a qualified thermal assessor for the specific building, climate zone and roof assembly. R-values stated are approximate blanket-only values — total roof assembly R-value depends on the complete assembly. Do not rely on this reference as a substitute for professional engineering or thermal assessor advice.</p>
            </div>
