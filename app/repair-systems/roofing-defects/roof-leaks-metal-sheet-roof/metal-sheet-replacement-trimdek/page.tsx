...
import {
  TrimdekProductSection,
  TrimdekIntroSection,
} from "./TrimdekProductSection";
...
export const metadata: Metadata = {
  title:
    "Metal Sheet Replacement — Trimdek — Roof Leaks Metal Sheet Roof — Remedial Building Australia",
  description:
    "Technical product reference for Trimdek high-rib trapezoidal metal sheet roof replacement — Lysaght Trimdek, Stramit TrimClad and equivalent Colorbond trapezoidal sheet systems for Australian Class 2 strata building metal roof remediation.",
};
...
const ACTIVE_SLUG = "metal-sheet-replacement-trimdek";
const BASE_URL = "/repair-systems/roofing-defects/roof-leaks-metal-sheet-roof";

export default function TrimdekPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <Link href="/repair-systems/roofing-defects/roof-leaks-metal-sheet-roof" className="hover:text-sky-700 transition">Roof Leaks — Metal Sheet Roof</Link>
              <span>/</span>
              <span className="text-sky-950">Trimdek sheet replacement</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Trimdek sheet replacement systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Trimdek is a high-rib trapezoidal steel roofing sheet with a 35mm rib height and 762mm cover width, widely used on Australian commercial and Class 2 strata buildings for its structural performance and flat-pan appearance. Replacement requires matching the trapezoidal profile exactly — Trimdek is not interchangeable with corrugated sheet or concealed-fix profiles.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Profile", value: "Trapezoidal (Hi-Rib)" },
                  { label: "BMT range", value: "0.42mm — 0.70mm" },
                  { label: "AS standard", value: "AS 1562.1" },
                  { label: "Substrate", value: "BlueScope Colorbond" },
                ].map((s) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  href: `${BASE_URL}/metal-sheet-replacement-colorbond-corrugated`,
                  label: "Metal Sheets",
                  title: "Corrugated — Colorbond sheet replacement",
                },
                {
                  href: `${BASE_URL}/metal-sheet-replacement-klip-lok`,
                  label: "Metal Sheets",
                  title: "Klip-Lok sheet replacement",
                },
                {
                  href: `${BASE_URL}/ridge-barge-cappings-metal`,
                  label: "Cappings & Accessories",
                  title: "Ridge and barge cappings — metal",
                },
                {
                  href: `${BASE_URL}/roofing-screws-sealing-washers`,
                  label: "Cappings & Accessories",
                  title: "Roofing screws and sealing washers",
                },
                {
                  href: BASE_URL,
