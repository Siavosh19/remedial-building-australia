...
import { RidgeBargeCappingsProductSection, RidgeBargeCappingsIntroSection } from "./RidgeBargeCappingsProductSection";
...
export const metadata: Metadata = {
  title:
    "Ridge and Barge Cappings — Metal Sheet Roof — Remedial Building Australia",
  description:
    "Technical product reference for ridge and barge cappings on metal sheet roofs — Lysaght, Stramit and Stratco Colorbond ridge and barge cappings for Australian metal roof remediation.",
};
...
const ACTIVE_SLUG = "ridge-barge-cappings-metal";
const BASE_URL = "/repair-systems/roofing-defects/roof-leaks-metal-sheet-roof";

export default function RidgeBargeCappingsPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Ridge and barge cappings</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Min lap", value: "150mm" },
                  { label: "Lap seal", value: "Butyl tape" },
                  { label: "Fix", value: "Class 3/4 screws" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <RidgeBargeCappingsIntroSection />
            <RidgeBargeCappingsProductSection />
          </div>
        </section>
