...
import { RoofingScrewsProductSection, RoofingScrewsIntroSection } from "./RoofingScrewsProductSection";

export const metadata: Metadata = {
  title:
    "Roofing Screws and Sealing Washers — Metal Sheet Roof — Remedial Building Australia",
  description:
    "Technical product reference for roofing screws and EPDM sealing washers — Buildex Class 3 and Class 4 hex-head self-drilling roofing screws for Australian metal sheet roof remediation under AS 3566.2.",
};
...
const ACTIVE_SLUG = "roofing-screws-sealing-washers";
const BASE_URL = "/repair-systems/roofing-defects/roof-leaks-metal-sheet-roof";

export default function RoofingScrewsPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Roofing screws and sealing washers</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Standard gauge", value: "14g (5.5mm)" },
                  { label: "Corrosion class", value: "AS 3566.2 Class 3/4" },
                  { label: "Min engagement", value: "3 full turns" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <RoofingScrewsIntroSection />
            <RoofingScrewsProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Final screw class, length, quantity and spacing must be confirmed against the current manufacturer TDS, AS 3566.2, the structural engineer specification and the sheet manufacturer warranty conditions. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
