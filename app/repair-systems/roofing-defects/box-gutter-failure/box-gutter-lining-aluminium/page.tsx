...
import { BoxGutterAluminiumProductSection, BoxGutterAluminiumIntroSection } from "./BoxGutterAluminiumProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Box Gutter Lining — Aluminium — Box Gutter Failure — Remedial Building Australia",
  description:
    "Technical product reference for aluminium sheet box gutter lining systems used in box gutter failure remediation on Australian Class 2 strata apartment buildings — product classification, system selection, limitations, and brand comparisons.",
};
...
export default function BoxGutterLiningAluminiumPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Aluminium lining</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Material", value: "Aluminium sheet" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "box-gutter-lining-aluminium";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <BoxGutterAluminiumIntroSection />

            <BoxGutterAluminiumProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse aluminium box gutter lining with:</h3>
              </div>
