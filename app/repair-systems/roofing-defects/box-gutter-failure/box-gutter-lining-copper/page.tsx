...
import { BoxGutterCopperProductSection, BoxGutterCopperIntroSection } from "./BoxGutterCopperProductSection";

export const metadata: Metadata = {
  title: "Box Gutter Lining — Copper — Box Gutter Failure — Remedial Building Australia",
  description:
    "Technical product reference for copper sheet box gutter lining systems used in box gutter failure remediation on Australian Class 2 strata apartment buildings — product classification, heritage requirements, dissimilar metal precautions, and brand comparisons.",
};
...
export default function BoxGutterLiningCopperPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Copper lining</span>
            </nav>
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "box-gutter-lining-copper";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <BoxGutterCopperIntroSection />

            <BoxGutterCopperProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse copper box gutter lining with:</h3>
              </div>
