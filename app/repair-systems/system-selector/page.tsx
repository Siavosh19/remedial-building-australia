...
export const metadata: Metadata = {
  title: "System Selector — Remedial Building Australia",
  description:
    "Choose the right concrete and structural defect repair system for your project — by defect type, orientation, depth, and site conditions.",
};
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">System Selector</span>
            </nav>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
              Answer a few questions about your defect and site conditions. The selector will assemble the appropriate multi-stage repair system and matching products.
            </p>
          </div>
        </section>
