...
const SUBCATEGORIES = [
  ...
  },
  {
    ...
    count: 10,
    description:
      "Migrating corrosion inhibitors (MCI), epoxy zinc-rich primers, rebar coatings, cathodic protection systems, CFRP strips and epoxy laminating resins for corrosion-induced concrete damage in chloride-affected and carbonated structures.",
    live: true,
  },
  {
  ...
  },
  {
    ...
    count: 4,
    description:
      "Moisture suppression primers, self-levelling underlayments, floor patching compounds and grinding equipment for encapsulation, repair and overlay of deteriorated magnesite composite flooring in Class 2 strata buildings.",
    live: true,
  },
] as const;
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
              Technical repair system reference for concrete and structural defects in Australian Class 2 strata — select a defect subcategory to view product categories, system information and brand equivalents.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-8 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Select a defect type to browse product categories and brand comparisons.</p>
              </div>
            </div>
