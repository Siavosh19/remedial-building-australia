...
export const metadata: Metadata = {
  title: "Epoxy Rigid Injection Resins — Concrete Cracking — Remedial Building Australia",
  description:
    "Technical product reference for epoxy rigid injection resins for structural crack reinstatement in concrete — Sika Injection-451, Fosroc Concresive 1414, Mapei Mapeject 52, and Ardex FK 45 for dormant dry crack repair in Australian structures.",
};
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Crack condition", value: "Dry only" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              ...
              <ul className="space-y-2.5">
                {[
                  "PU flexible injection resins — polyurethane resins (Sika Injection-107, Fosroc Nitoflex PU) seal water ingress and tolerate crack movement; epoxy resins structurally re-join crack faces into a bond exceeding the parent concrete — completely different function and performance class",
                  "Epoxy anchoring adhesives — anchoring adhesives (Hilti HIT-RE 500 V3, Ramset Chemset) are formulated for drilled cylindrical holes with rebar or threaded rod; injection resins are formulated for crack trace infiltration under low pressure through surface ports",
                  "Epoxy bonding agents — SBR latex and acrylic bonding agents (Sika Primer-01, Ardex Arditex) are brush-applied to concrete surfaces to improve substrate bond for overlay mortars; they are not injectable into crack traces",
                  "Epoxy laminating resins — two-component epoxy resins used for CFRP strip bonding (Sika CarboDur, MBrace) are formulated for fibre saturation and adhesive bond; they are not injection-grade and have the wrong viscosity for crack penetration under pressure",
                  "Crack port adhesive (epoxy paste) — fast-setting epoxy pastes (Sika Monotop 623, Fosroc Nitomortar FC) bond surface ports to concrete and seal crack surfaces between ports; they are adhesive pastes applied to the surface, not injected into the crack",
                ].map((item) => (
