...
export const metadata: Metadata = {
  title: "Concrete Crack Stitching — Concrete Cracking — Remedial Building Australia",
  description:
    "Technical product reference for concrete crack stitching — proprietary carbon-fibre stitches (Ardex Concrete Crack Lock, Fortress) and custom-fabricated austenitic stainless staples/dowels — re-establishing tensile continuity across dormant structural cracks to ACI 224.1R / AS 3600.",
};

const ACTIVE_SLUG = "crack-stitching";
...
export default function CrackStitchingPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Crack stitching</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Concrete crack stitching</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for crack stitching across dormant structural cracks in concrete — proprietary carbon-fibre stitches and custom-fabricated austenitic stainless staples/dowels bonded with a structural epoxy to re-establish tensile continuity. Stitch size, number, spacing and embedment are engineer-determined to ACI 224.1R / AS 3600.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products covered", value: "3" },
                  { label: "Crack condition", value: "Dormant / structural" },
                  { label: "Sizing basis", value: "Engineer-determined" },
                  { label: "Standard", value: "ACI 224.1R / AS 3600" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse crack stitching with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. All crack stitching is a structural intervention and must be designed by a structural engineer to ACI 224.1R / AS 3600 — there is no crack-width → size lookup. Final product selection, stitch sizing, spacing, embedment and bonding adhesive must be confirmed against the current manufacturer TDS and the engineer&rsquo;s design. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/epoxy-anchoring-adhesives`, label: "Epoxy Anchoring Adhesives", title: "Structural adhesives used to bond steel stitches and dowels" },
                { href: `${BASE}/cfrp-strips-laminates`, label: "CFRP Strips & Laminates", title: "External CFRP strengthening across structural cracks" },
              ].map((card) => (
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 md:grid-cols-[1.2fr_1fr]">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm font-semibold leading-6 text-sky-900">Australia&rsquo;s remedial building directory — business listings, industry news, jobs and expert desktop review.</p>
          </div>
