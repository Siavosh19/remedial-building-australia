...
import { EpoxyAnchoringAdhesivesCCIntroSection, EpoxyAnchoringAdhesivesCCProductSection } from "./EpoxyAnchoringAdhesivesCCProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Epoxy Anchoring Adhesives — Concrete Cracking — Remedial Building Australia",
  description:
    "Technical product reference for epoxy anchoring adhesives used in structural crack stitching and dowel installation — Hilti HIT-RE 500 V3, Sika AnchorFix-3+, Ramset Chemset Epoxy 500+, and Mapei Mapefox EW for AS 5216 crack stitching in Australia.",
};
...
export default function EpoxyAnchoringAdhesivesCCPage() {
  return (
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Epoxy anchoring adhesives</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for epoxy and epoxy-acrylate anchoring adhesives used in structural crack stitching and crack-crossing dowel installation — covers AS 5216 compliance, hole condition suitability, and cartridge systems for Australian structural repair.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products covered", value: "4" },
                  { label: "Design standard", value: "AS 5216" },
                  { label: "Hole cleaning", value: "Blow-brush-blow" },
                  { label: "Engineer design", value: "Required" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EpoxyAnchoringAdhesivesCCIntroSection />
            <EpoxyAnchoringAdhesivesCCProductSection />
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/repair-systems/reinforcement-corrosion/epoxy-anchoring-adhesives", label: "RC — Anchoring Adhesives", title: "Epoxy anchoring adhesives in the reinforcement corrosion context" },
