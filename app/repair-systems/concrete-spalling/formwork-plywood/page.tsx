...
export const metadata: Metadata = {
  ...
  description:
    "Technical product reference for F11 structural plywood and film-faced formply used as concrete formwork in concrete spalling repair — slab edge, column, and beam soffit boxing in Australian remedial work.",
};

const ACTIVE_SLUG = "formwork-plywood";
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Min. grade", value: "F11" },
                  { label: "Std. thickness", value: "17 mm" },
                  { label: "Reuse (film-faced)", value: "8–20+ pours" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <FormworkPlywoodIntroSection />

            <FormworkPlywoodProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse structural formwork plywood with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/form-release-agents`, label: "Form Release Agents", title: "Release agents applied to plywood formwork before placing mortar" },
