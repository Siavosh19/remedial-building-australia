...
import { FormworkTimberIntroSection, FormworkTimberProductSection } from "./FormworkTimberProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Formwork Timber, Bearers and Props — Concrete Spalling — Remedial Building Australia",
  description:
    "Technical product reference for MGP10 pine framing, DAR pine soldiers, hardwood props, and Acrow adjustable props used in concrete spalling repair formwork on Australian structures.",
};

const ACTIVE_SLUG = "formwork-timber";
...
export default function FormworkTimberPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Formwork timber</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Min. framing grade", value: "MGP10" },
                  { label: "Formwork standard", value: "AS 3610" },
                  { label: "Prop type", value: "Acrow / hardwood" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <FormworkTimberIntroSection />

            <FormworkTimberProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse formwork timber and props with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/formwork-plywood`, label: "Formwork Plywood", title: "F11 structural plywood used as form face supported by timber framing" },
