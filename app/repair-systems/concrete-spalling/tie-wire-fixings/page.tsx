...
import { TieWireFixingsIntroSection, TieWireFixingsProductSection } from "./TieWireFixingsProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Tie Wire, Bar Chairs and Formwork Fixings — Concrete Spalling — Remedial Building Australia",
  description:
    "Technical product reference for annealed tie wire, plastic bar chairs, chemical anchor injection systems, and formwork ties used in concrete spalling repair on Australian structures.",
};

const ACTIVE_SLUG = "tie-wire-fixings";
...
export default function TieWireFixingsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Tie wire &amp; fixings</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Cover per", value: "AS 3600" },
                  { label: "Anchor standard", value: "AS 5216" },
                  { label: "Types", value: "Wire / chair / anchor" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <TieWireFixingsIntroSection />

            <TieWireFixingsProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse tie wire, bar chairs and fixings with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/rebar-primers-inhibitors`, label: "Rebar Primers", title: "Corrosion inhibitor primers applied to cleaned rebar before mortar" },
