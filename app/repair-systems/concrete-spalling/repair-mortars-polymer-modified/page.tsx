...
export const metadata: Metadata = {
  title: "Polymer-Modified Repair Mortars — Concrete Spalling — Remedial Building Australia",
  description:
    "Technical product reference for polymer-modified cementitious repair mortars for concrete spalling repair in Australian Class 2 strata, carparks and civil structures — Sika MonoTop, Ardex BR, Fosroc Renderoc, and Mapei Mapegrout system comparisons.",
};
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Repair mortars (polymer-modified)</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Mortar grades", value: "3" },
                  { label: "EN standard", value: "EN 1504-3" },
                  { label: "Max layer (high-build)", value: "100 mm" },
                ].map((s) => (
