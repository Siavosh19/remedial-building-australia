...
export const metadata: Metadata = {
  title: "Acrylic Curing Compounds for Repair Mortars — Concrete Spalling — Remedial Building Australia",
  description:
    "Technical product reference for spray-applied acrylic and wax-emulsion curing compounds used to retain moisture in fresh repair mortar after concrete spalling repair on Australian structures.",
};
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Standard", value: "ASTM C309" },
                  { label: "Apply after", value: "Initial set" },
                  { label: "Types", value: "Acrylic & wax" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/curing-sheeting`, label: "Curing Sheeting", title: "Polyethylene curing sheeting — alternative to spray-applied curing compounds" },
