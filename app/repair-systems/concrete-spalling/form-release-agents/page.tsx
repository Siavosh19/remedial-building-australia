...
import { FormReleaseAgentsIntroSection, FormReleaseAgentsProductSection } from "./FormReleaseAgentsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Form Release Agents for Concrete Repair Formwork — Concrete Spalling — Remedial Building Australia",
  description:
    "Technical product reference for water-based reactive, wax emulsion, and petroleum form release agents used on plywood and steel formwork in concrete spalling repair and reinstatement.",
};

const ACTIVE_SLUG = "form-release-agents";
...
export default function FormReleaseAgentsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Form release agents</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Preferred type", value: "Water-based" },
                  { label: "Apply to", value: "Dry formwork" },
                  { label: "Best staining", value: "Very low" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <FormReleaseAgentsIntroSection />

            <FormReleaseAgentsProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse form release agents with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/formwork-plywood`, label: "Formwork Plywood", title: "F11 structural plywood used as formwork face for concrete repair" },
