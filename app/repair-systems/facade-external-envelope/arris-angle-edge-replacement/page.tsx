...
import { ArrisAngleIntroSection, ArrisAngleProductSection } from "./ArrisAngleProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Arris Angle & Edge Replacement — Facade Repair — Remedial Building Australia",
  description:
    "Technical product reference for aluminium, stainless steel and PVC arris angle bead systems for replacement of damaged render returns at external corners and edges of Class 2 strata facades in Australia.",
};
...
export default function ArrisAngleEdgeReplacementPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Arris Angle &amp; Edge Replacement</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Arris Angle &amp; Edge Replacement
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for aluminium, stainless steel and PVC arris angle bead systems for replacement of damaged or missing render returns at external corners and edges of Class 2 strata facades in Australia.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Materials", value: "Al / SS / PVC" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "arris-angle-edge-replacement";
                      return (
                        <Link
                          key={tab.slug}
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ArrisAngleIntroSection />
            <ArrisAngleProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Arris angle selection must be confirmed against substrate type, exposure category, render system and the current manufacturer technical data sheet. In coastal and corrosive environments stainless steel arris angles are recommended. Confirm compliance with AS 3700. Do not rely on this reference as a substitute for professional advice.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  label: "Render Cracking & Delamination",
                  title: "Render repair mortars, coatings and primers",
                },
                {
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-7xl px-5 pt-10">
          <Link href="/repair-systems/facade-external-envelope" className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm transition hover:bg-slate-200">
