...
import { MovementBeadIntroSection, MovementBeadProductSection } from "./MovementBeadProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Movement & Expansion Beads — Arris Angles & Render Beads — Remedial Building Australia",
  description:
    "Technical product reference for movement and expansion beads used at render control joints on Australian facade remediation projects — aluminium and PVC profiles, control joint spacing, coastal selection, substrate changes.",
};

const ACTIVE_SLUG = "movement-expansion-beads";
...
export default function MovementExpansionBeadsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Movement &amp; expansion beads</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Movement &amp; expansion beads
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for movement and expansion beads used at render control joints on Australian facade remediation projects. Covers aluminium and PVC profiles, control joint requirements, movement capacity, and selection for coastal environments.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Use", value: "Movement joints" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <MovementBeadIntroSection />

            <MovementBeadProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse movement and expansion beads with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Render stop beads — terminate render at edges without movement capacity — used at render terminations, not control joints",
                  "Expansion joint cover plates — structural cover plates for large structural expansion joints — different product class from render beads",
                  "Arris corner beads — protect external render corners — no movement capacity",
                  "Control joint sealants — sealant applied within a formed joint — no bead profile",
                ].map((item) => (
