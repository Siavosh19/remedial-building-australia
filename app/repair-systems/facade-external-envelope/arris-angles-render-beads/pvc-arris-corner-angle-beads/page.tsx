...
import { PVCArrisIntroSection, PVCArrisProductSection } from "./PVCArrisProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "PVC Arris & Corner Angle Beads — Arris Angles & Render Beads — Remedial Building Australia",
  description:
    "Technical product reference for UV-stabilised PVC arris and corner angle beads used in all-environment render repair and reinstallation works on Australian Class 2 strata and commercial buildings — corrosion-resistant alternative to metal beads.",
};

const ACTIVE_SLUG = "pvc-arris-corner-angle-beads";
...
export default function PVCArrisPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">PVC arris &amp; corner angle beads</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  PVC arris &amp; corner angle beads
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for UV-stabilised PVC arris and corner angle beads used in render repair, removal and reinstallation works on Australian Class 2 strata and commercial buildings. Covers UV stabilisation requirements, environment suitability, and product comparisons.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products listed", value: "3" },
                  { label: "Material", value: "UV-stabilised PVC" },
                  { label: "Use", value: "All environments" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <PVCArrisIntroSection />

            <PVCArrisProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse PVC arris beads with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Aluminium beads (metal — preferred in high-impact locations)",
                  "Stainless steel beads (metal — preferred in high-corrosion environments)",
                  "Mesh-wing beads (integral fibreglass mesh flange)",
                  "Render stop beads (different profile — render termination not corner protection)",
                ].map((item) => (
