...
import { RevealBeadIntroSection, RevealBeadProductSection } from "./RevealBeadProductSection";

export const metadata: Metadata = {
  title: "Reveal Beads — Arris Angles & Render Beads — Remedial Building Australia",
  description:
    "Technical product reference for reveal beads used at window and door reveals on Australian facade remediation projects — aluminium and PVC profiles, coastal selection, replacement during render repair works.",
};

const ACTIVE_SLUG = "reveal-beads";
...
export default function RevealBeadsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Reveal beads</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for reveal beads used at window and door reveals on Australian facade remediation projects. Covers aluminium and PVC profiles, coastal material selection, frame clearance requirements, and replacement criteria during render repair works.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Use", value: "Window/door reveals" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <RevealBeadIntroSection />

            <RevealBeadProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse reveal beads with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Arris corner beads — protect external corners on the facade face — reveal beads are specific to window and door reveal edges",
                  "Render stop beads — terminate render at edges without a reveal-specific profile — used at general render terminations, not window perimeters",
                  "Bellcast beads — installed at slab edges and window sills for water shedding — different location and function from reveal beads",
                  "Window flashing — metal flashing installed at sill or head of window opening — different product class from render beads",
                ].map((item) => (
