...
import { RenderStopBeadIntroSection, RenderStopBeadProductSection } from "./RenderStopBeadProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Render Stop Beads & Screed Beads — Arris Angles & Render Beads — Remedial Building Australia",
  description:
    "Technical product reference for aluminium and PVC render stop beads and screed beads used in render repair and reinstallation works on Australian Class 2 strata and commercial buildings — slab soffit, window head, control joint termination.",
};

const ACTIVE_SLUG = "render-stop-beads";
...
export default function RenderStopBeadsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Render stop beads &amp; screed beads</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Render stop beads &amp; screed beads
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for aluminium and PVC render stop beads and screed beads used in render repair, removal and reinstallation works on Australian Class 2 strata and commercial buildings. Covers render termination locations, material selection, and product comparisons.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Use", value: "Render termination" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <RenderStopBeadIntroSection />

            <RenderStopBeadProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse render stop beads with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Arris corner beads (protect corners — render stop beads terminate render edges)",
                  "Bellcast/drip beads (specific drip profile at slab edges — different profile)",
                  "Movement/expansion beads (allow movement — different function)",
                  "Reveal beads (window/door reveals — different profile)",
                ].map((item) => (
