...
import { StainlessSteelArrisIntroSection, StainlessSteelArrisProductSection } from "./StainlessSteelArrisProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Stainless Steel Arris & Corner Angle Beads — Arris Angles & Render Beads — Remedial Building Australia",
  description:
    "Technical product reference for Grade 316 stainless steel arris and corner angle beads used in coastal and corrosive environment render repair and reinstallation works on Australian Class 2 strata and commercial buildings.",
};

const ACTIVE_SLUG = "stainless-steel-arris-corner-angle-beads";
...
export default function StainlessSteelArrisPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Stainless steel arris &amp; corner angle beads</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Stainless steel arris &amp; corner angle beads
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for Grade 316 stainless steel arris and corner angle beads used in coastal and corrosive environment render repair and reinstallation works on Australian Class 2 strata and commercial buildings. Covers material grade selection, product comparison, and application guidance.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products listed", value: "3" },
                  { label: "Material", value: "Grade 316 SS" },
                  { label: "Use", value: "Coastal/corrosive" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <StainlessSteelArrisIntroSection />

            <StainlessSteelArrisProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse stainless steel arris beads with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Aluminium beads (not suitable in coastal environments)",
                  "Galvanised steel beads (may corrode in coastal environments)",
                  "PVC beads (plastic — no structural edge)",
                  "Mesh-wing beads (integral mesh flange — different product)",
                ].map((item) => (
