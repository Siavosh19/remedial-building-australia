...
import { MeshWingBeadIntroSection, MeshWingBeadProductSection } from "./MeshWingBeadProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Mesh-Wing Render Beads — Arris Angles & Render Beads — Remedial Building Australia",
  description:
    "Technical product reference for mesh-wing render beads used for corner and edge reinforcement on Australian facade remediation projects — alkali-resistant fibreglass mesh wings, aluminium and PVC profiles, AR mesh specification.",
};

const ACTIVE_SLUG = "mesh-wing-render-beads";
...
export default function MeshWingRenderBeadsPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Mesh-wing render beads</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Mesh-wing render beads
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for mesh-wing render beads used for corner and edge reinforcement on Australian facade remediation projects. Covers alkali-resistant fibreglass mesh integration, aluminium and PVC profiles, AR mesh specification, and application in re-rendering and EIFS systems.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products", value: "3" },
                  { label: "Materials", value: "Aluminium / PVC + fibreglass mesh" },
                  { label: "Use", value: "Corner & edge reinforcement" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <MeshWingBeadIntroSection />

            <MeshWingBeadProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse mesh-wing render beads with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Standard arris corner beads — perforated flange only, no integral mesh wing — do not provide the same level of tensile reinforcement at corners",
                  "Fibreglass reinforcing mesh (roll mesh) — applied separately as a continuous sheet over the render base coat — not integral to the bead profile",
                  "EIFS mesh — fibreglass mesh embedded in render over EPS insulation board — different application and specification from mesh-wing bead reinforcement",
                ].map((item) => (
