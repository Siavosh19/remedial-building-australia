...
import { SaltResistantRenderIntroSection, SaltResistantRenderProductSection } from "./SaltResistantRenderProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Salt-resistant Renovating Render Systems — Salt Attack & Salt-Contaminated Render — Remedial Building Australia",
  description:
    "Technical product reference for salt-resistant renovating render systems for salt attack remediation on Class 2 strata facades — porous matrix renders formulated to tolerate high salt environments without surface disruption.",
};
...
const ACTIVE_SLUG = "salt-resistant-renovating-render";

export default function SaltResistantRenovatingRenderPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <Link href="/repair-systems/facade-external-envelope/salt-attack-salt-contaminated-render" className="hover:text-sky-700 transition">Salt Attack &amp; Salt-Contaminated Render</Link>
              <span>/</span>
              <span className="text-sky-950">Salt-resistant renovating render</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Renovating render" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <SaltResistantRenderIntroSection />

            <SaltResistantRenderProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse salt-resistant renovating renders with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Standard polymer-modified renders — standard PM renders are not formulated with a controlled pore structure and will fail under salt attack conditions where salt migration is ongoing",
                  "Salt-retardant substrate treatment systems — crystalline or silicate treatments applied to the substrate before rendering — separate product class listed on the substrate treatment page",
                  "Breathable/vapour-permeable render — render systems designed primarily for moisture vapour transmission rather than salt tolerance — different product specification listed on the breathable render page",
                  "Waterproofing membranes — liquid-applied membranes applied before render are a separate system entirely",
                ].map((item) => (
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-7xl px-5 pt-10">
          <Link href="/repair-systems/facade-external-envelope/salt-attack-salt-contaminated-render" className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm transition hover:bg-slate-200">
