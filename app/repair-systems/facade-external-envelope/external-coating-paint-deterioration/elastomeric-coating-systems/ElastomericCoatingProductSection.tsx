...
const PRODUCTS: Product[] = [
  {
    ...
    systemDescription:
      "Dulux Acratex Weathershield Flex is a high-build elastomeric exterior coating for masonry and render facades requiring enhanced waterproofing and flexibility compared to standard exterior acrylics. The elastomeric binder provides significant elongation at break — enabling the coating to bridge fine surface cracks and accommodate minor substrate movement — making it suitable for facades where hairline or fine crack formation is expected over the service life. Applied as a two-coat high-build system over Dulux Acratex Prep Coat or compatible alkali-resistant primer, the system forms a continuous flexible waterproof membrane over the facade surface. It is UV-resistant and includes anti-fungal additives, making it suitable for coastal and high-humidity environments. Confirm current product name, system specification, primer requirements, and DFT from the current Dulux Acratex product documentation before specifying. Dulux Acratex is the specialist facade coating range within the Dulux portfolio specifically positioned for remedial and protective coating work on masonry facades.",
    technicalProperties: [
