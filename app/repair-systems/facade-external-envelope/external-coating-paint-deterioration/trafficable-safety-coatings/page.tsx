...
import { TrafficableSafetyProductSection, TrafficableSafetyIntroSection } from "./TrafficableSafetyProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Trafficable Safety Coatings — External Coating — Remedial Building Australia",
  description: "Technical product reference for trafficable safety coatings — Westox Wesdex Safety Colours anti-slip coloured coating for concrete and masonry on Australian strata and commercial buildings.",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><TrafficableSafetyIntroSection /><TrafficableSafetyProductSection /></div></section>
