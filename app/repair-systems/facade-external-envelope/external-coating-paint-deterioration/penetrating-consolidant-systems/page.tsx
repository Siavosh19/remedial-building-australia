  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Penetrating consolidant systems</h1>
        ...
        <section className="px-4 sm:px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><PenetratingConsolidantIntroSection /><PenetratingConsolidantProductSection />
