...
export const metadata: Metadata = {
  title: "Elastomeric Crack-Bridging Coating Systems — External Coating — Remedial Building Australia",
  description:
    "Technical product reference for elastomeric crack-bridging coating systems for facades with active and dormant cracking — Dulux Acratex Maxfilm, Solver and Wattyl high-build crack-bridging systems.",
};
...
const ACTIVE_SLUG = "elastomeric-crack-bridging-coating";
const BASE_URL = "/repair-systems/facade-external-envelope/external-coating-paint-deterioration";

export default function ElastomericCrackBridgingPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Elastomeric crack-bridging coating</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Elastomeric crack-bridging coating systems</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Elastomeric crack-bridging coatings are ultra-high-build systems designed to span cracks up to 0.3–0.5mm and provide a continuous flexible waterproof membrane. Applied in 2–3 coats to achieve the required DFT, they are specified where a standard elastomeric coating is insufficient — typically where dormant cracking is present across the facade and a higher crack-bridging capacity is required without render replacement.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[{ label: "Crack bridging", value: ">0.3mm" }, { label: "Elongation", value: ">300%" }, { label: "DFT", value: "250–400µm" }, { label: "Coats", value: "2–3" }].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><ElastomericCrackBridgingIntroSection /><ElastomericCrackBridgingProductSection />
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[{ href: `${BASE_URL}/elastomeric-coating-systems`, label: "External Coating", title: "Elastomeric coating systems" }, { href: `${BASE_URL}/exterior-acrylic-coating-systems`, label: "External Coating", title: "Exterior acrylic coating systems" }, { href: `${BASE_URL}/alkali-resistant-primer-systems`, label: "External Coating", title: "Alkali-resistant primer systems" }, { href: "/repair-systems/facade-external-envelope/render-cracking-delamination/two-coat-polymer-modified-render", label: "Related", title: "Two-coat polymer-modified render" }, { href: BASE_URL, label: "Back to defect", title: "External Coating & Paint Deterioration" }].map((card) => (
