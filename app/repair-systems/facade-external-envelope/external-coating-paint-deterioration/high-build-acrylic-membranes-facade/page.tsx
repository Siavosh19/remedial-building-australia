  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div><p className="text-sm font-bold uppercase tracking-[0.28em] text-red-700">Repair Systems — 03 — Facade &amp; External Envelope</p><h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">High-build acrylic membranes — facade</h1><p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for high-build acrylic membrane coatings for masonry and render facades — Westox WBA Membrane system for Australian strata and commercial buildings.</p></div>
        ...
        <section className="px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><HighBuildAcrylicIntroSection /><HighBuildAcrylicProductSection /></div></section>
