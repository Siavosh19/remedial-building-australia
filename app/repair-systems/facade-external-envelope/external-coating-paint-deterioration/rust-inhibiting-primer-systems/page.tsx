...
export const metadata: Metadata = {
  title: "Rust-Inhibiting Primer Systems — External Coating — Remedial Building Australia",
  description:
    "Technical product reference for rust-inhibiting zinc phosphate and zinc-rich primers for ferrous metal balustrades, lintels and facade metalwork — Dulux Metalshield, Wattyl Killrust and Rust-Oleum systems.",
};
...
const ACTIVE_SLUG = "rust-inhibiting-primer-systems";
const BASE_URL = "/repair-systems/facade-external-envelope/external-coating-paint-deterioration";

export default function RustInhibitingPrimerPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Rust-inhibiting primer systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[{ label: "Binder", value: "Epoxy/alkyd" }, { label: "Zinc content", value: "15–85%" }, { label: "DFT", value: "25–75µm" }, { label: "Substrate", value: "Steel/iron" }].map((s) => (
