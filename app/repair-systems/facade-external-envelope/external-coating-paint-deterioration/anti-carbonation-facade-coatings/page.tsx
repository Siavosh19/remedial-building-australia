...
import { AntiCarbonationProductSection, AntiCarbonationIntroSection } from "./AntiCarbonationProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Anti-Carbonation Facade Coatings — External Coating — Remedial Building Australia",
  description:
    "Technical product reference for anti-carbonation facade protective coatings for concrete and masonry facades — ARDEX WPM 330 Facade elastomeric CO2 barrier coating for Australian strata and commercial buildings.",
};
...
const ACTIVE_SLUG = "anti-carbonation-facade-coatings";
const BASE_URL = "/repair-systems/facade-external-envelope/external-coating-paint-deterioration";

export default function AntiCarbonationPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Anti-carbonation facade coatings</span>
            </nav>
            <PageNav />
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <AntiCarbonationIntroSection />
            <AntiCarbonationProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8">
              <a href={BASE_URL} className="inline-flex items-center gap-2 rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm hover:bg-slate-200 transition">
                <ArrowRight size={14} className="rotate-180" /> Back to External Coating &amp; Paint Deterioration
              </a>
            </div>
          </div>
        </section>
