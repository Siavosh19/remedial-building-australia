...
import { FlexibleCoatingsProductSection, FlexibleCoatingsIntroSection } from "./FlexibleCoatingsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Flexible Coatings — External Coating — Remedial Building Australia",
  description: "Technical product reference for flexible facade coatings — Westox Wesflex flexible coating for masonry and render facades on Australian strata and commercial buildings.",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><FlexibleCoatingsIntroSection /><FlexibleCoatingsProductSection /></div></section>
