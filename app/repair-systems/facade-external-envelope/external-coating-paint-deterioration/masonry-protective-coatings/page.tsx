...
import { MasonryProtectiveProductSection, MasonryProtectiveIntroSection } from "./MasonryProtectiveProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Masonry Protective Coatings — External Coating — Remedial Building Australia",
  description: "Technical product reference for masonry protective coatings — Dulux Acratex AcraSkin fine texture protective coating for rendered and masonry facades on Australian strata and commercial buildings.",
};
