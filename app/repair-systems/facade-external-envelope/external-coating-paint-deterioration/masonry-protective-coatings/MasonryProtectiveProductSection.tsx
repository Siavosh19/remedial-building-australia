...
const PRODUCTS: Product[] = [
  {
    ...
    productType: "Fine texture acrylic facade protective coating — render and masonry",
    filterTags: ["Masonry-protective", "Render-protective", "Acrylic", "Masonry", "Render", "UV-resistant", "Water-based"],
    techChips: [
      { label: "Fine texture", cls: "bg-purple-100 text-purple-800" },
      { label: "Acrylic", cls: "bg-purple-100 text-purple-800" },
      { label: "UV-resistant", cls: "bg-amber-100 text-amber-700" },
      { label: "Render finish", cls: "bg-slate-100 text-slate-700" },
    ],
    systemDescription:
      "Dulux Acratex AcraSkin is a fine-texture acrylic protective coating in the Acratex facade system range. It is applied as a finish coat over rendered or masonry facades to provide a smooth to fine-textured protective surface with UV and weather resistance.\n\nAcraSkin provides a decorative and protective finish for exterior rendered facades where a consistent fine-textured appearance is required. It is applied by roller or spray over a prepared and primed substrate.\n\nConfirm current product technical data sheet, coverage, DFT, texture grade, application method, and primer requirements with Acratex technical before specifying. Acratex is the Dulux Group specialist facade coating brand — confirm current product name and formulation.",
    technicalProperties: [
      "Fine-texture acrylic finish coat for rendered and masonry facades",
      "UV-resistant and weatherproof — suitable for Australian exterior facade conditions",
      "Applied by roller or spray — confirm application method from current Acratex TDS",
      "Confirm coverage rate, DFT, texture grade, and primer specification from current Acratex AcraSkin TDS",
    ],
    limitations: [
      "Confirm current product name and formulation with Acratex before specifying — Acratex range is subject to periodic update",
      "Alkali-resistant primer required on new or unpainted cement render — confirm primer with Acratex",
      "Not a crack-bridging system — for facades with active cracking specify an elastomeric system",
      "Confirm current Australian product availability with Acratex / Dulux Trade before specifying",
    ],
    procurementSources: [
...
const FILTER_DEFS: { id: FilterTag; label: string }[] = [
  { id: "Masonry-protective", label: "Masonry protective" },
  { id: "Render-protective", label: "Render protective" },
...
export function MasonryProtectiveIntroSection() {
  const [expanded, setExpanded] = useState(false);
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
      <div className="mb-4 flex items-center gap-2.5">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-950 text-white"><BookOpen size={15} /></div>
        <h3 className="text-base font-extrabold text-sky-950">What are masonry protective coatings?</h3>
      </div>
      <div className="space-y-4 text-sm leading-7 text-slate-600">
        <p>Masonry protective coatings are acrylic or polymer-modified coatings applied to rendered and masonry facades to provide a protective and decorative finish. They combine weather resistance, UV stability, and a consistent surface appearance — used as finish coats in facade painting and coating specifications.</p>
        {expanded && <p>Dulux Acratex AcraSkin is positioned in the Acratex facade system range as a fine-texture protective coating for rendered facades. Confirm current product name, formulation, application method, and system requirements with Acratex technical before specifying. Always apply over a compatible primer — alkali-resistant primer is required on new or unpainted cement render.</p>}
      </div>
...
export function MasonryProtectiveProductSection() {
  ...
  return (
    <div>
      <div className="mb-5 flex items-start gap-3">
        ...
        <div><h2 className="text-2xl font-extrabold text-sky-950">Product Reference</h2><p className="mt-1 text-sm text-slate-500">1 product — Dulux Acratex — masonry protective coating systems</p></div>
      </div>
