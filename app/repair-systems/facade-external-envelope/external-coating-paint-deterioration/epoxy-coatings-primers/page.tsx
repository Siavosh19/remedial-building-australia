...
import { EpoxyCoatingsPrimersProductSection, EpoxyCoatingsPrimersIntroSection } from "./EpoxyCoatingsPrimersProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Epoxy Coatings & Primers — External Coating — Remedial Building Australia",
  description: "Technical product reference for epoxy coatings and primers — Westox WB30 Epoxy water-based epoxy coating and primer for concrete, masonry, and metal on Australian strata and commercial buildings.",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><EpoxyCoatingsPrimersIntroSection /><EpoxyCoatingsPrimersProductSection /></div></section>
