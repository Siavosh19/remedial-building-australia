...
import { ElastomericFacadeProductSection, ElastomericFacadeIntroSection } from "./ElastomericFacadeProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Elastomeric Facade Coatings — External Coating — Remedial Building Australia",
  description:
    "Technical product reference for elastomeric facade coatings for exterior masonry and render — Dulux Acratex AcraShield Advance crack-bridging elastomeric waterproof coating for Australian strata and commercial buildings.",
};

const SIBLING_GROUPS = [
  { heading: "Primers & Preparation", tabs: [
  ...
  { heading: "Water Repellents", tabs: [
    { label: "Silane/siloxane", slug: "penetrating-silane-siloxane" },
    { label: "PVDF recoating", slug: "cladding-metal-panel-recoating-pvdf" },
  ]},
  { heading: "Specialist Coatings", tabs: [
    { label: "Anti-carbonation", slug: "anti-carbonation-facade-coatings" },
    { label: "Elastomeric facade", slug: "elastomeric-facade-coatings" },
    { label: "Masonry protective", slug: "masonry-protective-coatings" },
    { label: "Exterior systems", slug: "exterior-coating-systems" },
    { label: "High-build acrylic", slug: "high-build-acrylic-membranes-facade" },
    { label: "Trafficable protect.", slug: "trafficable-protective-coatings" },
    { label: "Trafficable safety", slug: "trafficable-safety-coatings" },
    { label: "Flexible coatings", slug: "flexible-coatings" },
    { label: "Clear water repellent", slug: "clear-masonry-water-repellents" },
    { label: "Textured protective", slug: "textured-protective-coatings" },
    { label: "Epoxy coatings", slug: "epoxy-coatings-primers" },
  ]},
];

const ACTIVE_SLUG = "elastomeric-facade-coatings";
const BASE_URL = "/repair-systems/facade-external-envelope/external-coating-paint-deterioration";

export default function ElastomericFacadePage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Elastomeric facade coatings</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Elastomeric facade coatings</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for elastomeric crack-bridging facade coatings — Dulux Acratex AcraShield Advance premium waterproof membrane coating for exterior masonry and render facades on Australian strata and commercial buildings.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[{ label: "Products listed", value: "1" }, { label: "Brand", value: "Acratex" }].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ElastomericFacadeIntroSection />
            <ElastomericFacadeProductSection />
          </div>
        </section>
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 md:grid-cols-[1.2fr_1fr]">
          <div><div className="text-lg font-extrabold text-sky-950">Remedial Building Australia</div><p className="mt-2 max-w-xl text-sm font-semibold leading-6 text-sky-900">Australia's remedial building directory — business listings, industry news, jobs and expert desktop review.</p></div>
