          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Elastomeric facade coatings</h1>
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 md:grid-cols-[1.2fr_1fr]">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm font-semibold text-sky-950">
            ...
            <a href="/repair-systems" className="hover:text-sky-700">Repair Systems</a><a href="/directory" className="hover:text-sky-700">Business Directory</a>
          </div>
        </div>
