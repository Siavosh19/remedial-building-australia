...
type FilterTag = "Clear-coating" | "Water-repellent" | "Penetrating" | "Masonry" | "Concrete" | "Brick" | "Render" | "Westox";
...
const PRODUCTS: Product[] = [
  {
    ...
    accentColor: "#64748b",
    name: "Westox Water Repellent DG",
    descriptionLine: "Clear masonry water repellent — penetrating or surface-applied hydrophobic treatment for masonry, concrete, brick, and render — confirm current formulation, coverage, and system specifications with Westox technical",
    productType: "Clear water repellent — masonry, concrete, brick and render",
    filterTags: ["Clear-coating", "Water-repellent", "Penetrating", "Masonry", "Concrete", "Brick", "Render", "Westox"],
    techChips: [{ label: "Clear", cls: "bg-slate-100 text-slate-700" }, { label: "Water repellent", cls: "bg-blue-100 text-blue-700" }, { label: "Masonry", cls: "bg-slate-100 text-slate-700" }],
    systemDescription: "Westox Water Repellent DG is a clear water repellent treatment for masonry, concrete, brick, and rendered facade surfaces. Clear water repellents provide hydrophobic treatment to reduce water absorption by the substrate without significantly changing the substrate appearance — unlike opaque coatings, the treated surface retains its natural look.\n\nWater repellent treatments are applied as a preventive maintenance treatment to reduce rain-driven water penetration into masonry and concrete facades, reducing efflorescence, staining, and freeze-thaw damage.\n\nConfirm current product technical data sheet, application method (penetrating vs. surface-applied), coverage rate, substrate requirements, and system design with Westox technical before specifying. 'DG' designation may indicate a specific Westox product grade — confirm with Westox.",
    technicalProperties: ["Clear water repellent — hydrophobic treatment for masonry and concrete facades without altering surface appearance", "Reduces rain-driven water absorption into substrate — reduces efflorescence and water staining", "Confirm application method, coverage rate, and substrate suitability from current Westox Water Repellent DG TDS"],
    limitations: ["Confirm current product formulation and system specifications with Westox technical before specifying", "Not suitable for substrates with active cracks or open joints — water repellent does not bridge cracks", "Confirm compatibility with existing coatings — clear water repellents may not be overcoatable with some paint systems", "Confirm current Australian product availability with Westox before specifying"],
    procurementSources: [{ name: "Westox — contact for trade supply", url: "https://www.westox.com.au" }],
  },
];

const FILTER_DEFS: { id: FilterTag; label: string }[] = [{ id: "Clear-coating", label: "Clear coating" }, { id: "Water-repellent", label: "Water repellent" }, { id: "Penetrating", label: "Penetrating" }, { id: "Masonry", label: "Masonry" }, { id: "Brick", label: "Brick" }];
...
export function ClearWaterRepellentIntroSection() {
  return (<div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm"><div className="mb-4 flex items-center gap-2.5"><div className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-950 text-white"><BookOpen size={15} /></div><h3 className="text-base font-extrabold text-sky-950">Clear masonry water repellents</h3></div><p className="text-sm leading-7 text-slate-600">Clear masonry water repellents are transparent hydrophobic treatments applied to brick, masonry, concrete, and render surfaces to reduce water absorption without altering the substrate appearance. They are used as preventive maintenance to reduce rain-driven water penetration, efflorescence, and staining on facade surfaces. Confirm current Westox Water Repellent DG specifications with Westox technical before specifying.</p></div>);
}

export function ClearWaterRepellentProductSection() {
  ...
  return (
    <div>
      <div className="mb-5 flex items-start gap-3"><div className="mt-1 h-5 w-1 shrink-0 rounded-full bg-red-700" /><div><h2 className="text-2xl font-extrabold text-sky-950">Product Reference</h2><p className="mt-1 text-sm text-slate-500">1 product — Westox — clear masonry water repellent systems</p></div></div>
