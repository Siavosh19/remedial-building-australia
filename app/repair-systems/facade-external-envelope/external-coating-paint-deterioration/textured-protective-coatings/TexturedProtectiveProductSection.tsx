...
type FilterTag = "Texture-coat" | "Protective-coating" | "Masonry" | "Render" | "Acrylic" | "Spray-applied" | "Roller-applied" | "Westox";
...
const PRODUCTS: Product[] = [
  {
    ...
    accentColor: "#64748b",
    name: "Westox Incellcoat 15 Litre",
    descriptionLine: "Textured protective coating for masonry and render facades — decorative texture finish with weather and UV resistance — confirm current formulation, texture profile, coverage, and system specifications with Westox technical",
    productType: "Textured protective coating — masonry and render facades",
    filterTags: ["Texture-coat", "Protective-coating", "Masonry", "Render", "Acrylic", "Westox"],
    techChips: [{ label: "Textured", cls: "bg-slate-100 text-slate-700" }, { label: "Protective", cls: "bg-slate-100 text-slate-700" }, { label: "Facade finish", cls: "bg-slate-100 text-slate-700" }],
    systemDescription: "Westox Incellcoat is a textured protective coating for masonry and rendered facade surfaces. Textured coatings combine a decorative textured finish with weather and UV resistance, providing a protective and aesthetically consistent facade coating.\n\nConfirm current product technical data sheet, texture profile (fine, medium, coarse), application method (roller, spray), coverage rate, DFT, primer requirements, and system design with Westox technical before specifying. Do not rely on this general reference as a substitute for current Westox Incellcoat technical documentation.",
    technicalProperties: ["Textured protective coating — decorative texture finish with weather and UV resistance", "Suitable for masonry and rendered facade surfaces", "Confirm texture profile, coverage rate, application method, and primer requirements from current Westox Incellcoat TDS"],
    limitations: ["Confirm current product formulation, texture profile, and system specifications with Westox technical before specifying", "Texture matching for patch repairs may be difficult if original finish was a specific texture — contact Westox for match advice", "Confirm current Australian product availability with Westox before specifying"],
    procurementSources: [{ name: "Westox — contact for trade supply", url: "https://www.westox.com.au" }],
  },
];

const FILTER_DEFS: { id: FilterTag; label: string }[] = [{ id: "Texture-coat", label: "Texture coat" }, { id: "Protective-coating", label: "Protective coating" }, { id: "Masonry", label: "Masonry" }, { id: "Render", label: "Render" }, { id: "Acrylic", label: "Acrylic" }];
...
export function TexturedProtectiveIntroSection() {
  return (<div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm"><div className="mb-4 flex items-center gap-2.5"><div className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-950 text-white"><BookOpen size={15} /></div><h3 className="text-base font-extrabold text-sky-950">Textured protective coatings</h3></div><p className="text-sm leading-7 text-slate-600">Textured protective coatings combine a decorative textured surface finish with weather and UV resistance for masonry and rendered facades. They are applied as a finish coat to provide both aesthetic and protective properties. Westox Incellcoat is a textured protective coating in the Westox facade system range. Confirm current product specifications with Westox technical before specifying.</p></div>);
}

export function TexturedProtectiveProductSection() {
  ...
  return (
    <div>
      <div className="mb-5 flex items-start gap-3"><div className="mt-1 h-5 w-1 shrink-0 rounded-full bg-red-700" /><div><h2 className="text-2xl font-extrabold text-sky-950">Product Reference</h2><p className="mt-1 text-sm text-slate-500">1 product — Westox — textured protective coating systems</p></div></div>
