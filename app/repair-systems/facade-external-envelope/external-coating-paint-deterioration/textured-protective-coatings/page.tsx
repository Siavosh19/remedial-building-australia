...
import { TexturedProtectiveProductSection, TexturedProtectiveIntroSection } from "./TexturedProtectiveProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Textured Protective Coatings — External Coating — Remedial Building Australia",
  description: "Technical product reference for textured protective coatings — Westox Incellcoat textured facade coating for masonry and render on Australian strata and commercial buildings.",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><TexturedProtectiveIntroSection /><TexturedProtectiveProductSection /></div></section>
