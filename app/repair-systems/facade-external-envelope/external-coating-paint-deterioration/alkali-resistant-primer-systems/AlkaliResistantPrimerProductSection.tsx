...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    descriptionLine: "Multi-purpose alkali-resistant exterior primer for render, concrete, and masonry — four functions in one coat: prime, seal, stabilise, and alkali resistance — widely available nationally",
    productType: "Multi-function alkali-resistant exterior primer — render, concrete and masonry",
    filterTags: ["Alkali-resistant", "Primer", "Water-based", "New-render", "Concrete", "Masonry", "Pre-topcoat", "Low-VOC", "Penetrating", "Acrylic-binder"],
    techChips: [
    ...
    systemDescription:
      "British Paints 4-in-1 Exterior Primer is a multi-function primer designed for cement render, concrete, brick, and masonry facades. It provides priming, sealing, stabilising, and alkali-resistant functions in a single coat application — simplifying the substrate preparation process for straightforward exterior facade repainting works. The alkali-resistant component addresses the pH 12–13 environment of fresh cement render and prevents saponification failure of the acrylic topcoat. The stabilising function provides light consolidation of slightly dusty or porous surfaces. British Paints (part of the PPG group) is widely distributed nationally through Mitre 10, Home Hardware, and independent paint retailers. Confirm current product formulation, DFT, spread rate, and compatibility with your chosen exterior topcoat from the current British Paints TDS before specifying.",
    technicalProperties: [
      "Binder: acrylic emulsion — multi-function: prime, seal, stabilise, and alkali-resistant in one coat",
      ...
      "Coverage: confirm from current TDS — penetrating action increases effective coverage on porous substrates",
      "Water-based — low VOC — suitable for occupied building facade repainting",
      "Wide distribution through Mitre 10, Home Hardware, and independent paint retailers nationally",
    ],
    limitations: [
