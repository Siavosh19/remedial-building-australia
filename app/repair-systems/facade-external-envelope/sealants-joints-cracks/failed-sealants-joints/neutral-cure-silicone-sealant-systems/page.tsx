...
import { NCSiliconeIntroSection, NCSiliconeProductSection } from "./NCSiliconeProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Neutral Cure Silicone Sealant Systems — Sealants, Joints & Cracks — Remedial Building Australia",
  description:
    "Technical product reference for neutral cure silicone sealant systems used in facade glazing, aluminium frame and weatherseal joint remediation on Australian Class 2 strata buildings — Dow, Sika and Tremco system comparisons.",
};

const ACTIVE_SLUG = "neutral-cure-silicone-sealant-systems";
...
export default function NCSiliconePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Neutral cure silicone sealant systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Neutral cure silicone sealant systems
                </h1>
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <NCSiliconeIntroSection />
            <NCSiliconeProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse neutral cure silicone with:</h3>
              </div>
