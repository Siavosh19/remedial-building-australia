...
import { PolysulfideIntroSection, PolysulfideProductSection } from "./PolysulfideProductSection";

export const metadata: Metadata = {
  title: "Polysulfide Sealant Systems — Sealants, Joints & Cracks — Remedial Building Australia",
  description:
    "Technical product reference for polysulfide sealant systems used in facade joint remediation on Australian Class 2 strata buildings — Fosroc, Sika and Bostik polysulfide system comparisons.",
};

const ACTIVE_SLUG = "polysulfide-sealant-systems";
...
export default function PolysulfidePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Polysulfide sealant systems</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Polysulfide" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PolysulfideIntroSection />
            <PolysulfideProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse polysulfide sealant with:</h3>
              </div>
