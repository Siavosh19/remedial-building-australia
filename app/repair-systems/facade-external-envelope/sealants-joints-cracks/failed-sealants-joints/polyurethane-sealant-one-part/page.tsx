...
import { PU1PartIntroSection, PU1PartProductSection } from "./PU1PartProductSection";

export const metadata: Metadata = {
  title: "Polyurethane Sealant — One Part — Sealants, Joints & Cracks — Remedial Building Australia",
  description:
    "Technical product reference for one-part polyurethane sealant systems used in facade movement joint and perimeter joint remediation on Australian Class 2 strata buildings — Sika, Tremco and Bostik system comparisons.",
};

const ACTIVE_SLUG = "polyurethane-sealant-one-part";
...
export default function PU1PartPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Polyurethane sealant — one part</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for one-part polyurethane sealant systems used in facade movement joint, control joint and perimeter joint remediation on Australian Class 2 strata buildings. Covers product classification, system selection, application requirements and brand comparisons.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "One-part PU" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse one-part polyurethane sealant with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Two-part polyurethane sealant (mixed A+B components — different pot life, higher performance for some applications — listed on the two-part PU sealant page)",
                  "Neutral cure silicone sealant (different chemistry — silicone is superior for glazing, aluminium and UV exposure but less paintable — listed on the neutral cure silicone page)",
                  "Polysulfide sealant (different chemistry — used in aviation fuel tanks and pool joints, older product in facade use — listed on the polysulfide sealant page)",
                  "Acetic-cure silicone (releases acetic acid on cure — attacks metals — NOT suitable for facade joints or aluminium substrates)",
