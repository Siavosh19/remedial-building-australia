...
import { PrimerIntroSection, PrimerProductSection } from "./PrimerProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Primer Systems — Per Substrate Type — Sealants, Joints & Cracks — Remedial Building Australia",
  description:
    "Technical product reference for sealant primer systems per substrate type used in facade joint remediation on Australian Class 2 strata buildings — Sika, Tremco and Bostik primer comparisons for concrete, masonry, aluminium and glass substrates.",
};

const ACTIVE_SLUG = "primer-systems-per-substrate-type";
...
export default function PrimerSystemsPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Primer systems — per substrate type</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Sealant primers" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse sealant primer with:</h3>
              </div>
