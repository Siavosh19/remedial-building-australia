...
type Group = { heading: string; cards: DefectCard[] };
    ...
    <section className="px-8 py-14">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex items-start gap-3">
          ...
          <div>
            <h2 className="text-2xl font-extrabold text-sky-950">Defect Categories</h2>
            <p className="mt-1 text-sm text-slate-500">{totalCategories} product categories across {groups.length} defect group{groups.length !== 1 ? "s" : ""} — select a defect type to browse product categories and brand comparisons.</p>
          </div>
        </div>
