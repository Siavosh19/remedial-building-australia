...
import { SandCementRenderIntroSection, SandCementRenderProductSection } from "./SandCementRenderProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Two-Coat Sand Cement Render Systems — Render Removal & Installation — Remedial Building Australia",
  description:
    "Technical product reference for traditional two-coat sand cement render — 1:4 OPC:sand scratch coat 12–15mm and float coat 6–10mm for full render removal and replacement on masonry and concrete facades.",
};
...
const ACTIVE_SLUG = "two-coat-sand-cement-render";
const BASE_URL = "/repair-systems/facade-external-envelope/render-removal-and-installation";

export default function SandCementRenderPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Two-coat sand cement render</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Mix ratio", value: "1:4 OPC:sand" },
                  { label: "Scratch coat", value: "12–15mm" },
                  { label: "Float coat", value: "6–10mm" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SandCementRenderIntroSection />
            <SandCementRenderProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">General technical information only. Mix ratios, coat thicknesses and substrate preparation must be confirmed by a qualified plasterer and the project specifications. Confirm compliance with AS 3700. Not a substitute for professional advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { href: `${BASE_URL}/polymer-modified-render-two-coat`, label: "Render Removal", title: "Polymer-modified render systems — two-coat" },
                { href: `${BASE_URL}/acrylic-spray-applied-render`, label: "Render Removal", title: "Acrylic spray-applied render systems" },
