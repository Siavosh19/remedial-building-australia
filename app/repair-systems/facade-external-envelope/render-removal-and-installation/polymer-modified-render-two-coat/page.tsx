...
import { PolymerModifiedRenderIntroSection, PolymerModifiedRenderProductSection } from "./PolymerModifiedRenderProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Polymer-Modified Render Systems — Two-Coat — Render Removal & Installation — Remedial Building Australia",
  description:
    "Technical product reference for two-coat polymer-modified cementitious render for full render replacement — Weber, Sika and Rockcote systems for improved bond strength and crack resistance on full render removal projects.",
};
...
const ACTIVE_SLUG = "polymer-modified-render-two-coat";
const BASE_URL = "/repair-systems/facade-external-envelope/render-removal-and-installation";

export default function PolymerModifiedRenderPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Polymer-modified render — two-coat</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Polymer-modified render systems — two-coat
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Polymer-modified cementitious render systems are the preferred specification for full render replacement on Class 2 strata facades, providing superior bond strength to existing substrates, reduced shrinkage cracking and extended service life compared to traditional sand cement render.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Binder", value: "OPC + polymer" },
                  { label: "Scratch coat", value: "8–12mm" },
                  { label: "Finish coat", value: "6–8mm" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PolymerModifiedRenderIntroSection />
            <PolymerModifiedRenderProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">General technical information only. Render system selection must be confirmed against substrate type, existing render system, and the current manufacturer TDS. Confirm compliance with AS 3700. Not a substitute for professional advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { href: `${BASE_URL}/two-coat-sand-cement-render`, label: "Render Removal", title: "Two-coat sand cement render" },
                { href: `${BASE_URL}/acrylic-spray-applied-render`, label: "Render Removal", title: "Acrylic spray-applied render" },
                { href: `${BASE_URL}/eifs-systems`, label: "Render Removal", title: "EIFS full installation systems" },
                { href: "/repair-systems/facade-external-envelope/render-cracking-delamination/two-coat-polymer-modified-render", label: "Related", title: "Two-coat PM render — cracking repair" },
