...
import { RenderRemovalIntroSection, RenderRemovalProductSection } from "./RenderRemovalProductSection";

export const metadata: Metadata = {
  title: "Render Removal & Installation — Facade Repair — Remedial Building Australia",
  description:
    "Technical product reference for sand cement, polymer-modified, acrylic spray-applied render systems and EIFS for full render removal and replacement on Class 2 strata facades in Australia.",
};
...
export default function RenderRemovalAndInstallationPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Cementitious / EIFS" },
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "render-removal-and-installation";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <RenderRemovalIntroSection />
            <RenderRemovalProductSection />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                Information is general only. Render system selection must be confirmed against substrate type, existing render system, and the current manufacturer technical data sheet. Confirm compliance with AS 3700 and NCC requirements. Do not rely on this reference as a substitute for professional facade or building consultant advice.
              </p>
            </div>
