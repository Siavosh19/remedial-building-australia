...
import { GalvChannelLintelIntroSection, GalvChannelLintelProductSection } from "./GalvChannelLintelProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Hot-Dip Galvanised Steel Channel Lintel — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for hot-dip galvanised steel PFC channel lintels for masonry facade remediation on Australian Class 2 strata buildings — HDG-only channel lintels for wide inland masonry openings with 15–25 year service life.",
};

const ACTIVE_SLUG = "galvanised-channel-lintel";
...
export default function GalvChannelLintelPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Profile", value: "Channel (PFC)" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <GalvChannelLintelIntroSection />
            <GalvChannelLintelProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse galvanised channel lintel with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Hot-dip galvanised channel lintel design, section size, back-to-back connection, bearing length and installation must be specified and certified by a structural engineer per AS 4100 and AS 3700.</p>
            </div>
