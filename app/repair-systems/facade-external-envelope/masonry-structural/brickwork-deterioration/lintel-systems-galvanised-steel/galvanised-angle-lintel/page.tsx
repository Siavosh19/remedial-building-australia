...
import { GalvAngleLintelIntroSection, GalvAngleLintelProductSection } from "./GalvAngleLintelProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Hot-dip Galvanised Steel Angle Lintel — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for hot-dip galvanised steel angle lintels for masonry facade remediation on Australian Class 2 strata buildings — HDG-only angle lintels for inland masonry opening support, 15–25 year service life.",
};

const ACTIVE_SLUG = "galvanised-angle-lintel";
...
export default function GalvanisedAngleLintelPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Hot-dip galvanised steel angle lintel
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for hot-dip galvanised steel angle lintels for masonry facade remediation on Australian Class 2 strata buildings. Covers HDG-only angle lintels for inland C2/C3 masonry opening support with 15–25 year service life. Structural engineer specification is mandatory for all lintel replacements.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Life", value: "15–25yr inland" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <GalvAngleLintelIntroSection />
            <GalvAngleLintelProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse hot-dip galvanised angle lintel with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Duplex coated angle lintel — HDG plus epoxy paint overcoat; 40–50 year inland service life; consider lifecycle cost before specifying galvanised-only for new installations",
                  "Stainless steel angle lintel — grade 316L for coastal and marine environments; required wherever the site is within 1 km of the coast or classified C4/C5",
                  "Concrete lintel — precast or in-situ reinforced concrete; different material, structural behaviour and application",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Hot-dip galvanised angle lintel design, section size, bearing length and installation must be specified and certified by a structural engineer per AS 4100 and AS 3700. Discuss service life requirements with the owner before specifying galvanised-only over duplex coated systems.</p>
            </div>
