...
export const metadata: Metadata = {
  title: "Lintel Systems — Galvanised Steel — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for hot-dip galvanised steel lintel systems for masonry facade remediation on Australian Class 2 strata buildings — galvanised steel angle, flat bar and channel lintels for inland masonry applications.",
};

const ACTIVE_SLUG = "lintel-systems-galvanised-steel";
...
export default function LintelGalvPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Lintel — galvanised</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Lintel systems — galvanised steel
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for hot-dip galvanised steel lintel systems for masonry facade remediation on Australian Class 2 strata buildings. Covers galvanised steel angle, flat bar and channel lintels for inland and sheltered masonry applications — hot-dip galvanising provides zinc corrosion protection but is not suitable for coastal or highly corrosive environments without a paint overcoat. Structural engineer specification is mandatory for all lintel replacements.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Lintel types", value: "3" },
                  { label: "Coating", value: "Hot-dip galv" },
                  { label: "Life", value: "15–25yr" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Galvanised steel lintel types</h2>
            ...
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_GALV}/galvanised-angle-lintel`,
                  label: "Standard",
                  title: "Angle Lintel",
                  description: "Equal angle (EA) — hot-dip galvanised only — 75×75×6 mm standard section — 15–25yr inland service life — for masonry openings in inland C2/C3 environments.",
                  suppliers: "InfraBuild · Lysaght/BlueScope · State fabricators",
                  tag: "Most common",
                },
                {
                  href: `${BASE_GALV}/galvanised-flat-bar-lintel`,
                  label: "Shallow rebate",
                  title: "Flat Bar Lintel",
                  description: "Flat bar — HDG only — for shallow rebate openings where equal angle cannot fit — restricted to spans under 2 m.",
                  suppliers: "InfraBuild · Lysaght/BlueScope · State fabricators",
                  tag: "Shallow rebate",
                },
                {
                  href: `${BASE_GALV}/galvanised-channel-lintel`,
                  label: "Wide opening",
                  title: "Channel Lintel",
                  description: "Parallel flange channel (PFC) — HDG only — higher section modulus for wide openings or heavily loaded masonry.",
                  suppliers: "InfraBuild · Lysaght/BlueScope · State fabricators",
                  tag: "Wide opening",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Hot-dip galvanised steel lintel design, section size, bearing length and installation must be specified and certified by a structural engineer per AS 4100 and AS 3700. HDG-only lintels provide 15–25yr inland service life — not suitable for coastal or C4/C5 environments.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { href: BASE_GALV + "/galvanised-angle-lintel", label: "Angle Lintel", title: "Hot-dip galvanised steel angle lintel — standard section" },
