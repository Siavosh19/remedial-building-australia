...
export const metadata: Metadata = {
  title: "Cavity Flashing — Aluminium — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for aluminium cavity flashing systems for masonry facade remediation on Australian Class 2 strata buildings — mill-finish and coated aluminium flashings for lintel, sill and base-of-cavity applications.",
};

const ACTIVE_SLUG = "cavity-flashing-aluminium";
...
export default function CavityFlashAlumPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Cavity flashing — aluminium</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Cavity flashing — aluminium
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for aluminium cavity flashing systems for masonry facade remediation on Australian Class 2 strata buildings. Covers mill-finish and powder-coated aluminium cavity flashings for installation above lintels, at sill courses and at base of cavity — designed to collect water within the cavity and direct it out through weep holes to the external face. Not suitable for coastal or marine-influenced environments without upgrade to Alcore composite, lead or stainless.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Flashing types", value: "3" },
                  { label: "Suppliers", value: "10+" },
                  { label: "System type", value: "Aluminium flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Aluminium cavity flashing types</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the aluminium flashing type below to compare individual suppliers, technical data, and procurement sources.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_ALUM}/mill-finish-aluminium-flashing`,
                  label: "Standard flashing",
                  title: "Mill Finish Aluminium Flashing",
                  description: "1.2–2.0mm 1100-H14 / 3003-H14 alloy strip for concealed cavity applications — the most common aluminium flashing type for new and remedial cavity construction. No colour coating.",
                  suppliers: "Capral · Metalcraft · Stramit · Local fabricators",
                  tag: "1.2–2.0mm",
                },
                {
                  href: `${BASE_ALUM}/powder-coated-aluminium-flashing`,
                  label: "Colour-coated",
                  title: "Powder Coated Aluminium Flashing",
                  description: "Factory powder coated aluminium strip in Dulux Powder or Colorbond colours — for exposed or semi-exposed applications where the flashing is visible at the wall face.",
                  suppliers: "Capral · Metalcraft · Stramit",
                  tag: "Colour match",
                },
                {
                  href: `${BASE_ALUM}/profiled-aluminium-cavity-tray`,
                  label: "Factory profiled",
                  title: "Profiled Aluminium Cavity Tray",
                  description: "Extruded 6063-T5 tray profiles with integral upstand, weep slots, and drip edge — eliminates site-fabrication of weep formers. Available lintel-seated and custom-extruded for non-standard cavity widths.",
                  suppliers: "Keystone Lintels · Extrude-a-Trim · Capral",
                  tag: "Integral weep",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Cavity flashing type, profile, upstand dimension, lap and weep hole spacing must be specified against the project's exposure classification, masonry type and AS 3700 requirements.</p>
            </div>
