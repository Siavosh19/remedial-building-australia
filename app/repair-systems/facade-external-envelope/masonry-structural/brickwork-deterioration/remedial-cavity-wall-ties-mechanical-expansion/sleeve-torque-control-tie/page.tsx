...
import { SleeveTorqueControlTieIntroSection, SleeveTorqueControlTieProductSection } from "./SleeveTorqueControlTieProductSection";

export const metadata: Metadata = {
  title: "Sleeve Torque-Control Mechanical Wall Tie — Rawlplug / Würth / Hilti — Remedial Building Australia",
  description:
    "Supplier comparison for sleeve torque-control mechanical remedial cavity wall ties for solid masonry facade remediation on Australian Class 2 strata buildings — Rawlplug, Würth, and Hilti HSA-R2.",
};

const ACTIVE_SLUG = "sleeve-torque-control-tie";
...
export default function SleeveTorqueControlTiePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Sleeve Torque-Control Tie</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Sleeve torque-control mechanical wall tie
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Supplier reference for sleeve torque-control mechanical remedial cavity wall ties for solid masonry facades on Class 2 strata buildings. Bolt-tightened sleeve expansion — torque is the key installation control. Solid masonry only. Compares Rawlplug, Würth, and Hilti HSA-R2 by grade, load data, and distribution.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Suppliers listed", value: "3" },
                  { label: "Fix type", value: "Sleeve expansion" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SleeveTorqueControlTieIntroSection />
            <SleeveTorqueControlTieProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse sleeve torque-control ties with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Wedge expansion ties — cone-wedge mechanism (not sleeve) — different geometry and edge distance requirements — listed on the wedge expansion tie page",
                  "Undercut expansion ties — high-load Hilti or Fischer undercut anchors with a keyed mechanical lock in an undercut profile — highest mechanical anchor capacity — listed on the undercut expansion tie page",
                  "Resin anchor ties — vinylester or epoxy chemical anchors — suitable for softer masonry where sleeve expansion would fail — listed on the cavity ties — resin anchor page",
                  "Helical grout-in ties — cementitious grouted helical ties — lower cost for standard residential masonry — listed on the cavity ties — helical page",
                  "Stainless steel through-bolts — bolting through the full masonry leaf is a different structural intervention and is not a cavity tie replacement system",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Sleeve torque-control ties are only suitable for solid, dense masonry. Tie type, diameter, embedment, and spacing must be confirmed by a structural engineer. Calibrated torque wrench is required — hand-tightening does not achieve design load.</p>
            </div>
