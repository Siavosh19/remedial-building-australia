...
import { UndercutExpansionTieIntroSection, UndercutExpansionTieProductSection } from "./UndercutExpansionTieProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Undercut Expansion Mechanical Wall Tie — Hilti HDA / Fischer FAZ II — Remedial Building Australia",
  description:
    "Supplier comparison for undercut expansion mechanical remedial cavity wall ties for masonry facade remediation on Australian Class 2 strata buildings — Hilti HDA and Fischer FAZ II undercut anchors.",
};

const ACTIVE_SLUG = "undercut-expansion-tie";
...
export default function UndercutExpansionTiePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Undercut Expansion Tie</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Fix type", value: "Undercut bearing" },
                  { label: "Load rating", value: "Very high" },
                  { label: "Tooling", value: "Specialist req." },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <UndercutExpansionTieIntroSection />
            <UndercutExpansionTieProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse undercut expansion ties with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Undercut expansion ties require specialist tooling and are engineer-specified for the highest-demand applications only. Anchor type, diameter, embedment, and spacing must be confirmed by a structural engineer against project-specific masonry conditions and AS 3700.</p>
            </div>
