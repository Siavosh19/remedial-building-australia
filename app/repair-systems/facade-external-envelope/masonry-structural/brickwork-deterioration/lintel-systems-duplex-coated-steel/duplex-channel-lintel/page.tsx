...
import { DuplexChannelLintelIntroSection, DuplexChannelLintelProductSection } from "./DuplexChannelLintelProductSection";

export const metadata: Metadata = {
  title: "Duplex Coated Steel Channel Lintel — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for duplex coated steel PFC channel lintels for masonry facade remediation on Australian Class 2 strata buildings — HDG plus epoxy paint channel lintels for wide inland masonry openings.",
};

const ACTIVE_SLUG = "duplex-channel-lintel";
...
export default function DuplexChannelLintelPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Channel Lintel</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Section", value: "PFC channel" },
                  { label: "Use", value: "Wide openings" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <DuplexChannelLintelIntroSection />
            <DuplexChannelLintelProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse duplex channel lintel with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Duplex coated channel lintel design, section size, back-to-back connection, bearing length and installation must be specified and certified by a structural engineer per AS 4100 and AS 3700.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Lintel corrosion and wide opening defects" },
