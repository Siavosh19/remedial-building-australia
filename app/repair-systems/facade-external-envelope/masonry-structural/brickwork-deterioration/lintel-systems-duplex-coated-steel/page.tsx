...
export const metadata: Metadata = {
  title: "Lintel Systems — Duplex Coated Steel — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for duplex coated steel lintel systems for masonry facade remediation on Australian Class 2 strata buildings — hot-dip galvanised and paint duplex coating for corrosion-protected steel lintels.",
};

const ACTIVE_SLUG = "lintel-systems-duplex-coated-steel";
...
export default function LintelDuplexPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Lintel — duplex steel</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Lintel systems — duplex coated steel
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for duplex coated steel lintel systems for masonry facade remediation on Australian Class 2 strata buildings. Covers hot-dip galvanised steel lintels with a paint overcoat (duplex system) — the combined galvanised plus paint coating significantly extends the service life of the lintel beyond galvanising alone — suitable for inland and moderate exposure environments. Structural engineer specification is mandatory for all lintel replacements.
                </p>
              </div>
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Duplex coated steel lintel types</h2>
            ...
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_DUPLEX}/duplex-angle-lintel`,
                  label: "Standard",
                  title: "Angle Lintel",
                  description: "Equal angle (EA) — HDG + epoxy paint — 75×75×6 mm standard section — for masonry openings up to ~2.5 m in inland C2/C3 environments.",
                  suppliers: "InfraBuild · Lysaght/BlueScope · State fabricators",
                  tag: "Most common",
                },
                {
                  href: `${BASE_DUPLEX}/duplex-flat-bar-lintel`,
                  label: "Shallow rebate",
                  title: "Flat Bar Lintel",
                  description: "Flat bar — HDG + epoxy — for shallow rebate openings where equal angle cannot fit — restricted to spans under 2 m.",
                  suppliers: "InfraBuild · Lysaght/BlueScope · State fabricators",
                  tag: "Shallow rebate",
                },
                {
                  href: `${BASE_DUPLEX}/duplex-channel-lintel`,
                  label: "Wide opening",
                  title: "Channel Lintel",
                  description: "Parallel flange channel (PFC) — HDG + epoxy — higher section modulus for wide openings or heavily loaded masonry.",
                  suppliers: "InfraBuild · Lysaght/BlueScope · State fabricators",
                  tag: "Wide opening",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Duplex coated steel lintel design, section size, bearing length and installation must be specified and certified by a structural engineer against project-specific span, load and corrosivity conditions per AS 4100 and AS 3700. Not suitable for coastal or C4/C5 environments.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { href: BASE_DUPLEX + "/duplex-angle-lintel", label: "Angle Lintel", title: "Duplex coated steel angle lintel — standard section" },
