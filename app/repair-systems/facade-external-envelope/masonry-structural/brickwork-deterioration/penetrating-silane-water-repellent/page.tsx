...
export const metadata: Metadata = {
  title: "Penetrating Silane Water Repellent — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for penetrating silane and silane-siloxane water repellent systems for masonry facade remediation on Australian Class 2 strata buildings — breathable hydrophobic treatment for brick and mortar protection.",
};

const ACTIVE_SLUG = "penetrating-silane-water-repellent";
...
export default function SilaneRepellentPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Silane water repellent</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for penetrating silane and silane-siloxane water repellent systems for masonry facade remediation on Australian Class 2 strata buildings. Penetrating silane treatments react with the masonry substrate to form a breathable hydrophobic barrier within the pore structure — reducing water absorption while allowing water vapour transmission. Applied as a supplementary treatment after all structural and repointing repairs have been completed; not a substitute for defective masonry repair.
                </p>
              </div>
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Penetrating silane water repellent products</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the product below to view supplier references, technical data and procurement sources.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_SILANE}/sika-protectosil-silane`,
                  label: "Specialist grade",
                  title: "Sika Protectosil",
                  description: "Silane-siloxane — deep penetration — breathable — specialist construction grade — national distribution",
                  tag: "BHN/CIT",
                },
                {
                  href: `${BASE_SILANE}/mapei-antipluviol-silane-siloxane`,
                  label: "Specialist grade",
                  title: "Mapei Antipluviol S",
                  description: "Silane-siloxane water repellent from Mapei — breathable, invisible, penetrating — alternative to Protectosil",
                  tag: "Silane-siloxane",
                },
                {
                  href: `${BASE_SILANE}/dulux-weathershield-masonry-repellent`,
                  label: "Trade + retail",
                  title: "Dulux Weathershield",
                  description: "Silane/siloxane masonry water repellent — available through Dulux trade and retail — for less critical applications",
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Silane water repellent selection, application rate and re-application interval must be confirmed against the project's masonry type, porosity and exposure conditions. Treatment is supplementary to structural repair — not a substitute for defective masonry remediation.</p>
            </div>
