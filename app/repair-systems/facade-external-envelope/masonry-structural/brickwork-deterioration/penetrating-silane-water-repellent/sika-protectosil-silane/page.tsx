...
import { SikaProtectosilIntroSection, SikaProtectosilProductSection } from "./SikaProtectosilProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Sika Protectosil Penetrating Silane Water Repellent — Sika Australia — Remedial Building Australia",
  description:
    "Technical product reference for Sika Protectosil BHN and CIT penetrating silane water repellent by Sika Australia — no surface film — vapour permeable — reduces water absorption up to 95% — for porous masonry facades on Australian Class 2 strata buildings.",
};

const ACTIVE_SLUG = "sika-protectosil-silane";
...
export default function SikaProtectosilPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Sika Protectosil</span>
            </nav>
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SikaProtectosilIntroSection />
            <SikaProtectosilProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse Sika Protectosil with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Silane product selection, application rate, coverage, and re-application interval must be confirmed against the project&apos;s masonry type, porosity and exposure conditions. Treatment is supplementary to structural repair — not a substitute for defective masonry remediation. Confirm current product data with the Sika TDS before specifying or applying.</p>
            </div>
