...
import { AttapulgitePoulticeIntroSection, AttapulgitePoulticeProductSection } from "./AttapulgitePoulticeProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Attapulgite H₂O₂ Poultice — Masonry Chemical Poultice — Remedial Building Australia",
  description:
    "Technical product reference for attapulgite clay and hydrogen peroxide poultice for organic stain removal from masonry on Australian Class 2 strata buildings — suitable for heritage sandstone, limestone, and terracotta where acid cleaning is prohibited.",
};

const ACTIVE_SLUG = "attapulgite-hydrogen-peroxide-poultice";
...
export default function AttapulgitePoulticeePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Attapulgite H₂O₂ Poultice</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Carrier", value: "Attapulgite clay" },
                  { label: "Active", value: "Hydrogen peroxide" },
                  { label: "Stain type", value: "Organic" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <AttapulgitePoulticeIntroSection />
            <AttapulgitePoulticeProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse attapulgite + H₂O₂ poultice with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Poultice selection must be matched to the specific stain type and masonry substrate. Trial application on an inconspicuous area is required before full-scale treatment. For heritage-listed buildings, document all trial areas with photographs before commencing full treatment.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { href: BASE_POULT, label: "Masonry Chemical Poultice", title: "Compare all chemical poultice masonry cleaning systems" },
