...
import { ProprietaryMasonryPoulticeIntroSection, ProprietaryMasonryPoulticeProductSection } from "./ProprietaryMasonryPoulticeProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Proprietary Masonry Poultice — Rust and Multi-Stain — Remedial Building Australia",
  description:
    "Technical product reference for proprietary masonry poultice systems (Remmers, PROSOCO, conservation specialists) for rust, iron, and multi-stain removal from masonry on Australian Class 2 strata buildings and heritage structures.",
};

const ACTIVE_SLUG = "proprietary-masonry-poultice";
...
export default function ProprietaryMasonryPoulticeePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Proprietary Masonry Poultice</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Proprietary masonry poultice system — rust and multi-stain
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for proprietary masonry poultice systems for rust, iron, metallic oxide, and multi-stain removal from masonry facades on Australian Class 2 strata buildings and heritage structures. Covers Remmers VWS, PROSOCO, and custom conservation formulations — pre-formulated chelating and reducing agent systems where site-mixed poultice combinations cannot deliver the required stain chemistry.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Type", value: "Proprietary formulated" },
                  { label: "Stain types", value: "Rust / metallic / multi" },
                  { label: "Key brands", value: "Remmers · PROSOCO" },
                  { label: "Method", value: "Poultice draw" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ProprietaryMasonryPoulticeIntroSection />
            <ProprietaryMasonryPoulticeProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for proprietary masonry poultice systems:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Identify and rectify the rust source before treating the stain — corroding embedded steel fixings, balustrade base plates, or reinforcement bar must be repaired or isolated before poultice treatment; without source rectification, rust staining will immediately recur after treatment",
                  "Trial area mandatory for all proprietary poultice products — apply to 0.1 m² minimum on an inconspicuous section; photograph before and after; confirm stain lift and no substrate damage before proceeding to full-area treatment",
                  "Some proprietary rust-removing products contain oxalic acid which is prohibited on certain heritage limestone and some marble substrates — confirm substrate compatibility with the manufacturer before specifying",
                  "Do not mix proprietary products with site-mixed chemicals — Remmers, PROSOCO, and conservation specialist formulations are balanced systems; adding site-mixed components changes the chemistry and can produce unpredictable results",
                  "For heritage-listed buildings, confirm product approval with the heritage consultant and authority before commencing — not all proprietary products are pre-approved for heritage council works; allow programme time for approval if required",
                  "Confirm lead time before specifying — specialist proprietary products from European manufacturers (Remmers) or North American suppliers (PROSOCO) may have variable availability in the Australian supply chain; confirm stock before specifying on time-critical projects",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Proprietary poultice product selection must be confirmed with the supplier for the specific stain type and masonry substrate. Heritage building treatment requires assessment by a qualified heritage consultant and may require heritage authority method approval.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Masonry staining and heritage facade defects" },
