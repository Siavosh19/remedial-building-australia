...
import { Sikaflex11FCIntroSection, Sikaflex11FCProductSection } from "./Sikaflex11FCProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Sikaflex-11FC+ One-Part Polyurethane Movement Joint Sealant — Sika Australia — Remedial Building Australia",
  description:
    "Technical product reference for Sikaflex-11FC+ one-part moisture-curing polyurethane sealant for masonry facade movement joints — ISO 11600 F 25 LM — ±25% movement accommodation — paintable after cure — for Australian Class 2 strata buildings.",
};

const ACTIVE_SLUG = "sikaflex-11fc-polyurethane-sealant";
...
export default function Sikaflex11FCPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Sikaflex-11FC+</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Supplier", value: "Sika Australia" },
                  { label: "Movement", value: "±25%" },
                  { label: "Cure", value: "Moisture-curing" },
                  { label: "Type", value: "1-part PU" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <Sikaflex11FCIntroSection />
            <Sikaflex11FCProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse Sikaflex-11FC+ with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Sealant selection, joint geometry, primer requirements and movement class must be confirmed against the project&apos;s joint design, substrate type and exposure conditions per ISO 11600 and AS 3700. Confirm current product data with the manufacturer TDS before specifying or applying.</p>
            </div>
