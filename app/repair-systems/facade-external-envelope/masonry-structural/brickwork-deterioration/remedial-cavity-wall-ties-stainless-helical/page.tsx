...
export const metadata: Metadata = {
  title: "Remedial Cavity Wall Ties — Stainless Helical — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for stainless helical cavity wall tie systems for masonry facade remediation on Australian Class 2 strata buildings — remedial helical tie installation where original ties have corroded or are absent.",
};

const ACTIVE_SLUG = "remedial-cavity-wall-ties-stainless-helical";
...
export default function CavityTiesHelicalPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Cavity ties — helical</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Remedial cavity wall ties — stainless helical
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for stainless helical cavity wall tie systems for masonry facade remediation on Australian Class 2 strata buildings. Covers remedial helical tie products used to re-connect outer leaf brickwork to the structural backing wall where original wall ties have corroded, failed or are absent — a structural life-safety remediation requiring engineer specification and supervision.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Tie types", value: "3" },
                  { label: "Suppliers", value: "8+" },
                  { label: "System type", value: "Helical wall ties" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Stainless helical wall tie types</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the helical tie type below to compare individual suppliers, technical data, and procurement sources. Structural engineer specification and supervision is required for all cavity wall tie remediation — this is structural life-safety work.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_HELICAL}/6mm-stainless-helical-grout-in`,
                  label: "Standard diameter",
                  title: "6mm Grout-in Helical Tie",
                  description: "The standard 6mm diameter Grade 316 stainless helical grout-in cavity wall tie for most residential and light commercial cavity masonry remediation. Helifix, Thor Helical, Simpson Strong-Tie.",
                  suppliers: "Helifix · Thor Helical · Simpson Strong-Tie",
                  tag: "Standard residential",
                },
                {
                  href: `${BASE_HELICAL}/8mm-stainless-helical-heavy-duty`,
                  label: "Heavy duty",
                  title: "8mm Heavy Duty Helical Tie",
                  description: "8mm Grade 316 stainless helical grout-in tie for heavy-duty applications — parapets, lintels, and high wind-load zones where 6mm capacity is insufficient. Engineer confirmation required.",
                  suppliers: "Helifix · Thor Helical · Ancon",
                  tag: "Heavy duty / engineer specified",
                },
                {
                  href: `${BASE_HELICAL}/stainless-helical-dryfix-friction`,
                  label: "No grout required",
                  title: "DryFix Friction Helical Tie",
                  description: "Grade 316 stainless helical friction-fit tie installed without grout or resin — suited to conditions where wet installation is impractical. Lower load capacity than grout-in ties.",
                  suppliers: "Helifix BowTie DryFix · Thor Helical DryFix",
                  tag: "No-grout installation",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Cavity wall tie remediation is structural work — tie type, length, spacing and installation must be designed and certified by a structural engineer against project-specific cavity dimensions, brick condition and AS 3700 structural requirements.</p>
            </div>
