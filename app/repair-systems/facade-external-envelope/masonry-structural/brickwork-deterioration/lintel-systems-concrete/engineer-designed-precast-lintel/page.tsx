...
import { EngineerDesignedPrecastIntroSection, EngineerDesignedPrecastProductSection } from "./EngineerDesignedPrecastProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Engineer-Designed In-Situ or Custom Precast Concrete Lintel — Lintel Systems Concrete — Remedial Building Australia",
  description:
    "Reference for engineer-designed in-situ or custom precast concrete lintels for non-standard masonry openings on Australian Class 2 strata buildings — local precast manufacturers and specialist structural precast fabricators.",
};

const ACTIVE_SLUG = "engineer-designed-precast-lintel";
...
export default function EngineerDesignedPrecastPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Engineer-Designed Precast</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Suppliers", value: "Local fabricators" },
                  { label: "Type", value: "Custom precast" },
                  { label: "Design std", value: "AS 3600" },
                  { label: "Use", value: "Non-standard" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EngineerDesignedPrecastIntroSection />
            <EngineerDesignedPrecastProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse engineer-designed precast with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Engineer-designed concrete lintel design, section dimensions, reinforcement, cover, crack control, and bearing details must be specified and certified by a structural engineer for each specific opening from first principles per AS 3600 and AS 3700.</p>
            </div>
