...
import { PrestressedPrecastLintelIntroSection, PrestressedPrecastLintelProductSection } from "./PrestressedPrecastLintelProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Prestressed Precast Concrete Lintel — Lintel Systems Concrete — Remedial Building Australia",
  description:
    "Supplier reference for prestressed precast concrete lintels for long-span masonry openings on Australian Class 2 strata buildings — Stresscrete and specialist prestress fabricators.",
};

const ACTIVE_SLUG = "prestressed-precast-lintel";
...
export default function PrestressedPrecastLintelPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Prestressed Precast</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "Prestressed" },
                  { label: "Span", value: "2.5m+" },
                  { label: "Standard", value: "AS 3600" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PrestressedPrecastLintelIntroSection />
            <PrestressedPrecastLintelProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for prestressed concrete lintel replacement:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Prestressed concrete lintel design, prestress level, camber, cover, span capacity, and bearing details must be specified and certified by a structural engineer for each specific opening per AS 3600 and AS 3700.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Lintel failure and masonry cracking above wide openings" },
