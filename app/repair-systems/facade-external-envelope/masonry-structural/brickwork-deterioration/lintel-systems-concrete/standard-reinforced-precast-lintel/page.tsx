...
import { StandardReinforcedPrecastIntroSection, StandardReinforcedPrecastProductSection } from "./StandardReinforcedPrecastProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Standard Reinforced Precast Concrete Lintel — Lintel Systems Concrete — Remedial Building Australia",
  description:
    "Supplier reference for standard reinforced precast concrete lintels for masonry facade remediation on Australian Class 2 strata buildings — Hume Concrete, BGC Concrete, and local precast manufacturers.",
};

const ACTIVE_SLUG = "standard-reinforced-precast-lintel";
const BASE_CONC = "/repair-systems/facade-external-envelope/masonry-structural/brickwork-deterioration/lintel-systems-concrete";
...
const SIBLING_GROUPS = [
  {
    heading: "Concrete Lintels",
    tabs: [
      { label: "Standard Reinforced Precast", slug: "standard-reinforced-precast-lintel" },
      { label: "Prestressed Precast", slug: "prestressed-precast-lintel" },
      { label: "Engineer-Designed Precast", slug: "engineer-designed-precast-lintel" },
    ],
    base: BASE_CONC,
  },
];

export default function StandardReinforcedPrecastPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <a href={BASE_CONC} className="hover:text-sky-700 transition">Lintel Systems — Concrete</a><span>/</span>
              <span className="text-sky-950">Standard Reinforced Precast</span>
            </nav>
            <PageNav />
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <StandardReinforcedPrecastIntroSection />
            <StandardReinforcedPrecastProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse standard reinforced precast with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Precast concrete lintel design, span, reinforcement, cover, and durability class must be specified and certified by a structural engineer against project-specific conditions per AS 3600 and AS 3700.</p>
            </div>
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-7xl px-5 pt-10">
          <a href={BASE_CONC} className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm transition hover:bg-slate-200">← Lintel Systems — Concrete</a>
        </div>
