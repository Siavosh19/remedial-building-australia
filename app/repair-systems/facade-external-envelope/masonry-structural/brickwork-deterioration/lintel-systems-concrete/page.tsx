...
export const metadata: Metadata = {
  title: "Lintel Systems — Precast Concrete — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for precast concrete lintel systems for masonry facade remediation on Australian Class 2 strata buildings — reinforced and prestressed precast concrete lintels for masonry openings.",
};

const ACTIVE_SLUG = "lintel-systems-concrete";
const BASE_CONCRETE = "/repair-systems/facade-external-envelope/masonry-structural/brickwork-deterioration/lintel-systems-concrete";
...
export default function LintelConcretePage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Lintel — concrete</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Lintel systems — precast concrete
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for precast concrete lintel systems for masonry facade remediation on Australian Class 2 strata buildings. Covers reinforced and prestressed precast concrete lintels manufactured to AS 3600 — used where a concrete lintel is preferred over metallic alternatives for durability, thermal mass or compatibility with the original construction. Structural engineer specification is mandatory for all lintel replacements.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Lintel types", value: "3" },
                  { label: "Type", value: "Precast" },
                  { label: "Design", value: "AS 3600" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Precast concrete lintel types</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the lintel type below to compare individual suppliers, technical data, and procurement sources.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_CONCRETE}/standard-reinforced-precast-lintel`,
                  label: "Standard",
                  title: "Standard Reinforced Precast",
                  description: "Reinforced precast concrete — AS 3600 — stock widths 110, 150, 230 mm — no corrosion risk — suitable for coastal and inland applications.",
                  suppliers: "Hume Concrete · BGC Concrete · Local precast manufacturers",
                  tag: "Most common",
                },
                {
                  href: `${BASE_CONCRETE}/prestressed-precast-lintel`,
                  label: "Long span",
                  title: "Prestressed Precast",
                  description: "Prestressed precast concrete — AS 3600 — for spans over 2.5 m where standard reinforced precast depth is excessive. Thinner section, higher capacity.",
                  suppliers: "Stresscrete · VSL · Specialist precast suppliers",
                  tag: "Long span",
                },
                {
                  href: `${BASE_CONCRETE}/engineer-designed-precast-lintel`,
                  label: "Custom",
                  title: "Engineer-Designed Precast",
                  description: "Custom precast to engineer's first-principles design — for non-standard openings, heavy loads, or integrated DPC details. 4–8 week lead time.",
                  suppliers: "Local precast fabricators · Structural specialists",
                  tag: "Non-standard",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Precast concrete lintel design, span, reinforcement, cover and durability must be specified and certified by a structural engineer against project-specific conditions per AS 3600 and AS 3700.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Lintel failure and masonry cracking above openings" },
