...
import { BrickFragmentEpoxyRepairIntroSection, BrickFragmentEpoxyRepairProductSection } from "./BrickFragmentEpoxyRepairProductSection";

export const metadata: Metadata = {
  title: "Brick Fragment Epoxy / Cementitious Face Repair — Sika / Mapei / Ardex — Remedial Building Australia",
  description:
    "Supplier comparison for brick fragment epoxy and cementitious face repair compounds for isolated brick spall cosmetic restoration on Australian Class 2 strata buildings — Sika, Mapei, and Ardex.",
};

const ACTIVE_SLUG = "brick-fragment-epoxy-repair";
...
export default function BrickFragmentEpoxyRepairPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Brick Fragment Epoxy Repair</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Brick fragment epoxy &amp; cementitious face repair
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Supplier reference for brick fragment epoxy and cementitious face repair compounds for cosmetic restoration of isolated brick spalls on Class 2 strata building facades. Cosmetic repair only — structural engineer confirmation required. Compares Sika, Mapei, and Ardex by product type, distribution, and tinting system.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Suppliers listed", value: "3" },
                  { label: "Repair type", value: "Cosmetic only" },
                  { label: "Max spall area", value: "~30% face" },
                  { label: "Engineer req.", value: "Required" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <BrickFragmentEpoxyRepairIntroSection />
            <BrickFragmentEpoxyRepairProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse brick fragment epoxy repair with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Reclaimed matching brick — full brick replacement using salvaged brick physically matched by sample — structural repair — listed on the reclaimed matching brick page",
                  "Manufactured matching brick — full brick replacement using purpose-manufactured new brick — structural repair — listed on the manufactured matching brick page",
                  "Concrete repair mortars — polymer-modified cementitious mortars for concrete spalling and delamination repair (Sika MonoTop, Fosroc Renderoc) — not for brick face repair",
                  "Repointing mortar — used to restore deteriorated mortar joints between bricks, not the brick face itself",
                  "Render repair systems — for repair of render and plaster coatings over masonry, not bare brick faces",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Brick fragment face repair is a cosmetic repair only — structural integrity of the brick must be confirmed by a structural engineer before accepting this approach in lieu of full brick replacement. Product specifications change — confirm current TDS with the supplier before specifying.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for brick repair" },
              ].map((card) => (
