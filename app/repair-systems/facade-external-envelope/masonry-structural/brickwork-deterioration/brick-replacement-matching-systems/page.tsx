...
export const metadata: Metadata = {
  title: "Brick Replacement — Matching Systems — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for brick replacement and matching systems for masonry facade remediation on Australian Class 2 strata buildings — salvaged, new matching and reclaimed brick sourcing for spalled or failed brick replacement.",
};

const ACTIVE_SLUG = "brick-replacement-matching-systems";
...
export default function BrickReplacementPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Brick replacement</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Brick replacement — matching systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical reference for brick replacement and matching systems for masonry facade remediation on Australian Class 2 strata buildings. Covers salvaged matching brick, new matching brick from current manufacturers, and reclaimed brick sourcing for spalled, cracked or failed brick replacement in heritage and contemporary masonry facades.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Types", value: "3" },
                  { label: "System type", value: "Brick matching" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Brick replacement and matching options</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the replacement approach below to compare individual suppliers, technical data, and procurement sources. A physical trial panel on the building is required before approving any brick match.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `/repair-systems/facade-external-envelope/masonry-structural/brickwork-deterioration/brick-replacement-matching-systems/reclaimed-matching-brick`,
                  label: "Salvage source",
                  title: "Reclaimed Matching Brick",
                  description: "Demolition salvage brick physically matched by sample comparison to the existing building. Best colour and texture match for pre-1980s and heritage facades — supply is unpredictable.",
                  suppliers: "Heritage Masonry · Salvage yards · Heritage specialist",
                  tag: "Heritage / pre-1980s",
                },
                {
                  href: `/repair-systems/facade-external-envelope/masonry-structural/brickwork-deterioration/brick-replacement-matching-systems/manufactured-matching-brick`,
                  label: "Manufactured (new)",
                  title: "Manufactured Matching Brick",
                  description: "Purpose-manufactured new brick colour-matched to the existing building by manufacturer colour-matching service. AS/NZS 4455 compliant. Preferred for post-1960s modern brick facades.",
                  suppliers: "Brickworks / Austral · PGH Bricks · Midland Brick (WA)",
                  tag: "Post-1960s",
                },
                {
                  href: `/repair-systems/facade-external-envelope/masonry-structural/brickwork-deterioration/brick-replacement-matching-systems/brick-fragment-epoxy-repair`,
                  label: "Cosmetic repair",
                  title: "Brick Fragment Epoxy / Cementitious Face Repair",
                  description: "Site-tinted cementitious repair compound for cosmetic restoration of isolated brick face spalls where full replacement is not practicable. Not a structural repair — engineer confirmation required.",
                  suppliers: "Sika Australia · Mapei Australia · Ardex Australia",
                  tag: "Cosmetic only",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Brick selection, grade, exposure classification and structural adequacy must be confirmed by a qualified remedial practitioner and, where structural masonry is involved, a structural engineer, against project-specific conditions and AS 3700.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Brick spalling and masonry face failure" },
