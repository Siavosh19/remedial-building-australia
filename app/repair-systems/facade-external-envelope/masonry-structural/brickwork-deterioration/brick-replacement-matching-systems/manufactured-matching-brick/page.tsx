...
import { ManufacturedMatchingBrickIntroSection, ManufacturedMatchingBrickProductSection } from "./ManufacturedMatchingBrickProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Manufactured Matching Brick — Brickworks / PGH / Midland Brick — Remedial Building Australia",
  description:
    "Supplier comparison for manufactured colour-matched replacement brick for post-1960s facade remediation on Australian Class 2 strata buildings — Brickworks / Austral Bricks, PGH Bricks, and Midland Brick.",
};

const ACTIVE_SLUG = "manufactured-matching-brick";
...
export default function ManufacturedMatchingBrickPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Manufactured Matching Brick</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Manufactured matching brick
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Supplier reference for manufactured colour-matched replacement brick for post-1960s facade remediation on Class 2 strata buildings. Compares Brickworks / Austral Bricks (national), PGH Bricks (eastern states), and Midland Brick (WA) by region, colour-matching service, and AS/NZS 4455 compliance.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Suppliers listed", value: "3" },
                  { label: "Source type", value: "Manufactured" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ManufacturedMatchingBrickIntroSection />
            <ManufacturedMatchingBrickProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse manufactured matching brick with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Reclaimed matching brick — salvaged demolition brick physically matched by sample comparison — preferred for heritage and pre-1960s buildings where a weathered brick is required — listed on the reclaimed matching brick page",
                  ...
                  "Masonry cleaning products — used to clean brick surfaces, not to replace brick units",
                  "Repointing mortar — used to restore deteriorated mortar joints, not brick faces",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Brick grade, structural suitability and compliance with AS/NZS 4455 must be confirmed by a structural engineer before installation. Trial panel approval is required before full-scale replacement. Product ranges and colour matching services change — confirm with manufacturer before ordering.</p>
            </div>
