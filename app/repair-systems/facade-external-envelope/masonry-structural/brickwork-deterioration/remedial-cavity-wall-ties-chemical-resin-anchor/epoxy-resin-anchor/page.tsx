...
import { EpoxyResinAnchorIntroSection, EpoxyResinAnchorProductSection } from "./EpoxyResinAnchorProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Epoxy Resin Anchor Cavity Wall Tie — Hilti / Fischer / Sika / Helifix — Remedial Building Australia",
  description:
    "Supplier comparison for epoxy resin anchor remedial cavity wall ties for masonry facade remediation on Australian Class 2 strata buildings — Hilti HIT-RE 500, Fischer FIS EM, Sika AnchorFix, and Helifix.",
};

const ACTIVE_SLUG = "epoxy-resin-anchor";
...
export default function EpoxyResinAnchorPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Epoxy Resin Anchor</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Resin type", value: "Two-part epoxy" },
                  { label: "Steel grade", value: "316 SS" },
                  { label: "Substrate", value: "Dry masonry" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EpoxyResinAnchorIntroSection />
            <EpoxyResinAnchorProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse epoxy resin anchor ties with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Epoxy resin anchor type, diameter, embedment, and spacing must be confirmed by a structural engineer against project-specific masonry conditions and AS 3700. Do not use epoxy in wet or saturated masonry without technical confirmation. Hole cleaning is critical — follow manufacturer installation instructions.</p>
            </div>
