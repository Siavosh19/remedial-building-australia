...
import { VinylesterResinAnchorIntroSection, VinylesterResinAnchorProductSection } from "./VinylesterResinAnchorProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Vinylester Resin Anchor Cavity Wall Tie — Helifix / Thor Helical / Simpson / Parchem — Remedial Building Australia",
  description:
    "Supplier comparison for vinylester resin anchor remedial cavity wall ties for masonry facade remediation on Australian Class 2 strata buildings — Helifix, Thor Helical, Simpson Strong-Tie, and Parchem.",
};

const ACTIVE_SLUG = "vinylester-resin-anchor";
...
export default function VinylesterResinAnchorPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Vinylester Resin Anchor</span>
            </nav>
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <VinylesterResinAnchorIntroSection />
            <VinylesterResinAnchorProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse vinylester resin anchor ties with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Resin anchor tie type, diameter, embedment, and spacing must be confirmed by a structural engineer against project-specific masonry conditions and AS 3700. Resin anchor installation requires hole cleaning per manufacturer TDS — deviations from the installation procedure will reduce bond strength.</p>
            </div>
