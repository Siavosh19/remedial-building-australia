...
export const metadata: Metadata = {
  title: "Remedial Cavity Wall Ties — Chemical Resin Anchor — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for chemical resin anchor cavity wall tie systems for masonry facade remediation on Australian Class 2 strata buildings — resin-anchored stainless ties for hollow masonry or perforated brick applications.",
};

const ACTIVE_SLUG = "remedial-cavity-wall-ties-chemical-resin-anchor";
...
export default function CavityTiesResinPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Cavity ties — resin anchor</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Remedial cavity wall ties — resin anchor
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for chemical resin anchor cavity wall tie systems for masonry facade remediation on Australian Class 2 strata buildings. Covers resin-anchored stainless 316 tie systems used where the masonry substrate is hollow, perforated or too friable for helical mechanical tie engagement — requiring resin injection to fill the bore and provide the required bond between the tie and the masonry.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Resin anchored ties" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Chemical resin anchor tie types</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the resin anchor type below to compare individual suppliers, technical data, and procurement sources. Structural engineer specification and supervision is required for all cavity wall tie remediation.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_RESIN}/vinylester-resin-anchor`,
                  label: "Damp substrates",
                  title: "Vinylester Resin Anchor",
                  description: "Grade 316 stainless tie installed with vinylester resin injection — high load capacity with reliable cure in damp masonry substrates. Preferred over epoxy where moisture is present.",
                  suppliers: "Helifix · Thor Helical · Simpson · Parchem",
                  tag: "High load / damp OK",
                },
                {
                  href: `${BASE_RESIN}/epoxy-resin-anchor`,
                  label: "Highest strength",
                  title: "Epoxy Resin Anchor",
                  description: "Two-part epoxy anchor systems — highest bond strength with zero shrinkage on curing. Specified for dry masonry and the most demanding load cases. Inhibited in wet or saturated substrates.",
                  suppliers: "Hilti HIT-RE 500 · Fischer FIS EM · Sika AnchorFix · Helifix",
                  tag: "Dry substrates only",
                },
                {
                  href: `${BASE_RESIN}/proprietary-kit-system`,
                  label: "All-in-one kit",
                  title: "Proprietary Kit System",
                  description: "Complete proprietary remedial tie kit systems integrating Grade 316 stainless tie, resin/grout, and installation driver from a single supplier — simplified procurement and guaranteed component compatibility.",
                  suppliers: "Helifix SockFix · Thor Helical · Simpson Strong-Tie",
                  tag: "Single-supplier system",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Resin-anchored cavity wall tie remediation is structural work — tie type, resin, length, spacing and installation must be designed and certified by a structural engineer against project-specific cavity dimensions, brick condition and AS 3700.</p>
            </div>
