...
import { PhosphoricAcidCleanerIntroSection, PhosphoricAcidCleanerProductSection } from "./PhosphoricAcidCleanerProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Phosphoric Acid Brick Cleaner — Masonry Cleaning Acid Wash — Remedial Building Australia",
  description:
    "Technical product reference for phosphoric acid brick cleaner for masonry facade remediation on Australian Class 2 strata buildings — gentler than HCl, suitable for clay brick and calcium silicate brick, removes lime bloom and efflorescence.",
};

const ACTIVE_SLUG = "phosphoric-acid-brick-cleaner";
...
export default function PhosphoricAcidCleanerPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Phosphoric Acid Cleaner</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Acid type", value: "Phosphoric" },
                  { label: "Compatible", value: "Clay brick + calcium silicate" },
                  { label: "Gentler than", value: "HCl" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PhosphoricAcidCleanerIntroSection />
            <PhosphoricAcidCleanerProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse phosphoric acid brick cleaner with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Phosphoric acid cleaner selection and application method must be confirmed for the specific masonry type and stain. Never apply acid cleaners to sandstone, limestone, or reconstituted stone. Flush thoroughly to remove phosphate residue before coating. OH&S requirements for chemical handling must be complied with.</p>
            </div>
