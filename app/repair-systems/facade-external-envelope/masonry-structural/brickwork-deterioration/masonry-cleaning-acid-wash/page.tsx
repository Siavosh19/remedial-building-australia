...
export const metadata: Metadata = {
  title: "Masonry Cleaning — Acid Wash — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for acid wash masonry cleaning systems for masonry facade remediation on Australian Class 2 strata buildings — dilute hydrochloric acid and proprietary acid-based cleaners for efflorescence and mortar stain removal.",
};

const ACTIVE_SLUG = "masonry-cleaning-acid-wash";
...
export default function MasonryAcidPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Masonry cleaning — acid</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Acid types", value: "3" },
                  { label: "Risk", value: "High" },
                  { label: "For", value: "Masonry" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Masonry acid wash cleaning types</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the acid cleaning type below to compare products, technical data, and procurement sources.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_ACID}/hydrochloric-acid-brick-cleaner`,
                  label: "Clay brick only",
                  title: "Hydrochloric Acid",
                  tag: "High risk",
                  description: "5–10% HCl — for clay brick mortar smear and efflorescence — NEVER on calcium silicate or marble",
                  suppliers: "Parchem · RLA · Generic HCl",
                },
                {
                  href: `${BASE_ACID}/phosphoric-acid-brick-cleaner`,
                  label: "Clay + calc. silicate",
                  title: "Phosphoric Acid",
                  tag: "Medium risk",
                  description: "Gentler alternative to HCl — for rust stains and efflorescence — suitable on a wider range of masonry types",
                  suppliers: "Parchem · Dulux AcraTex · Generic",
                },
                {
                  href: `${BASE_ACID}/sulphamic-acid-efflorescence-remover`,
                  label: "Efflorescence specific",
                  title: "Sulphamic Acid",
                  tag: "Low–medium risk",
                  description: "Powder form — specifically for calcium-based efflorescence and carbonate deposits — lowest risk acid option",
                  suppliers: "Parchem · RLA Efflotec · Generic",
                },
              ].map((card) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Acid cleaning product selection, dilution ratio and application method must be confirmed for the specific masonry type and stain — never apply acid cleaners to acid-sensitive substrates. OH&S requirements for chemical handling must be complied with.</p>
            </div>
