...
import { SulphamicAcidCleanerIntroSection, SulphamicAcidCleanerProductSection } from "./SulphamicAcidCleanerProductSection";

export const metadata: Metadata = {
  title: "Sulphamic Acid Efflorescence Remover — Masonry Cleaning Acid Wash — Remedial Building Australia",
  description:
    "Technical product reference for sulphamic acid efflorescence remover for masonry facade remediation on Australian Class 2 strata buildings — mildest acid cleaner, low fuming, solid crystal form, suitable for occupied buildings and semi-enclosed areas.",
};

const ACTIVE_SLUG = "sulphamic-acid-efflorescence-remover";
...
export default function SulphamicAcidCleanerPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Sulphamic Acid Remover</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Acid type", value: "Sulphamic" },
                  { label: "Use case", value: "Efflorescence" },
                  { label: "Form", value: "Solid crystals / pre-mixed" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SulphamicAcidCleanerIntroSection />
            <SulphamicAcidCleanerProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse sulphamic acid efflorescence remover with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Masonry efflorescence and surface defects" },
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for efflorescence treatment" },
              ].map((card) => (
