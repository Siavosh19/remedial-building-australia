...
import { StainlessAngleLintelIntroSection, StainlessAngleLintelProductSection } from "./StainlessAngleLintelProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Grade 316L Stainless Steel Angle Lintel — Lintel Systems Stainless Steel — Remedial Building Australia",
  description:
    "Supplier reference for grade 316L stainless steel angle lintels for coastal masonry facade remediation on Australian Class 2 strata buildings — Ancon, Helifix, and state stainless fabricators.",
};

const ACTIVE_SLUG = "stainless-angle-lintel";
...
export default function StainlessAngleLintelPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Grade 316L stainless steel angle lintel
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Supplier reference for grade 316L stainless steel angle lintels for coastal masonry facade remediation on Class 2 strata buildings. Covers Ancon Building Products, Helifix, and state stainless steel fabricators supplying 75×75×6 mm standard and engineer-specified sections for coastal and marine-influenced masonry opening replacement. Structural engineer design mandatory for all lintel replacements.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Suppliers", value: "3+" },
                  { label: "Grade", value: "316L stainless" },
                  { label: "Life", value: "50+ yr coastal" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <StainlessAngleLintelIntroSection />
            <StainlessAngleLintelProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse 316L angle lintel with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Duplex coated angle lintel — hot-dip galvanised + powder coated steel — suitable for inland or low-exposure coastal, but not adequate for direct coastal or marine environments where 316L stainless is specified",
                  "Galvanised angle lintel — zinc coating only — not suitable for coastal or marine environments; corrodes and fails within 10–15 years in chloride-rich masonry",
                  "Flat bar lintel — lower section modulus than angle — suitable only for shallow rebate openings and spans typically under 2 m; not interchangeable with angle lintel without engineering approval",
                  "Back-to-back angle lintel — two angles bolted together for wide or heavily loaded openings — higher capacity than single angle; confirm with engineer if single angle is adequate for the span",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Grade 316L stainless steel angle lintel design, section size, grade, bearing length and installation must be specified and certified by a structural engineer against project-specific span, load and coastal exposure conditions per AS 4100 and AS 3700.</p>
            </div>
