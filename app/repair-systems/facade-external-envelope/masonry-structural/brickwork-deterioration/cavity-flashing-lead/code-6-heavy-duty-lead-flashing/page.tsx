...
import { Code6LeadFlashingIntroSection, Code6LeadFlashingProductSection } from "./Code6LeadFlashingProductSection";
import SiteHeader from "@/components/SiteHeader";

export const metadata: Metadata = {
  title: "Code 6 Heavy Duty Lead Cavity Flashing — Midland Lead · Austral Lead — Remedial Building Australia",
  description:
    "Supplier comparison for Code 6 heavy duty milled lead cavity flashing (2.65mm, 30 kg/m²) for masonry facade remediation on Australian Class 2 strata buildings — parapet copings and engineer-specified applications.",
};

const ACTIVE_SLUG = "code-6-heavy-duty-lead-flashing";
...
export default function Code6LeadFlashingPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Code 6 Heavy Duty Lead</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Code 6 heavy duty lead cavity flashing
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Supplier reference for Code 6 heavy duty milled lead cavity flashing (2.65mm, 30 kg/m²) for masonry facade remediation on Class 2 strata buildings. The heaviest standard lead code — for parapet copings on exposed coastal buildings and engineer-specified applications where maximum fatigue resistance and service life are required.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Suppliers listed", value: "2" },
                  { label: "Code", value: "Code 6" },
                  { label: "Thickness", value: "2.65mm" },
                  { label: "Weight", value: "30 kg/m²" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <Code6LeadFlashingIntroSection />
            <Code6LeadFlashingProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse Code 6 lead flashing with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Code 5 lead flashing (2.24mm, 25 kg/m²) — standard parapet grade — appropriate for most parapet applications unless engineer specifies Code 6 — listed on the Code 5 lead flashing page",
                  "Code 4 lead flashing (1.8mm, 20 kg/m²) — standard cavity flashing grade for base of cavity and over lintels — not appropriate for parapet copings in exposed locations — listed on the Code 4 lead flashing page",
                  "Aluminium cavity flashing — not self-sealing at laps, not always suitable for coastal environments — listed on the cavity flashing — aluminium page",
                  "Alcore composite flashing — bitumen-aluminium laminate — lighter, easier to install but different performance characteristics — listed on the cavity flashing — Alcore page",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Lead code selection, flashing width, lap detail, and weep former spacing must be confirmed by a qualified remedial practitioner and structural engineer against project-specific conditions and AS 3700.</p>
            </div>
