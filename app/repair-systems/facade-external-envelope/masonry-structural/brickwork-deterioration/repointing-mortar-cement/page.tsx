...
export const metadata: Metadata = {
  title: "Repointing Mortar — Cement-Based — Brickwork Deterioration — Remedial Building Australia",
  description:
    "Cement-based repointing mortar product index — GP cement + hydrated lime, pre-mixed masonry cement, and polymer-modified cement mortars for masonry facade remediation on Australian Class 2 strata buildings.",
};

const ACTIVE_SLUG = "repointing-mortar-cement";
...
export default function RepointCementPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Repointing — cement</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Repointing mortar — cement-based
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for cement-based repointing mortars for masonry facade remediation on Australian Class 2 strata buildings. Covers pre-blended polymer-modified masonry mortars and site-mixed cement-lime mortars — used for repointing brick and block facades where the original mortar was cement-based and the masonry substrate is strong enough to accommodate the mortar hardness.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Cement mortar" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl">
            <h2 className="mb-2 text-xl font-extrabold text-sky-950">Cement-based repointing mortar types</h2>
            <p className="mb-8 max-w-2xl text-sm leading-6 text-slate-600">Select the mortar type below to compare individual suppliers, technical data, and procurement sources for each product type.</p>
            <div className="grid gap-5 sm:grid-cols-3">
              {[
                {
                  href: `${BASE_CEMENT}/gp-cement-hydrated-lime-mortar`,
                  label: "Site-mixed mortar",
                  title: "GP Cement + Hydrated Lime Repointing Mortar",
                  description: "Standard site-mixed repointing mortar batched from separate GP cement and hydrated lime — M3/M4 mortar class to AS 3700. Suited to modern clay brick, concrete masonry, and calcium silicate brick facades.",
                  suppliers: "Boral · Cement Australia · Adbri · Cockburn",
                  tag: "M3 / M4",
                },
                {
                  href: `${BASE_CEMENT}/pre-mixed-masonry-cement-mortar`,
                  label: "Pre-mixed mortar",
                  title: "Pre-mixed Masonry Cement Repointing Mortar",
                  description: "Factory-blended, add-water-only bagged mortar for consistent joint colour and strength. Eliminates site-batching variability. Suited to mid-size and large repointing contracts.",
                  suppliers: "Boral · BGC Cement · Cockburn · Hanson",
                  tag: "M3",
                },
                {
                  href: `${BASE_CEMENT}/polymer-modified-cement-mortar`,
                  label: "Polymer-modified",
                  title: "Polymer-Modified Cement Repointing Mortar",
                  description: "Pre-bagged mortars with polymer admixtures for enhanced bond strength, reduced shrinkage, and improved durability. Specified for high-movement zones, coastal parapets, and where standard cement mortar has repeatedly failed.",
                  suppliers: "Sika · Mapei · Parchem (Fosroc) · Ardex",
                  tag: "High-bond",
                },
              ].map((card) => (
