...
import { PolymerModifiedMortarIntroSection, PolymerModifiedMortarProductSection } from "./PolymerModifiedMortarProductSection";

export const metadata: Metadata = {
  title: "Polymer-Modified Cement Repointing Mortar — Sika / Mapei / Parchem / Ardex — Remedial Building Australia",
  description:
    "Supplier comparison for polymer-modified cement repointing mortar for Class 2 strata facade remediation — Sika, Mapei, Parchem (Fosroc), and Ardex — high-bond, coastal-rated, pre-bagged.",
};

const ACTIVE_SLUG = "polymer-modified-cement-mortar";
...
export default function PolymerModifiedMortarPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Polymer-Modified Cement</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Product type", value: "Polymer-mod." },
                  { label: "Standard", value: "AS 3700" },
                  { label: "Format", value: "Pre-bagged" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PolymerModifiedMortarIntroSection />
            <PolymerModifiedMortarProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse polymer-modified cement repointing mortar with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Mortar type, polymer compatibility, and application conditions must be confirmed by a qualified remedial practitioner and, where structural masonry is involved, a structural engineer, against project-specific conditions and AS 3700. Supplier product ranges and TDS data change — confirm with supplier before specifying.</p>
            </div>
