...
import { NhlFivePointZeroMortarIntroSection, NhlFivePointZeroMortarProductSection } from "./NhlFivePointZeroMortarProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "NHL 5.0 Natural Hydraulic Lime Repointing Mortar — Parex / Limemortar.com.au — Remedial Building Australia",
  description:
    "Supplier comparison for NHL 5.0 natural hydraulic lime repointing mortar for heritage masonry facade remediation — Parex and specialist suppliers — exposed parapets, moderately hard historic brick, Class 2 strata buildings.",
};

const ACTIVE_SLUG = "natural-hydraulic-lime-mortar-nhl-50";
...
export default function NhlFivePointZeroMortarPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">NHL 5.0 Mortar</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "NHL grade", value: "5.0" },
                  { label: "Strength range", value: "5–15 MPa" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <NhlFivePointZeroMortarIntroSection />
            <NhlFivePointZeroMortarProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white">
                  <AlertTriangle size={15} />
                </div>
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse NHL 5.0 lime mortar with:</h3>
              </div>
