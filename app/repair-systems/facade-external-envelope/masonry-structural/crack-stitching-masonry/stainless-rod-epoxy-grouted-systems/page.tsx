...
import { StainlessRodEpoxyIntroSection, StainlessRodEpoxyProductSection } from "./StainlessRodEpoxyProductSection";

export const metadata: Metadata = {
  title: "Stainless Rod Epoxy Grouted Systems — Crack Stitching — Remedial Building Australia",
  description:
    "Technical product reference for stainless rod epoxy grouted crack stitching systems for masonry facade remediation on Australian Class 2 strata buildings — grade 316 threaded rods grouted into drilled channels with structural epoxy.",
};

const ACTIVE_SLUG = "stainless-rod-epoxy-grouted-systems";
...
export default function StainlessRodEpoxyPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Stainless rod epoxy</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Types", value: "2" },
                  { label: "System type", value: "Epoxy stitch rod" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <StainlessRodEpoxyIntroSection />
            <StainlessRodEpoxyProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for stainless rod epoxy grouted crack stitching:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Stainless rod epoxy grouted crack stitching is structural work — rod specification, channel geometry, epoxy selection and installation must be specified and certified by a structural engineer against project-specific crack cause, load conditions and masonry type per AS 3700.</p>
            </div>
