...
import { StormAngleSSIntroSection, StormAngleSSProductSection } from "./StormAngleSSProductSection";

export const metadata: Metadata = {
  title: "Storm Angle — Stainless Steel — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for stainless steel 316 storm angle systems used in window and door frame remediation on Australian Class 2 strata buildings — coastal and high-exposure applications.",
};

const ACTIVE_SLUG = "storm-angle-stainless";
...
export default function StormAngleSSPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Storm angle — stainless steel</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Stainless angle" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <StormAngleSSIntroSection />
            <StormAngleSSProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Stainless vs aluminium storm angle — selection and installation notes:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Storm angle sizing, grade selection and fixing details must be confirmed by a qualified remedial practitioner against site conditions and exposure classification. Always verify stainless grade (316 vs 304) against the project exposure zone before ordering.</p>
            </div>
