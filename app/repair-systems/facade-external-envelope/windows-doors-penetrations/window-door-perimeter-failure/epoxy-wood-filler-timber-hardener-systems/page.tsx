...
import { EpoxyWoodIntroSection, EpoxyWoodProductSection } from "./EpoxyWoodProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Epoxy Wood Filler & Timber Hardener — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for epoxy wood filler and timber hardener systems used in window and door frame remediation on Australian Class 2 strata buildings — Selleys, Sika and Bostik system comparisons.",
};

const ACTIVE_SLUG = "epoxy-wood-filler-timber-hardener-systems";
...
export default function EpoxyWoodPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Epoxy wood filler &amp; timber hardener</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Epoxy wood filler &amp; timber hardener
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for epoxy wood filler and timber hardener systems used in window and door frame remediation on Australian Class 2 strata buildings. Covers consolidant hardeners for structurally compromised timber and two-part epoxy fillers for localised rot repair — used where timber window frames have localised decay not requiring full replacement.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Epoxy wood repair" },
                  { label: "Standards", value: "Per TDS" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EpoxyWoodIntroSection />
            <EpoxyWoodProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for epoxy timber repair — scope and limitations:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Epoxy wood repair is not a structural repair — it restores surface profile and weatherproofing continuity only; structurally compromised sections require timber replacement",
                  "Always assess and address the cause of decay before applying filler — if the moisture source is not eliminated, decay will continue beneath and around the repair",
                  "Apply timber hardener / consolidant first to stabilise soft, punky or partially decayed timber before applying epoxy filler — do not apply filler directly to active soft rot",
                  "Do not apply epoxy filler over painted or contaminated timber — remove all loose material, old paint and contamination and allow the substrate to dry before application",
                  "Epoxy fillers are not UV-stable — all repairs must be primed and painted on completion; do not leave epoxy repairs exposed",
                  "Two-part epoxy fillers have a limited working time — mix only what can be placed in the stated pot life and work quickly in warm conditions",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Final product selection must be confirmed against current manufacturer TDS, substrate condition and extent of decay. Epoxy wood repair is not a substitute for structural timber replacement where load-bearing capacity is compromised.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for timber window frame repair" },
              ].map((card) => (
