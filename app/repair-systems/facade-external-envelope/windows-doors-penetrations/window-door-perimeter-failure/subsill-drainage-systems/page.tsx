...
import { SubsillDrainageIntroSection, SubsillDrainageProductSection } from "./SubsillDrainageProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Subsill Drainage Systems — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for subsill drainage systems used in window sill remediation on Australian Class 2 strata buildings — aluminium subsill channel, weep holes and drainage insert comparisons.",
};

const ACTIVE_SLUG = "subsill-drainage-systems";
...
export default function SubsillDrainagePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Subsill drainage systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Subsill drainage" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SubsillDrainageIntroSection />
            <SubsillDrainageProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for subsill drainage specification and installation:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Subsill drainage system selection, sizing and installation details must be confirmed by a qualified remedial practitioner against existing window frame construction and site conditions. Drainage systems manage water ingress — they do not substitute for correct primary waterproofing.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for window subsill drainage" },
              ].map((card) => (
