...
import { PerimeterPUIntroSection, PerimeterPUProductSection } from "./PerimeterPUProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Perimeter Sealant — Polyurethane — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for polyurethane perimeter sealant systems for window and door frame remediation on Australian Class 2 strata buildings — Sika, Tremco and Bostik system comparisons.",
};

const ACTIVE_SLUG = "perimeter-sealant-polyurethane";
...
export default function PerimeterPUPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Perimeter sealant — polyurethane</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "PU sealant" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PerimeterPUIntroSection />
            <PerimeterPUProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">PU vs silicone for window perimeter sealant — selection guide:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Final product selection must be confirmed against current manufacturer TDS, substrate condition and exposure classification. Do not rely on this reference as a substitute for professional advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for window perimeter remediation" },
              ].map((card) => (
