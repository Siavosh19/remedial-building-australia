...
import { HeadFlashColorbondIntroSection, HeadFlashColorbondProductSection } from "./HeadFlashColorbondProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Head Flashing — Colorbond — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for Colorbond head flashing systems used in window and door remediation on Australian Class 2 strata buildings — custom fabricated Colorbond and pre-formed section comparisons.",
};
...
export default function HeadFlashColorbondPage() {
  return (
      ...
      <main>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Colorbond flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <HeadFlashColorbondIntroSection />
            <HeadFlashColorbondProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Colorbond vs stainless head flashing — selection guide:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Head flashing details are project-specific — final fabrication dimensions, fixing details and substrate preparation must be confirmed by a qualified remedial practitioner against site conditions. Always verify Colorbond exposure zone suitability before specifying.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for window head flashing" },
              ].map((card) => (
