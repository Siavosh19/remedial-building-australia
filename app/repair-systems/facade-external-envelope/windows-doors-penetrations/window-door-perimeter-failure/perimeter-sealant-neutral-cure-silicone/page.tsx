...
import { PerimeterNCSiliconeIntroSection, PerimeterNCSiliconeProductSection } from "./PerimeterNCSiliconeProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Perimeter Sealant — Neutral Cure Silicone — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for neutral cure silicone perimeter sealant systems used in window and door frame remediation on Australian Class 2 strata buildings — Dow, Sika and Tremco system comparisons.",
};

const ACTIVE_SLUG = "perimeter-sealant-neutral-cure-silicone";
...
export default function PerimeterNCSiliconePage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Perimeter sealant — neutral cure silicone</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Perimeter sealant — neutral cure silicone
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for neutral cure silicone perimeter sealant systems used in window and door frame remediation on Australian Class 2 strata buildings. Covers product selection for aluminium window frames, glazing perimeters and UV-exposed perimeter joints — the preferred sealant type for metal-to-masonry and glass interfaces.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Neutral silicone" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <PerimeterNCSiliconeIntroSection />
            <PerimeterNCSiliconeProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical selection notes for window perimeter sealant:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Never specify acetic cure silicone for window frames — acetic cure releases acetic acid which attacks aluminium, galvanised steel and most metals — always confirm neutral cure",
                  "Neutral cure silicone is not paintable — where the perimeter joint will be overpainted with facade paint, specify polyurethane sealant instead (listed on the perimeter sealant — polyurethane page)",
                  "Silicone does not bond to cured silicone — all existing silicone must be fully removed before replacement — do not apply new silicone over old",
                  "Structural silicone sealant (for structural glazing bonding) is a different, specialist product — not for general perimeter sealing use",
                  "Primer may be required on some substrates — confirm with manufacturer before application on difficult or contaminated surfaces",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">
                This page provides general technical information only. Final product selection must be confirmed against current manufacturer TDS, substrate condition and exposure classification. Always specify neutral cure (not acetic cure) silicone for all metal frame applications.
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Window and door perimeter failure — causes and methodology" },
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for window perimeter sealant remediation" },
              ].map((card) => (
