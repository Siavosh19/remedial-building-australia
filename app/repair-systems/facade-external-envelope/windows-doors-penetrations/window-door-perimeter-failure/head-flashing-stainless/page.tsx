...
import { HeadFlashStainlessIntroSection, HeadFlashStainlessProductSection } from "./HeadFlashStainlessProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Head Flashing — Stainless Steel — Windows, Doors & Penetrations — Remedial Building Australia",
  description:
    "Technical product reference for stainless steel head flashing systems used in window and door remediation on Australian Class 2 strata buildings — stainless 316 custom fabrication and pre-formed section comparisons.",
};
...
export default function HeadFlashStainlessPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Head flashing — stainless steel</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Stainless flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <HeadFlashStainlessIntroSection />
            <HeadFlashStainlessProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for stainless head flashing specification:</h3>
              </div>
