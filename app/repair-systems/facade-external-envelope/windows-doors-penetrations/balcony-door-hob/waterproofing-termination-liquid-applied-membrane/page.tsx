...
import { WPTermLiquidIntroSection, WPTermLiquidProductSection } from "./WPTermLiquidProductSection";

export const metadata: Metadata = {
  title: "Waterproofing Termination — Liquid Applied Membrane — Balcony Door Hob — Remedial Building Australia",
  description:
    "Technical product reference for liquid-applied waterproofing membrane termination systems at balcony door hobs on Australian Class 2 strata buildings — Sika, Mapei and Ardex system comparisons.",
};

const ACTIVE_SLUG = "waterproofing-termination-liquid-applied-membrane";
...
export default function WPTermLiquidPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">WP termination — liquid membrane</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Liquid membrane" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <WPTermLiquidIntroSection />
            <WPTermLiquidProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for waterproofing membrane termination at door hobs:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Waterproofing membrane system selection, DFT requirements, primer compatibility and AS 3740 height compliance must be confirmed by a licensed waterproofer and qualified remedial practitioner against project-specific conditions.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for balcony waterproofing termination" },
              ].map((card) => (
