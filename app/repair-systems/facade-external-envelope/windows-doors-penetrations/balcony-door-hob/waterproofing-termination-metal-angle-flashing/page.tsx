...
import { WPTermMetalIntroSection, WPTermMetalProductSection } from "./WPTermMetalProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Waterproofing Termination — Metal Angle Flashing — Balcony Door Hob — Remedial Building Australia",
  description:
    "Technical product reference for metal angle flashing waterproofing termination systems at balcony door hobs on Australian Class 2 strata buildings — stainless 316 angle and aluminium termination bar comparisons.",
};

const ACTIVE_SLUG = "waterproofing-termination-metal-angle-flashing";
...
export default function WPTermMetalPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">WP termination — metal angle</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  WP termination — metal angle flashing
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for metal angle flashing waterproofing termination systems at balcony door hobs on Australian Class 2 strata buildings. Covers 316 stainless angle termination bars, aluminium termination bars and proprietary membrane termination profiles — used to mechanically fix and terminate the upper edge of the balcony waterproofing membrane at the door hob-to-frame junction.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Metal termination" },
                  { label: "Standards", value: "AS 3740" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <WPTermMetalIntroSection />
            <WPTermMetalProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Critical notes for metal angle waterproofing termination at door hobs:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Metal termination bars are a mechanical fixing for the membrane edge — they do not waterproof the termination in isolation; the sealant joint above the termination bar is the primary waterproofing element at this junction",
                  "Always specify 316 stainless termination angles in balcony applications — aluminium termination bars corrode in wet, tile-grouted environments over time and are not appropriate for coastal locations",
                  "The sealant joint between the top of the termination bar and the door frame must be a compatible, correctly specified sealant — this joint is the most critical element in the termination assembly",
                  "Fixing screws through the termination angle into the hob must be 316 stainless and must be screw-sealed or sealed with sealant on installation — each fixing is a potential water path if left open",
                  "Membrane must be lapped under the termination bar and the bar pressed onto the membrane before fixing — do not apply the termination bar to bare substrate and then try to tuck membrane under it afterwards",
                  "Termination bar must be installed at minimum height above finished tile level as required by AS 3740 — do not install the termination bar below the required upstand height to accommodate the door frame",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">This page provides general technical information only. Termination bar selection, membrane compatibility, sealant specification and AS 3740 height compliance must be confirmed by a licensed waterproofer and qualified remedial practitioner against project-specific balcony construction and door frame conditions.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: "/defect-library/facade-external-envelope", label: "Defect Library", title: "Balcony door hob waterproofing failure" },
                { href: "/ai-scope-builder", label: "AI Scope Builder", title: "Generate a scope of works for balcony WP termination" },
              ].map((card) => (
