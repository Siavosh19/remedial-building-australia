...
export default function TwoCoatPMRenderPage() {
  return (
      ...
      <main>
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <TwoCoatPMRenderIntroSection />

            <TwoCoatPMRenderProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse two-coat polymer-modified render with:</h3>
              </div>
