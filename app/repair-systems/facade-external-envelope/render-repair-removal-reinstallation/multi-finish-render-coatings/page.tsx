...
import { MultiFinishRenderProductSection, MultiFinishRenderIntroSection } from "./MultiFinishRenderProductSection";

export const metadata: Metadata = {
  title: "Multi-Finish Render Coatings — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description: "Technical product reference for multi-finish render coatings — Westox Plastalite Multifinish for masonry and concrete facade surfaces on Australian strata and commercial buildings.",
};

const ACTIVE_SLUG = "multi-finish-render-coatings";
...
export default function MultiFinishRenderPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><MultiFinishRenderIntroSection /><MultiFinishRenderProductSection /></div></section>
