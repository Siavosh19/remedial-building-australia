  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="px-4 sm:px-8 py-14"><div className="mx-auto max-w-7xl space-y-10"><MultiFinishRenderIntroSection /><MultiFinishRenderProductSection /></div></section>
