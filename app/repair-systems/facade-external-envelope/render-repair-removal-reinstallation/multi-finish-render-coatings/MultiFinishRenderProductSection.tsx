...
type FilterTag = "Multi-finish" | "Render-finish" | "Masonry" | "Concrete" | "Pre-bagged" | "Hand-applied" | "Interior" | "Westox";
...
const PRODUCTS: Product[] = [
  {
    ...
    accentColor: "#64748b",
    name: "Westox Plastalite Multifinish 20kg",
    descriptionLine: "Multi-finish render coat for interior and exterior masonry and concrete surfaces — confirm current formulation, coverage, finish profile, and system specifications with Westox technical",
    productType: "Multi-finish render coat — masonry and concrete surfaces",
    filterTags: ["Multi-finish", "Render-finish", "Masonry", "Concrete", "Pre-bagged", "Hand-applied", "Westox"],
    techChips: [{ label: "Multi-finish", cls: "bg-slate-100 text-slate-700" }, { label: "Pre-bagged", cls: "bg-slate-100 text-slate-700" }, { label: "Render coat", cls: "bg-slate-100 text-slate-700" }],
    systemDescription: "Westox Plastalite Multifinish is a pre-bagged multi-finish render coat for masonry and concrete surfaces. Multi-finish render coats are used as a final finishing layer over base render coats or direct to block/masonry to provide a smooth or semi-smooth surface suitable for subsequent decoration or topcoat application.\n\nMulti-finish products are used in remedial facade works to provide a consistent and even surface finish before painting or texture coating application, and can also be used to correct minor surface irregularities in repaired render substrates.\n\nConfirm current product technical data sheet, water ratio, coverage, finish profile, coat thickness, and compatible topcoat system with Westox technical before specifying.",
    technicalProperties: [
      "Pre-bagged multi-finish render coat — suitable for masonry and concrete surfaces",
      "Provides smooth or semi-smooth finish suitable for subsequent paint or texture coating",
      "Confirm water ratio, coverage, finish profile, coat thickness, and compatible topcoat from current Westox Plastalite Multifinish TDS",
    ],
    limitations: [
      "Confirm current product formulation and system specifications with Westox technical before specifying",
      "Multi-finish coats are thin-section finishing layers — not suitable as a primary structural render replacement",
      "Confirm compatibility with subsequent topcoat and paint system with Westox before specifying",
...
const FILTER_DEFS: { id: FilterTag; label: string }[] = [{ id: "Multi-finish", label: "Multi-finish" }, { id: "Render-finish", label: "Render finish" }, { id: "Masonry", label: "Masonry" }, { id: "Concrete", label: "Concrete" }, { id: "Pre-bagged", label: "Pre-bagged" }];
...
export function MultiFinishRenderIntroSection() {
  return (<div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm"><div className="mb-4 flex items-center gap-2.5"><div className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-950 text-white"><BookOpen size={15} /></div><h3 className="text-base font-extrabold text-sky-950">Multi-finish render coatings</h3></div><p className="text-sm leading-7 text-slate-600">Multi-finish render coats are applied as a final finishing layer over base render coats or direct to block and masonry to provide a smooth or semi-smooth surface suitable for subsequent decoration or topcoat application. They are used in remedial facade works to correct minor surface irregularities and achieve a consistent finish before painting. Westox Plastalite Multifinish is a pre-bagged multi-finish render coat for masonry and concrete surfaces. Confirm current specifications with Westox technical before specifying.</p></div>);
}

export function MultiFinishRenderProductSection() {
  ...
  return (
    <div>
      <div className="mb-5 flex items-start gap-3"><div className="mt-1 h-5 w-1 shrink-0 rounded-full bg-red-700" /><div><h2 className="text-2xl font-extrabold text-sky-950">Product Reference</h2><p className="mt-1 text-sm text-slate-500">1 product — Westox — multi-finish render coating systems</p></div></div>
