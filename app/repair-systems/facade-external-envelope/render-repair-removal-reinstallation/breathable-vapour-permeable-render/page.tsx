...
export const metadata: Metadata = {
  title: "Breathable & Vapour-Permeable Render Systems — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description:
    "Technical product reference for breathable and vapour-permeable render systems with low sd values used in facade remediation on Australian masonry facades where moisture vapour release is required — Remmers, Parex, and Rockcote systems.",
};
...
export default function BreathableRenderRRPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Breathable &amp; vapour-permeable render systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for breathable and vapour-permeable render systems with low sd values used in facade remediation on Australian masonry facades where moisture vapour release through the render is required. Covers product classification, system selection, and brand comparisons.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "Vapour-permeable" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse breathable vapour-permeable render with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Standard PM render — low vapour permeability; standard polymer-modified renders have higher sd values and lower pore volumes that can trap moisture vapour behind the render surface",
                  "Salt-resistant renovating render — different sd value and pore structure specification; salt-resistant renovating render prioritises salt crystallisation accommodation, not primarily vapour permeability",
                  "Waterproof coatings — barrier coatings that are the opposite intent to breathable renders; applying a waterproof coating over a breathable render defeats the vapour permeability of the system",
                  "Elastomeric crack-bridging coatings — applied over render as a topcoat; applying these over breathable render reduces the system sd value and can trap moisture vapour",
                ].map((item) => (
