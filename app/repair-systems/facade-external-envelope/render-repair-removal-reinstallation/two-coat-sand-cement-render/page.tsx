...
import { TwoCoatSandCementIntroSection, TwoCoatSandCementProductSection } from "./TwoCoatSandCementProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Two-Coat Sand-Cement Render Systems — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description:
    "Technical product reference for two-coat sand-cement render systems used in render repair, removal and reinstallation works on Australian masonry and heritage facades — Mapei, Boral, and Rockcote system comparisons.",
};
...
export default function TwoCoatSandCementRenderPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Two-coat sand-cement render systems</span>
            </nav>
            <PageNav />
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <TwoCoatSandCementIntroSection />

            <TwoCoatSandCementProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse two-coat sand-cement render with:</h3>
              </div>
