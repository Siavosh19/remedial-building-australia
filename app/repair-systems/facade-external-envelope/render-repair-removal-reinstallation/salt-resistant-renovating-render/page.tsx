...
export const metadata: Metadata = {
  title: "Salt-Resistant Renovating Render Systems — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description:
    "Technical product reference for salt-resistant renovating render (sanierputz) systems used in facade remediation on Australian masonry and concrete facades subject to salt attack — WTA-classified systems from Remmers, Parex, and Rockcote.",
};
...
export default function SaltResistantRenderRRPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Salt-resistant renovating render systems</span>
            </nav>
            <PageNav />
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse salt-resistant renovating render with:</h3>
              </div>
