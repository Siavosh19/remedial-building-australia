...
export const metadata: Metadata = {
  title: "Saline-Resistant Primer & Slurry Systems — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description:
    "Technical product reference for saline-resistant primer and cementitious slurry systems applied to salt-contaminated masonry and concrete facades before WTA renovating render in Australian facade remediation — Remmers, Mapei, and Rockcote products.",
};
...
export default function SalinePrimerRRPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Saline-resistant primer &amp; slurry systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Saline-resistant primer &amp; slurry systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for saline-resistant primer and cementitious slurry systems applied to salt-contaminated masonry and concrete facades before WTA renovating render as part of a complete salt-attack remediation system. Covers products from Remmers, Mapei, and Rockcote.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "Primer / slurry" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse saline primer and slurry with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Bonding agent (general purpose render bonding) — general-purpose acrylic or SBR bonding agents are not formulated specifically for salt-contaminated substrates; a saline primer is the salt-specific equivalent used in WTA systems",
                  "Salt-retardant treatment — applied to substrate before the primer; the salt-retardant substrate treatment is stage 2 in the WTA system, and the saline primer/slurry is stage 3 — they are different stages, not the same product",
                  "Salt-resistant renovating render — the render system applied over the primer; the saline primer/slurry is substrate preparation, not a render system",
                  "Standard acrylic primer — not formulated for salt-affected substrates; standard acrylic primers are not compatible with WTA renovation render systems on salt-contaminated substrates",
                ].map((item) => (
