...
export const metadata: Metadata = {
  title: "Bonding Agent & Primer Systems — Render Repair, Removal & Reinstallation — Remedial Building Australia",
  description:
    "Technical product reference for bonding agent and primer systems used before render application on dense, smooth, and low-absorption substrates in Australian facade remediation — Mapei, Sika, Fosroc, and Rockcote products.",
};
...
export default function BondingAgentRRPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Bonding agent &amp; primer systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Bonding agent &amp; primer systems
                </h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for bonding agent and primer systems used before render application on dense, smooth, and low-absorption substrates in Australian facade remediation. Covers acrylic and SBR bonding agents from Mapei, Sika, Fosroc, and Rockcote.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Type", value: "Bonding agents / primers" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse bonding agents with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Render systems — bonding agents are substrate preparation products, not render systems; the render system (two-coat PM, salt-resistant, breathable, etc.) is applied over the bonding agent",
                  "Salt-retardant treatments — these treat the substrate for salt contamination and are a different stage in the remediation sequence; they are applied to the substrate before the bonding agent in salt-attack remediation",
                  "Saline primer — a specialist primer formulated for salt-affected substrates applied before salt-resistant render; different product class from a general bonding agent",
                  "Structural crack repair primers — crack injection and repair primers used in structural crack remediation; different product class from render bonding agents",
                ].map((item) => (
