...
import { HeadFlashSSIntroSection, HeadFlashSSProductSection } from "./HeadFlashSSProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Head Flashing — Stainless — Cladding Flashings — Remedial Building Australia",
  description:
    "Technical product reference for stainless 316 head flashings at cladding panel openings — drip-edge, Z-flashing, and box gutter head flashings for facade cladding remediation on Class 2 buildings in Australia.",
};
...
const ACTIVE_SLUG = "head-flashing-stainless";

export default function HeadFlashSSPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Head Flashing — Stainless</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Head Flashing — Stainless</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for stainless grade 316 head flashings at facade cladding panel openings — drip-edge, Z-profile, and box gutter head flashings for window heads, door heads, and horizontal panel junctions. Suitable for all exposure zones including coastal and marine.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "SS 316 head flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <HeadFlashSSIntroSection />
            <HeadFlashSSProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse stainless 316 head flashings with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Aluminium head flashing — appropriate for most inland and sheltered coastal zones but not marine zone exposures where SS 316 is required; aluminium head flashings will corrode at faster rates in high-chloride environments without adequate alloy specification",
                  "Galvanised steel head flashing — zinc coating does not provide sufficient corrosion resistance in coastal or marine environments; galvanised flashings installed adjacent to aluminium cladding also create a bimetallic corrosion risk",
                  "Lead flashing — prohibited in Australia for most new construction and remedial work; lead is a hazardous material and its use in accessible facade locations is not permitted under current health and safety requirements",
                  "Colorbond head flashing in marine zone — steel-substrate Colorbond has reduced corrosion resistance in direct marine exposure compared to SS 316; marine zones require SS 316 or specialist Colorbond Ultra with confirmed suitability",
                ].map((item) => (
