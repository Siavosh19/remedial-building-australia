...
import { HeadFlashColorIntroSection, HeadFlashColorProductSection } from "./HeadFlashColorProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Head Flashing — Colorbond — Cladding Flashings — Remedial Building Australia",
  description:
    "Technical product reference for Colorbond steel head flashings at cladding panel openings — pre-painted Colorbond drip-edge, Z-flashing, and box gutter head flashings with colour-matched finish for facade cladding remediation on Class 2 buildings.",
};
...
const ACTIVE_SLUG = "head-flashing-colorbond";

export default function HeadFlashColorPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Head Flashing — Colorbond</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Head Flashing — Colorbond</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for pre-painted Colorbond steel head flashings at facade cladding panel openings — drip-edge, Z-profile, and box gutter head flashings available in the full Colorbond colour range for colour-matched facade systems. Suitable for non-marine environments; confirm coastal suitability with BlueScope for specific colour and profile combinations.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Colorbond head flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <HeadFlashColorIntroSection />
            <HeadFlashColorProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse Colorbond head flashings with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Colorbond roofing accessories — roof ridges, barge flashings, and gutter profiles designed for horizontal roofing applications; facade head flashings have different profiles, upstand heights, and weathering details suited to vertical external wall terminations",
                  "Lead flashing — a heavy, grey malleable metal; often confused visually with painted steel flashings at a distance; lead is prohibited for most new and remedial facade work in Australia and must be removed and replaced, not patched",
                  "Zincalume in coastal or marine zones — Zincalume (unpainted Al-Zn coated steel) has lower corrosion resistance than Colorbond Ultra in coastal conditions; do not substitute Zincalume for Colorbond Ultra in coastal zones without confirming zone classification",
                  "Site-cut painted steel from off-cuts — raw-cut steel sheet or off-cut plate painted on site is not equivalent to factory Colorbond-coated flashing; cut edges on Colorbond flashings must be factory-treated or sealed to prevent edge corrosion",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_FLASHINGS}/head-flashing-aluminium`, label: "Head — Aluminium", title: "Aluminium head flashing for cladding" },
