...
import { ExternalCornerIntroSection, ExternalCornerProductSection } from "./ExternalCornerProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "External Corner Flashing — Cladding Flashings — Remedial Building Australia",
  description:
    "Technical product reference for external corner flashings at facade cladding system corners — aluminium and stainless 316 L-profile and box corner flashings at external corners between cladding panels on Class 2 buildings.",
};
...
const ACTIVE_SLUG = "external-corner-flashing";

export default function ExternalCornerPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">External Corner Flashing</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">External Corner Flashing</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for external corner flashings at facade cladding system corners — aluminium and stainless grade 316 L-profile, box, and extruded corner flashings at external corners where two cladding faces meet. Corner flashings must accommodate thermal movement and be compatible with the selected cladding panel system.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "External corner flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ExternalCornerIntroSection />
            <ExternalCornerProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse external corner flashings with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Internal corner flashings — L-section pressed inward to weatherproof a re-entrant corner; external corners require an outward-facing L-section or purpose-folded corner cap — mixing internal and external corner profiles creates weathering failures",
                  "Render corner bead (plaster bead) — a thin perforated aluminium or PVC bead used to reinforce external render at corners; a render bead is not a weatherproofing element and must not be used as a cladding corner flashing",
                  "PVC corner trim — combustible PVC corner moulding used in internal joinery and some lightweight cladding; on NCC Type A and Type B buildings, combustible facade trim components must not be used at corners where fire spread or external weather exposure is a concern",
                  "Aluminium corner trim installed without sealant at panel edges — corner flashings must be installed with compatible sealant at panel abutments to prevent water ingress at the flashing-to-panel interface, particularly at the top and exposed edges",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. External corner flashing profiles, leg dimensions, and fixing methods must be confirmed by a facade engineer against the specific cladding system design and panel movement requirements. Corner flashings at high-wind-load buildings require additional engineering consideration. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_FLASHINGS}/expressed-joint-vertical-joint-flashing`, label: "Expressed Joint", title: "Expressed joint and vertical joint flashing" },
