...
import { ExpressedJointFlashIntroSection, ExpressedJointFlashProductSection } from "./ExpressedJointFlashProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Expressed Joint / Vertical Joint Flashing — Cladding — Remedial Building Australia",
  description:
    "Technical product reference for expressed joint and vertical joint flashings in facade cladding systems — aluminium and stainless 316 cover flashings and Z-flashings at vertical joints and horizontal joints between cladding panels on Class 2 buildings.",
};
...
const ACTIVE_SLUG = "expressed-joint-vertical-joint-flashing";

export default function ExpressedJointFlashPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Expressed Joint / Vertical Joint Flashing</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Expressed Joint / Vertical Joint Flashing</h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Expressed joint flashing" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <ExpressedJointFlashIntroSection />
            <ExpressedJointFlashProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse expressed / vertical joint flashings with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Expressed joint flashing profiles, lap dimensions, and fixing methods must be confirmed by a facade engineer against the specific cladding system design and panel movement requirements. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
