...
import { JointSealantIntroSection, JointSealantProductSection } from "./JointSealantProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Joint Sealant Replacement Systems — Cladding — Remedial Building Australia",
  description:
    "Technical product reference for joint sealant replacement systems in facade cladding — silicone, polyurethane, and hybrid sealants for movement joints between cladding panels and at perimeter junctions on Class 2 buildings in Australia.",
};
...
const ACTIVE_SLUG = "joint-sealant-replacement-systems";

export default function JointSealantPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Joint Sealant Replacement Systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Joint Sealant Replacement Systems</h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Si / PU / Hybrid sealant" },
                  { label: "Standards", value: "ISO 11600 / NCC 2022" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <JointSealantIntroSection />
            <JointSealantProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse external facade joint sealants with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Joint sealant selection, joint geometry, and application method must be confirmed by a facade engineer. Adhesion to specific cladding substrates must be verified by peel adhesion test. Three-sided bond must be prevented by a correctly sized backer rod. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_JOINTS}/express-joint-trim-systems`, label: "Express Joint / Trim", title: "Expressed joint trim systems for cladding" },
