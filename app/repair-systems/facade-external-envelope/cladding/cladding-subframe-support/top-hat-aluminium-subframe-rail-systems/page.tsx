...
import { TopHatIntroSection, TopHatProductSection } from "./TopHatProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Top-Hat / Aluminium Subframe & Rail Systems — Cladding — Remedial Building Australia",
  description:
    "Technical product reference for top-hat and aluminium subframe rail systems supporting facade cladding remediation on Class 2 buildings in Australia — extruded aluminium top-hat, Z-section, and proprietary rail systems.",
};
...
const ACTIVE_SLUG = "top-hat-aluminium-subframe-rail-systems";
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Top-Hat / Aluminium Subframe &amp; Rail Systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Top-Hat / Aluminium Subframe &amp; Rail Systems</h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Aluminium rail / top-hat" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse aluminium top-hat subframe systems with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Subframe design including bracket spacing, structural capacity, and thermal performance must be confirmed by a structural engineer and facade engineer. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_SUBFRAME}/helping-hand-bracket-fixing-systems`, label: "Helping-Hand Bracket", title: "Helping-hand and bracket fixing systems" },
