...
import { FCSheetIntroSection, FCSheetProductSection } from "./FCSheetProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Fibre Cement Compressed Sheet — Non-Combustible Cladding — Remedial Building Australia",
  description:
    "Technical product reference for fibre cement compressed sheet external cladding — NCC 2022 non-combustible external wall cladding for Class 2 buildings. Includes standard, textured, and primed FC compressed sheets.",
};
...
const ACTIVE_SLUG = "fibre-cement-compressed-sheet";

export default function FCSheetPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Fibre Cement Compressed Sheet</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Fibre Cement Compressed Sheet</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for compressed fibre cement sheet non-combustible external cladding. Standard, textured, and factory-primed FC compressed sheets for NCC 2022 compliant cladding replacement on Class 2 buildings. Products include James Hardie, BGC, and Cemintel ranges.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "FC compressed sheet" },
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse fibre cement compressed sheet with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Fibre cement architectural panel — large-format, factory-primed and factory-finished FC panels for rainscreen or concealed-fix cladding; compressed sheet is typically face-fixed in expressed-joint configurations — different product specification",
                  "FC wet-area lining sheet — interior-grade fibre cement used in bathrooms; not rated for external vertical cladding or facade weatherproofing applications",
                  "Non-compressed fibre cement (standard density) — lower-density FC board not suitable for external facade exposure; compressed sheet is high-density and moisture-resistant",
                  "FC flooring sheet — higher-density FC used as a tile substrate over floor framing; not rated for external vertical facade installation",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Fibre cement compressed sheet must be confirmed against NCC 2022 non-combustible requirements and building height classification. Engage a building certifier before specification. Do not rely on this reference as a substitute for professional advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_REPLACEMENT}/fibre-cement-architectural-panel`, label: "FC Architectural Panel", title: "Fibre cement architectural facade panels" },
