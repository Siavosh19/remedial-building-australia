...
import { TerracottaIntroSection, TerracottaProductSection } from "./TerracottaProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Terracotta / Ceramic Facade Panel — Cladding — Remedial Building Australia",
  description:
    "Technical product reference for terracotta and ceramic rainscreen facade panels — non-combustible, fired-clay cladding for NCC 2022 compliant facade remediation on Class 2 buildings in Australia.",
};
...
const ACTIVE_SLUG = "terracotta-ceramic-facade-panel";
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Terracotta / Ceramic Facade Panel</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Terracotta / Ceramic Facade Panel</h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Terracotta / ceramic" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <TerracottaIntroSection />
            <TerracottaProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse terracotta / ceramic facade panels with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Terracotta and ceramic panel cladding requires facade engineering including subframe design, thermal movement, and clip fixing specification. Engage a facade engineer before specification. Panel self-weight requires structural assessment of supporting framing.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_REPLACEMENT}/vitreous-enamel-porcelain-panel`, label: "Vitreous Enamel", title: "Vitreous enamel and porcelain facade panels" },
