...
import { SolidAlumIntroSection, SolidAlumProductSection } from "./SolidAlumProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Solid Aluminium Sheet — Non-Combustible Cladding — Remedial Building Australia",
  description:
    "Technical product reference for solid aluminium sheet non-combustible facade cladding replacement — 3 mm and 4 mm solid aluminium panels for NCC 2022 compliant cladding remediation on Class 2 buildings in Australia.",
};
...
const SIBLING_GROUPS = [
  {
    heading: "Cladding Replacement — Fire-Rated",
    tabs: [
  ...
  {
    heading: "Joints & Weatherproofing",
    tabs: [
...
const ACTIVE_SLUG = "solid-aluminium-sheet-non-combustible";

export default function SolidAlumPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <Link href="/repair-systems/facade-external-envelope/cladding" className="hover:text-sky-700 transition">Cladding</Link>
              <span>/</span>
              <span className="text-sky-950">Solid Aluminium Sheet — Non-Combustible</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Solid aluminium sheet" },
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SolidAlumIntroSection />
            <SolidAlumProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse solid aluminium sheet (non-combustible) with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_REPLACEMENT}/aluminium-composite-fr-a2-core`, label: "ACP — FR/A2 Core", title: "Aluminium composite panels with fire-resistant core" },
      ...
      <footer className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-7xl px-5 pt-10">
          <Link href="/repair-systems/facade-external-envelope/cladding" className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm transition hover:bg-slate-200">
            ← Cladding
          </Link>
        </div>
