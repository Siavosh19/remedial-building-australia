...
import { FCPanelIntroSection, FCPanelProductSection } from "./FCPanelProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Fibre Cement Architectural Panel — Cladding — Remedial Building Australia",
  description:
    "Technical product reference for fibre cement architectural facade panels — large-format, textured, and factory-finished FC panels for NCC 2022 compliant cladding replacement on Class 2 buildings in Australia.",
};
...
const ACTIVE_SLUG = "fibre-cement-architectural-panel";

export default function FCPanelPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Fibre Cement Architectural Panel</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Fibre Cement Architectural Panel</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Technical product reference for large-format fibre cement architectural facade panels — factory-primed, textured, and pre-finished FC panels for NCC 2022 compliant cladding replacement. Products include Scyon Axon, Cemintel Director, and James Hardie architectural ranges used in rainscreen and face-fixed configurations.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "FC architectural panel" },
                  { label: "Standards", value: "NCC 2022 / AS 1530.1" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse fibre cement architectural panels with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Fibre cement compressed sheet — smaller-format, uncoated FC sheet used face-fixed with expressed joints; architectural panels are large-format, factory-primed and typically used in concealed-fix or rainscreen configurations — different fixing method and specification",
                  "ACP — aluminium composite panels with combustible polyethylene core — prohibited on Type A and Type B buildings under NCC 2022 as a replacement cladding; FC panels are non-combustible and compliant",
                  "FC wet-area lining sheet — interior-only fibre cement used in bathrooms and laundries; architectural facade panels are external-grade with appropriate surface treatment and density rating",
                  "FC eaves lining — thinner, lower-density FC board used as non-structural soffit lining; not the same product as an architectural facade panel and not rated for vertical external cladding loads",
                ].map((item) => (
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Fibre cement architectural panels must be confirmed against NCC 2022 and the building's fire performance requirements. Engage a building certifier and facade engineer before specification.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_REPLACEMENT}/fibre-cement-compressed-sheet`, label: "FC Compressed Sheet", title: "Standard fibre cement compressed sheet cladding" },
