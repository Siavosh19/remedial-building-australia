...
import { ACPFRIntroSection, ACPFRProductSection } from "./ACPFRProductSection";

export const metadata: Metadata = {
  title: "Aluminium Composite — FR/A2 Core Cladding — Remedial Building Australia",
  description:
    "Technical product reference for aluminium composite panels with fire-resistant FR core or non-combustible A2 mineral core — NCC 2022 compliant cladding replacement for Class 2 buildings in Australia.",
};
...
const ACTIVE_SLUG = "aluminium-composite-fr-a2-core";

export default function ACPFRPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Aluminium Composite — FR/A2 Core</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "ACP FR / A2 core" },
                  { label: "Standards", value: "NCC 2022 / AS 1530.3" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse FR/A2 core ACP panels with:</h3>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_REPLACEMENT}/solid-aluminium-sheet-non-combustible`, label: "Solid Aluminium", title: "Solid aluminium sheet non-combustible panels" },
