...
import { MetalProfiledIntroSection, MetalProfiledProductSection } from "./MetalProfiledProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Metal Profiled / Standing-Seam Cladding — Remedial Building Australia",
  description:
    "Technical product reference for metal profiled, mini-orb, and standing-seam facade cladding — steel, aluminium, and Colorbond profiled cladding for NCC 2022 compliant facade remediation on Class 2 buildings.",
};
...
const ACTIVE_SLUG = "metal-profiled-standing-seam-cladding";

export default function MetalProfiledPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Metal Profiled / Standing-Seam Cladding</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Metal Profiled / Standing-Seam Cladding</h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "Metal profiled / seam" },
                  { label: "Standards", value: "NCC 2022 / AS 1562" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <MetalProfiledIntroSection />
            <MetalProfiledProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse metal profiled / standing-seam facade cladding with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Metal profiled and standing-seam cladding must be confirmed against NCC 2022 and AS 1562 for facade application. Thermal movement provision and concealed-fix system design require facade engineering review. Engage a facade engineer before specification.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_REPLACEMENT}/solid-aluminium-sheet-non-combustible`, label: "Solid Aluminium", title: "Solid aluminium sheet non-combustible cladding" },
                { href: `${BASE_JOINTS}/joint-sealant-replacement-systems`, label: "Joint Sealant", title: "Joint sealant replacement for cladding systems" },
