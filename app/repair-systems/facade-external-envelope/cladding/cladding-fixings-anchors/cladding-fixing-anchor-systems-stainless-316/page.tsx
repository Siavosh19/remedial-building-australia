...
import { SS316FixingsIntroSection, SS316FixingsProductSection } from "./SS316FixingsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Cladding Fixing & Anchor Systems — Stainless Grade 316 — Remedial Building Australia",
  description:
    "Technical product reference for stainless grade 316 cladding fixing and anchor systems — screw, bolt, and anchor products for securing facade cladding panels and subframes to building structure on Class 2 buildings.",
};
...
const ACTIVE_SLUG = "cladding-fixing-anchor-systems-stainless-316";

export default function SS316FixingsPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Cladding Fixing &amp; Anchor Systems — SS 316</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Cladding Fixing &amp; Anchor Systems — Stainless Grade 316</h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "System type", value: "SS 316 fixings" },
                  { label: "Standards", value: "AS 3600 / NCC 2022" },
                ].map((s) => (
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SS316FixingsIntroSection />
            <SS316FixingsProductSection />
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse stainless 316 cladding fixings with:</h3>
              </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 sm:px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">Information is general only. Fixing selection and spacing must be confirmed by a structural engineer against design wind loads. Site pull-out testing is mandatory for anchors into existing concrete or masonry. Do not rely on this reference as a substitute for professional engineering advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE_FIXINGS}/rivet-concealed-fix-systems`, label: "Rivet / Concealed Fix", title: "Rivet and concealed fix systems for cladding" },
