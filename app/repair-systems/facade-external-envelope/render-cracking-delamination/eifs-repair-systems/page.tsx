...
import { EIFSRepairIntroSection, EIFSRepairProductSection } from "./EIFSRepairProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "EIFS Repair Systems — Render Cracking — Remedial Building Australia",
  description:
    "Technical product reference for external insulation and finish system (EIFS) repair — Sto, Parex and Rockcote EPS board, base coat, mesh and finish coat systems for EIFS defect repair on Class 2 strata facades.",
};
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">EIFS repair systems</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  External insulation and finish system (EIFS) defects require system-specific repair — patching with standard render is not compatible with the EPS substrate. Sto, Parex and Rockcote EIFS repair systems use proprietary adhesive, base coat, alkali-resistant mesh and finish coat to restore the complete system integrity.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "System type", value: "EIFS" },
                  { label: "Mesh type", value: "160g/m² AR glass" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EIFSRepairIntroSection />
            <EIFSRepairProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">General technical information only. EIFS repair must use the same system manufacturer's components — do not mix brands. Confirm system compatibility, NCC fire compliance and substrate assessment with the EIFS manufacturer and a qualified facade consultant before proceeding.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { href: "/repair-systems/facade-external-envelope/render-removal-and-installation/eifs-systems", label: "Render Removal", title: "EIFS full installation systems" },
                { href: `${BASE_URL}/bonding-agent-primer-systems`, label: "Render Cracking", title: "Bonding agent and primer systems" },
