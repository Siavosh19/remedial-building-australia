...
import { FibreReinforcedRenderIntroSection, FibreReinforcedRenderProductSection } from "./FibreReinforcedRenderProductSection";

export const metadata: Metadata = {
  title: "Fibre-Reinforced Render Systems — Render Cracking — Remedial Building Australia",
  description:
    "Technical product reference for AR glass fibre-reinforced render systems for improved crack resistance on rendered facades — Parex, Rockcote and Sika systems for render cracking and delamination repair.",
};
...
const ACTIVE_SLUG = "fibre-reinforced-render";
const BASE_URL = "/repair-systems/facade-external-envelope/render-cracking-delamination";

export default function FibreReinforcedRenderPage() {
  return (
      ...
      <main>
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span className="text-sky-950">Fibre-reinforced render</span>
            </nav>
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Fibre type", value: "AR glass" },
                  { label: "Min thickness", value: "8mm" },
                  { label: "Fibre content", value: "≥0.9 kg/m²" },
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <FibreReinforcedRenderIntroSection />
            <FibreReinforcedRenderProductSection />
          </div>
        </section>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-8 py-10">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
              ...
              <p className="text-xs leading-6 text-amber-900">General technical information only. System selection must be confirmed against substrate type, defect cause, and the current manufacturer TDS. Confirm compliance with AS 3700. Not a substitute for professional advice.</p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { href: `${BASE_URL}/two-coat-polymer-modified-render`, label: "Render Cracking", title: "Two-coat polymer-modified render systems" },
