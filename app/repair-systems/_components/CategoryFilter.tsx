...
export default function CategoryFilter({ groups, basePath }: { groups: Group[]; basePath: string }) {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">{totalCategories} product categories — select to view technical reference and brand equivalents.</p>
          </div>
        </div>
                ...
                <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                  {group.categories.map((cat) => (
                    ...
                    >
                      ...
                      <p className="mt-2 text-xs font-semibold text-slate-400">{cat.count} {cat.count === 1 ? "product" : "products"}</p>
