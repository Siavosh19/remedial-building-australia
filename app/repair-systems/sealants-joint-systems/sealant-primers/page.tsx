...
import {
  SealantPrimersIntroSection,
  SealantPrimersProductSection,
} from "./SealantPrimersProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Sealant Adhesion Primers — Sealants & Joint Systems — Remedial Building Australia",
  description:
    "Technical product reference for sealant adhesion primers used with silicone and polyurethane movement joint sealants on Australian Class 2 strata and commercial buildings — Sika Primer-215, Dow Corning PR-1200, Tremco primers.",
};
...
export default function SealantPrimersPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Sealant adhesion primers</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Chemistry", value: "Silane / organosilane / isocyanate" },
                  { label: "Use", value: "Porous and non-porous substrates" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "sealant-primers";
                      return (
                        <Link
                          key={tab.slug}
