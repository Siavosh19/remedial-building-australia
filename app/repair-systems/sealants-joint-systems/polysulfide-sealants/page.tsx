...
import {
  PolysulfideSealantsIntroSection,
  PolysulfideSealantsProductSection,
} from "./PolysulfideSealantsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Polysulfide Joint Sealants — Sealants & Joint Systems — Remedial Building Australia",
  description:
    "Technical product reference for two-component polysulfide joint sealants used in Australian curtain wall, glazing channel and structural joint applications — Bostik Thioflex, Fosroc Nitoseal, Sika two-part systems.",
};
...
export default function PolysulfideSealantsPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Polysulfide joint sealants</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Components", value: "2-part mix" },
                  { label: "Use", value: "Structural / glazing joints" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "polysulfide-sealants";
                      return (
                        <Link
                          key={tab.slug}
