...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    productType: "Neutral-cure silicone",
    filterTags: ["Silicone", "Neutral-cure", "Weatherseal", "Facade-joint", "Movement-joint", "UV-stable", "ISO-11600", "1C"],
    techChips: [
      { label: "Neutral-cure silicone", cls: "bg-sky-100 text-sky-800" },
      { label: "One-component", cls: "bg-slate-100 text-slate-700" },
      { label: "Low modulus", cls: "bg-violet-100 text-violet-800" },
      { label: "Weatherseal", cls: "bg-slate-100 text-slate-700" },
      { label: "ISO 11600-F&G-25LM", cls: "bg-amber-50 text-amber-700" },
    ],
    systemDescription:
      "DOWSIL 791 (formerly Dow Corning 791) is a one-component neutral-cure low-modulus silicone weatherproofing sealant for curtain wall façade, expansion joint and perimeter weatherseal applications. It is neutral cure — it does not release acetic acid — making it suitable for use on metals, concrete, masonry and porous substrates as well as glass and aluminium. Conforms to ISO 11600-F&G-25LM. Movement capability is ±50%. Confirm substrate compatibility and primer requirements from Dow technical data before specifying.",
    technicalProperties: [
      "Neutral-cure — does not release acetic acid — suitable for metals, masonry, concrete and porous substrates",
      "ISO 11600-F&G-25LM — movement capability ±50% — exceeds ISO 11600 Class 25 requirements",
      "Low modulus — low stress on joint faces — suitable for curtain wall and façade weatherseal joints",
      "Excellent UV and ozone resistance — suitable for external exposure in Australian conditions",
      "One-component — no mixing required — suitable for field application by contractors",
    ],
    limitations: [
      "Not a structural sealant — not rated for structural glazing under ASTM C1184 — use DOWSIL 795 for structural glazing applications",
      "Primer required on certain substrates — confirm from Dow TDS for each specific substrate before application",
      "Not paintable — silicone surface cannot be painted without special topcoat system",
      "Do not apply to wet or frost-covered substrates — allow surface to dry before application",
  ...
  },
  {
    ...
    productType: "Neutral-cure silicone",
    filterTags: ["Silicone", "Neutral-cure", "Structural", "Weatherseal", "Facade-joint", "Movement-joint", "UV-stable", "ISO-11600", "1C", "High-movement"],
    techChips: [
      { label: "Neutral-cure silicone", cls: "bg-sky-100 text-sky-800" },
      { label: "One-component", cls: "bg-slate-100 text-slate-700" },
      { label: "2-sided structural glazing", cls: "bg-slate-100 text-slate-700" },
      { label: "UV stable", cls: "bg-amber-50 text-amber-700" },
      { label: "ASTM C920 — confirm ISO class", cls: "bg-amber-50 text-amber-700" },
    ],
    systemDescription:
      "Tremco Spectrem 2 is a one-component neutral-cure medium-modulus silicone sealant suitable for 2-sided structural glazing, exterior façade, curtain wall and glazing joint applications on Class 2 and commercial buildings in Australia. Neutral-cure system — no acetic acid release — suitable for a wider substrate range including aluminium, glass, steel, painted metal, plastic, stone, concrete and masonry. UV and ozone resistant. Part of Tremco CPG's complete façade sealant system — warranted when used with compatible Tremco primers throughout. Confirm ASTM C920 and ISO 11600 classifications from current Tremco CPG APAC TDS before specifying.",
    technicalProperties: [
      "Neutral-cure — no acetic acid release — suitable for aluminium, glass, steel, masonry, concrete and porous substrates",
      "Suitable for 2-sided structural glazing applications — confirm structural glazing warranty requirements with Tremco CPG",
      "UV and ozone resistant — suitable for direct external exposure in all Australian climate zones",
  ...
  },
  {
    ...
    productType: "One-component pure polyurethane",
    filterTags: ["Polyurethane", "Facade-joint", "Movement-joint", "Weatherseal", "1C", "ISO-11600", "Paintable"],
    techChips: [
      { label: "One-component pure PU", cls: "bg-sky-100 text-sky-800" },
    ...
    systemDescription:
      "Sika Sikaflex-11 FC Purform (formerly Sikaflex-11 FC+) is a fast-curing one-component pure polyurethane sealant and adhesive widely used in Australian construction and remediation for façade, balcony, wall and floor joints. Suitable for sealing joints in concrete, masonry, metal, wood and most plastics. Can be painted after full cure. Used extensively in Class 2 strata remediation for sealing non-structural movement joints, window perimeter sealing, balcony edge joints and general construction joint sealing. Application temperature range +5°C to +35°C. Confirm joint width, depth and movement expectations against manufacturer joint design guidance before specifying.",
    technicalProperties: [
  ...
  },
  {
    ...
    techChips: [
      { label: "One-component pure PU", cls: "bg-sky-100 text-sky-800" },
      { label: "Floor & civil applications", cls: "bg-slate-100 text-slate-700" },
      { label: "UV resistant", cls: "bg-amber-50 text-amber-700" },
      { label: "TODO: owner confirm ISO class", cls: "bg-amber-50 text-amber-700" },
      { label: "High movement", cls: "bg-green-50 text-green-700" },
    ],
    systemDescription:
      "Sika Sikaflex PRO-3 Purform (formerly Sikaflex-PRO-3 WF) is a one-component pure polyurethane weatherproofing sealant for floor and civil engineering joint applications including façade, balcony, horizontal and vertical movement joint applications in Class 2 and commercial building remediation. The Australian TDS (July 2025, Version 04.01) is available at aus.sika.com. Confirm ISO 11600 classification, exact movement capacity and primer selection per substrate from the current Sika Australia TDS before specifying.",
    technicalProperties: [
      "One-component pure PU — moisture cures — confirm ISO 11600 classification from current Sika Australia TDS",
      "Pure polyurethane formulation — Purform technology — confirm UV resistance claims from current Australian TDS",
      "Suitable for floor and civil engineering joints — confirm suitability for façade and balcony deck applications with Sika Australia",
      "Good adhesion to concrete, masonry, fibre cement, metal and primed timber",
      "TODO: owner confirm — ISO 11600 classification and movement capacity for PRO-3 Purform not confirmed from AU TDS fetch",
    ],
    limitations: [
  ...
  },
  {
    ...
    technicalProperties: [
      ...
      "ISO 11600 F-25-LM — movement capacity 25% — low modulus (0.25 N/mm²) — Shore A hardness 22",
  ...
  },
  {
    ...
    filterTags: ["Polyurethane", "Hybrid-PU", "Facade-joint", "Movement-joint", "Weatherseal", "Expansion-joint", "1C", "Paintable"],
    techChips: [
      { label: "One-component PU-hybrid", cls: "bg-violet-100 text-violet-800" },
      { label: "Paintable", cls: "bg-green-50 text-green-700" },
      { label: "UV resistant", cls: "bg-amber-50 text-amber-700" },
      { label: "Façade & window perimeter", cls: "bg-slate-100 text-slate-700" },
    ],
    systemDescription:
      "Tremco Dymonic FC is a single-component, fast-curing, moisture-cure polyurethane hybrid sealant specifically formulated for façade and window perimeter sealing applications on Class 2 and commercial buildings in Australia. High UV resistance. Paintable after cure. Used for control joints, perimeter caulking around windows and doors, and panel joint sealing. Note: Tremco Australia also offers Dymonic 100 (a separate product — medium-modulus non-sag polyurethane with +100%/-50% movement capacity). Confirm which Dymonic product is appropriate for the specific application with Tremco Australia before specifying.",
    technicalProperties: [
      "One-component moisture-cure PU-hybrid — fast curing — suitable for façade and window perimeter joint sealing",
      "Paintable after cure — suitable for colour-matched façade joint repairs in visible locations",
      "High UV resistance — suitable for external façade exposure in Australian climate conditions",
      "Suitable for vertical joint orientations — control joints, perimeter caulking and panel joints",
      "Confirm ISO 11600 classification and movement capacity from current Tremco Australia TDS before specifying",
    ],
    limitations: [
      ...
      "Not suitable for submerged or water-retaining structure joints — do not use in below-grade submerged conditions",
      "Confirm movement capacity against project specification — Dymonic FC and Dymonic 100 have different movement ratings",
      "Tremco CPG distribution in Australia more limited than Sika or Dow — confirm local availability before specifying",
      "Confirm current product specification, ISO 11600 classification and local availability with Tremco CPG Australia before specifying",
    ],
    procurementSources: [
      { name: "Tremco CPG Australia — trade supply — contact for current pricing", url: "https://www.tremcosealants.com.au" },
    ],
...
const BRAND_EQUIV: { system: string; dow: string; sika: string; mapei: string; tremco: string }[] = [
  { system: "Silicone neutral-cure — structural / high-movement", dow: "DOWSIL 795", sika: "Sikasil structural*", mapei: "—", tremco: "Spectrem 2" },
  { system: "Silicone neutral-cure — low-modulus weatherseal / façade", dow: "DOWSIL 791", sika: "Sikasil-GP*", mapei: "—", tremco: "—" },
  { system: "PU 1C — general purpose sealant / adhesive", dow: "—", sika: "Sikaflex-11 FC Purform", mapei: "Mapeflex PU50 SL*", tremco: "—" },
  { system: "PU 1C — weatherproofing façade / high movement", dow: "—", sika: "Sikaflex PRO-3 Purform", mapei: "—", tremco: "Dymonic FC / Dymonic 100*" },
];
