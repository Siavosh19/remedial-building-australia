...
import {
  IntumescentJointSealantsIntroSection,
  IntumescentJointSealantsProductSection,
} from "./IntumescentJointSealantsProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Intumescent Joint Sealants — Passive Fire Protection — Remedial Building Australia",
  description:
    "Technical product reference for intumescent and fire-rated joint sealants used in passive fire protection on Australian Class 2 buildings — Hilti CP 601S, 3M Fire Barrier, Bostik FireFlex — penetration sealing and fire-rated joint systems.",
};
...
export default function IntumescentJointSealantsPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Intumescent joint sealants</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">
                  Intumescent joint sealants — passive fire protection
                </h1>
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Rating type", value: "FRL rated" },
                  { label: "Use", value: "Penetrations / fire joints" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "intumescent-joint-sealants";
                      return (
                        <Link
                          key={tab.slug}
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                {
                  href: "/repair-systems/sealants-joint-systems/movement-joint-sealants-silicone-pu",
                  label: "Silicone & PU Sealants",
                  title: "Browse silicone and polyurethane movement joint sealant systems",
                },
              ].map((card) => (
                <a
                  key={card.href}
