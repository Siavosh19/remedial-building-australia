...
import {
  BackingRodBondBreakerIntroSection,
  BackingRodBondBreakerProductSection,
} from "./BackingRodBondBreakerProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Backing Rods and Bond Breaker Tape — Sealants & Joint Systems — Remedial Building Australia",
  description:
    "Technical product reference for closed-cell polyethylene backing rods and polyethylene bond breaker tapes used in movement joint design for Australian Class 2 strata and commercial buildings — Sika, Tremco, Backer Rod Mfg.",
};
...
export default function BackingRodBondBreakerPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-4 sm:px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Backing rods & bond breaker tape</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Product types", value: "2" },
                  { label: "Material", value: "Closed-cell PE foam / PE tape" },
                  { label: "Function", value: "Joint depth control / 2-point adhesion" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "backing-rod-bond-breaker";
                      return (
                        <Link
                          key={tab.slug}
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                {
                  href: "/repair-systems/balcony-waterproofing-failure/backer-rod-bond-breaker-tape",
                  label: "Backer Rod for Waterproofing",
                  title: "Backer rod and bond breaker tape for balcony waterproofing movement joints",
                },
              ].map((card) => (
                <a
                  key={card.href}
