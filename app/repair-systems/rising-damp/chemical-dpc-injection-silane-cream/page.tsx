...
import { SilaneCreamDPCIntroSection, SilaneCreamDPCProductSection } from "./SilaneCreamDPCProductSection";
import PageNav from "@/components/PageNav";

import SiteHeader from "@/components/SiteHeader";
import SeoCrossPromo from "@/components/sections/SeoCrossPromo";
export const metadata: Metadata = {
  title: "Chemical DPC Injection — Silane Cream — Rising Damp — Remedial Building Australia",
  description:
    "Technical product reference for silane cream chemical damp proof course injection for rising damp treatment in Australian masonry — product comparisons, brand equivalents, BS 6576 compliance and system selection.",
};
...
export default function SilaneCreamDPCPage() {
  return (
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Chemical DPC injection — silane cream</span>
            </nav>
            <PageNav />
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              ...
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Application method", value: "Cartridge gun" },
                  { label: "Standard", value: "BS 6576" },
                ].map((s) => (
              ...
              {SIBLING_GROUPS.map((group, gi) => (
                ...
                >
                  ...
                  <div className="flex items-end">
                    {group.tabs.map((tab) => {
                      const active = tab.slug === "chemical-dpc-injection-silane-cream";
                      return (
                        <a
                          key={tab.slug}
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <SilaneCreamDPCIntroSection />
            <SilaneCreamDPCProductSection />
          </div>
        </section>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  label: "Next: Salt-Resistant Plaster",
                  title: "WTA renovation plasters for rising damp remediation",
                },
                {
                  href: "/repair-systems/rising-damp/chemical-dpc-injection-siloxane-liquid",
