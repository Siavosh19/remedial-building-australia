...
export const metadata: Metadata = {
  title: "Abrasives, Blades & Tools — Slab Edge Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for diamond and abrasive grinding discs for slab edge surface preparation in Australian carparks and Class 2 buildings — Husqvarna Vari-Cut, Norton Bear-Tex, Metabo, Makita, and Bosch Expert comparisons.",
};
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight text-sky-950 md:text-5xl">Abrasives, blades &amp; tools</h1>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for diamond and abrasive grinding discs used for slab edge surface preparation before repair mortar application. Covers disc types and brands for achieving ICRI CSP 3 surface profile on concrete edge faces.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  { label: "Products covered", value: "5" },
                  { label: "Target profile", value: "CSP 3" },
                  { label: "Standard", value: "ICRI 310.2R" },
                  { label: "Dust control", value: "WHS regulated" },
                ].map((s) => (
          ...
          <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              <div className="mb-4 flex items-center gap-2.5">
                ...
                <h3 className="text-base font-extrabold text-amber-900">Do not confuse angle grinder grinding discs with:</h3>
              </div>
              <ul className="space-y-2.5">
                {[
                  "Concrete cutting discs and crack chaser blades — cutting discs and crack chaser blades are used for saw-cutting expansion joints, chase cuts, and slot operations; grinding discs are used for surface profiling — they are different tools and must not be substituted for each other",
                  "Tile saw blades and tile cutting discs — tile cutting discs are designed for ceramic, porcelain, and natural stone; they are not rated for concrete surface grinding and should not be used on concrete slab edges",
                  "Floor polishing and diamond polishing pads — polishing pads are used with planetary floor grinders for finishing and shine operations on cured concrete; they do not achieve CSP 3 profile and are not suitable for repair preparation",
                  "Floor grinding machines (Husqvarna PG, Scanmaskin) — planetary floor grinders are used for large-area slab surface preparation and are covered separately under magnesite flooring preparation; angle grinder discs are used for the restricted geometry of slab edge faces",
                  "Wire cup brushes for rebar cleaning — wire cup brushes and angle grinder wire wheels are used to clean corroded reinforcement bars, not to profile concrete surfaces; they do not achieve CSP 3 on concrete and must not be used as a substitute for diamond disc grinding",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/bonding-agents-sbr-latex`, label: "Bonding Agents", title: "Applied after surface preparation to prime for repair mortar" },
                { href: `${BASE}/repair-mortars-polymer-modified`, label: "PM Repair Mortars", title: "Repair mortars applied after surface preparation and bonding agent" },
              ].map((card) => (
