...
import { EpoxyRepairMortarsIntroSection, EpoxyRepairMortarsProductSection } from "./EpoxyRepairMortarsProductSection";

export const metadata: Metadata = {
  title: "Epoxy Repair Mortars — Slab Edge Deterioration — Remedial Building Australia",
  description:
    "Technical product reference for epoxy repair mortars for slab edge deterioration in Australian carparks and Class 2 buildings — Ardex RA 88 Plus, Sika Sikadur-42, and Fosroc Nitomortar 50 system comparisons.",
};
...
export default function EpoxyRepairMortarsPage() {
  return (
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">Technical product reference for epoxy repair mortars for high-load, chemically exposed, or early-return-to-service slab edge repairs in Australian carparks and industrial structures. Covers 2-part and 3-part systems from Ardex, Sika, and Fosroc.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 self-start rounded-2xl border border-slate-200 bg-slate-50 p-5">
                {[
                  ...
                  { label: "Traffic return", value: "4–8 hrs" },
                ].map((s) => (
        ...
        <section className="px-8 py-14">
          <div className="mx-auto max-w-7xl space-y-10">
            <EpoxyRepairMortarsIntroSection />
            <EpoxyRepairMortarsProductSection />
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-7">
              ...
              <ul className="space-y-2.5">
                {[
                  "Polymer-modified cementitious mortars (Sika MonoTop, Ardex BR 340, Fosroc Renderoc HB) — water-based polymer-modified mortars for standard structural slab edge repair — different binder chemistry, lower cost, longer open time, and vapour-permeable after cure — most slab edge repairs use PM mortars, not epoxy",
                  "Epoxy injection resins (Sika Sikadur-52, Fosroc Nitofill LD) — low-viscosity liquid resins injected under pressure into cracks — different product and application method — injection resins restore structural continuity in cracked elements; epoxy mortars fill voids and rebuild sections",
                  "Epoxy coating and membrane systems (Sika Sikafloor, Fosroc Nitocote) — epoxy surface coatings applied to cured concrete as a barrier or wearing surface — not a structural infill mortar and not interchangeable with epoxy repair mortar",
                  "Non-shrink cementitious grout (Conbextra, Masterflow) — flowable poured grout for baseplate bedding and anchor grouting — pourable formulation not suitable for vertical slab edge application",
                  "Epoxy tile adhesive (Ardex X 88, Mapei Kerapoxy) — adhesive bonding system for tiles — do not confuse with aggregate-filled epoxy repair mortar even though both are two-component epoxy systems",
                ].map((item) => (
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { href: `${BASE}/repair-mortars-polymer-modified`, label: "PM Repair Mortars", title: "Polymer-modified cementitious mortars for standard slab edge repair" },
