...
export const metadata: Metadata = {
  title: "Slab Edge Deterioration Repair Systems — Remedial Building Australia",
  description:
    "Product categories for slab edge deterioration repair in Australian Class 2 strata and carparks — polymer-modified repair mortars, epoxy mortars, bonding agents, edge forms, reinforcement mesh, curing compounds and tools.",
};
...
const GROUPS = [
  {
    ...
    categories: [
      { label: "Repair mortars (polymer-modified)", count: 5, slug: "repair-mortars-polymer-modified" },
  ...
  },
  {
    ...
    categories: [
      { label: "Abrasives, blades & tools", count: 5, slug: "abrasives-blades-tools" },
    ],
  },
];
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-12">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400">
              ...
              <span>/</span>
              <span className="text-sky-950">Slab edge deterioration</span>
            </nav>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
              Technical repair system reference for slab edge deterioration in Australian Class 2 strata, carparks and civil structures — select a product category to view system information, product comparisons and brand equivalents.
            </p>
          </div>
        </section>
