    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="px-6 py-16">
        <section className="mx-auto max-w-7xl">
            ...
            {services.map((service) => (
              ...
              >
                <div className="p-8">
                  ...
                  <div className="mb-5 text-sky-900">{service.icon}</div>
                  <h2 className="text-xl font-bold leading-snug text-sky-950">
                    {service.title}
                  </h2>
                  <p className="mt-1.5 text-sm font-semibold text-red-700">{service.price}</p>
          ...
          <div className="mt-16 rounded-2xl border border-slate-200 bg-white px-8 py-6">
