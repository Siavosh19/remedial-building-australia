        ...
        <section className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mb-4 mt-4 text-sm font-semibold uppercase tracking-wide text-slate-500">Suitable defect types</p>
          ...
          <div className="mt-8 rounded-2xl bg-sky-950 px-8 py-8 text-white">
            ...
            <div className="mt-3 flex flex-wrap items-baseline gap-x-4 gap-y-1">
              <span className="text-3xl font-extrabold text-white">From $395</span>
            ...
            <p className="mt-5 text-sm leading-6 text-sky-200">
