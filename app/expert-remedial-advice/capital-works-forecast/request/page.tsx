...
export default function CapitalWorksForecastRequestPage() {
  return (
      ...
      <main className="px-6 py-10">
        <section className="mx-auto max-w-4xl">
          <div className="mb-2 flex items-center gap-2 text-xs font-semibold text-slate-400">
            ...
            <span>›</span>
            <Link href="/expert-remedial-advice/capital-works-forecast" className="hover:text-sky-700 transition">Capital Works Forecast</Link>
            <span>›</span>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Capital Works Forecast — fill in the details below. We will review your submission and confirm the fee before starting.
          </p>
          ...
          <div className="mt-6">
            <Link href="/expert-remedial-advice/capital-works-forecast" className="inline-flex rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm font-bold text-sky-950 shadow-sm hover:bg-slate-200">← Back to Capital Works Forecast</Link>
          </div>
        </section>
      </main>
