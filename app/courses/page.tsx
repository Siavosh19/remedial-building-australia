...
export const metadata: Metadata = {
  title: "Courses — Coming Soon — Remedial Building Australia",
  description:
    "Training resources covering remedial building works, waterproofing systems, concrete repair, defect identification and industry practice. Coming soon.",
};

export default function CoursesComingSoonPage() {
  return (
        ...
        <section className="border-b border-slate-200 bg-white px-8 py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Training resources covering remedial building works, waterproofing systems, concrete repair, defect identification and industry practice.
            </p>
            <p className="mt-4 text-base leading-7 text-slate-500">
              We are building this section. Courses will be available shortly.
            </p>
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link href="/defect-library" className="inline-flex items-center gap-2 rounded-xl bg-sky-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-sky-800">
                Defect Library
              </Link>
