  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* ── Login area — side by side ───────────────────────────────────────── */}
        <div className="mx-auto max-w-5xl px-4 py-12">
          <div className="flex flex-col items-stretch gap-6 lg:flex-row">

            {/* Login card — flex-[3] = ~60% width */}
            <div className="w-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm lg:flex-[3] lg:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <label className="block space-y-1.5 text-base font-semibold text-slate-700">
                  <span>Email address</span>
                  <input
                    type="email"
                    value={form.email}
                    onChange={(event) => setForm({ ...form, email: event.target.value })}
                    className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-base text-slate-900 placeholder:text-slate-400 transition focus:border-sky-950 focus:outline-none focus:ring-2 focus:ring-sky-950/10"
                ...
                <label className="flex cursor-pointer items-center gap-3">
                  ...
                  />
                  <span className="text-base text-slate-600">Stay signed in for 30 days</span>
                </label>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-xl bg-red-700 px-5 text-base font-semibold text-white transition hover:bg-red-800 active:bg-red-900 disabled:cursor-not-allowed disabled:opacity-60"
            ...
            {/* Right info panel — flex-[2] = ~40% width */}
            <div className="hidden flex-col justify-center rounded-2xl bg-sky-950 p-8 text-white lg:flex lg:flex-[2]">
