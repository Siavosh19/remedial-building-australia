    ...
    <div className="space-y-8">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-600">Keep your listing up to date. Changes take effect after admin review.</p>
          </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="mb-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Profile status</p>
            <p className="mt-2 font-semibold text-slate-900">{company?.profile_status?.replace(/_/g, " ") ?? "—"}</p>
          </div>
        </div>
