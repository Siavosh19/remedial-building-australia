          ...
          {step === "coming_soon" ? (
            <div className="py-6">
              ...
              <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-8 text-center">
                <span className="inline-block rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-800 mb-4">Coming soon</span>
                <p className="text-slate-700 font-semibold text-lg mb-2">AI-powered scope of works builder</p>
                <p className="text-slate-500 text-sm leading-relaxed max-w-md mx-auto">
                  The consultant portal is under development. It will give remedial building consultants access to an AI-powered scope of works builder — generating fully formatted scope documents from site inspection inputs.
                </p>
